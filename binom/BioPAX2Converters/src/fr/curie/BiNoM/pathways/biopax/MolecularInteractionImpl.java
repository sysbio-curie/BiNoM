...
/**
 * Implementation of {@link fr.curie.BiNoM.pathways.biopax.MolecularInteraction}
 ...
 * <br>
 */
public class MolecularInteractionImpl extends com.ibm.adtech.jastor.ThingImpl implements fr.curie.BiNoM.pathways.biopax.MolecularInteraction {
	...
	MolecularInteractionImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static MolecularInteractionImpl getMolecularInteraction(Resource resource, Model model) throws JastorException {
		return new MolecularInteractionImpl(resource, model);
	}
	    
	static MolecularInteractionImpl createMolecularInteraction(Resource resource, Model model) throws JastorException {
		MolecularInteractionImpl impl = new MolecularInteractionImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, MolecularInteraction.TYPE)))
			impl._model.add(impl._resource, RDF.type, MolecularInteraction.TYPE);
		impl.addSuperTypes();
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, fr.curie.BiNoM.pathways.biopax.MolecularInteraction.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	private void initDataSource() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#dataSource properties in MolecularInteraction model not a Resource", stmt.getObject());
	...
	private void initAvailability() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#availability properties in MolecularInteraction model not a Literal", stmt.getObject());
	...
	private void initComment() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#comment properties in MolecularInteraction model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initName() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#name properties in MolecularInteraction model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initEvidence() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#evidence properties in MolecularInteraction model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initXref() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#xref properties in MolecularInteraction model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public fr.curie.BiNoM.pathways.biopax.InteractionVocabulary getInteractionType() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": interactionType getProperty() in fr.curie.BiNoM.pathways.biopax.MolecularInteraction model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	private void initParticipant() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#participant properties in MolecularInteraction model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof MolecularInteractionListener))
			throw new IllegalArgumentException("ThingListener must be instance of MolecularInteractionListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((MolecularInteractionListener)listener);
		}
	}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDataSource.iterator();iter.hasNext();){
							MolecularInteractionListener listener=(MolecularInteractionListener)iter.next();
							listener.dataSourceAdded(fr.curie.BiNoM.pathways.biopax.MolecularInteractionImpl.this,_dataSource);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(availabilityProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForAvailability.iterator();iter.hasNext();){
						MolecularInteractionListener listener=(MolecularInteractionListener)iter.next();
						listener.availabilityAdded(fr.curie.BiNoM.pathways.biopax.MolecularInteractionImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(commentProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForComment.iterator();iter.hasNext();){
						MolecularInteractionListener listener=(MolecularInteractionListener)iter.next();
						listener.commentAdded(fr.curie.BiNoM.pathways.biopax.MolecularInteractionImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						MolecularInteractionListener listener=(MolecularInteractionListener)iter.next();
						listener.nameAdded(fr.curie.BiNoM.pathways.biopax.MolecularInteractionImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForEvidence.iterator();iter.hasNext();){
							MolecularInteractionListener listener=(MolecularInteractionListener)iter.next();
							listener.evidenceAdded(fr.curie.BiNoM.pathways.biopax.MolecularInteractionImpl.this,_evidence);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForXref.iterator();iter.hasNext();){
							MolecularInteractionListener listener=(MolecularInteractionListener)iter.next();
							listener.xrefAdded(fr.curie.BiNoM.pathways.biopax.MolecularInteractionImpl.this,_xref);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(interactionTypeProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						MolecularInteractionListener listener=(MolecularInteractionListener)iter.next();
						listener.interactionTypeChanged(fr.curie.BiNoM.pathways.biopax.MolecularInteractionImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForParticipant.iterator();iter.hasNext();){
							MolecularInteractionListener listener=(MolecularInteractionListener)iter.next();
							listener.participantAdded(fr.curie.BiNoM.pathways.biopax.MolecularInteractionImpl.this,_participant);
						}
					}
				}
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.PhysicalEntity.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForParticipant_asPhysicalEntity.iterator();iter.hasNext();){
							MolecularInteractionListener listener=(MolecularInteractionListener)iter.next();
							listener.participantAdded(fr.curie.BiNoM.pathways.biopax.MolecularInteractionImpl.this,_participant_asPhysicalEntity);
						}
					}
				}
				return;
...
//				return;
			if (stmt.getPredicate().equals(dataSourceProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDataSource.iterator();iter.hasNext();){
							MolecularInteractionListener listener=(MolecularInteractionListener)iter.next();
							listener.dataSourceRemoved(fr.curie.BiNoM.pathways.biopax.MolecularInteractionImpl.this,_dataSource);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(availabilityProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						MolecularInteractionListener listener=(MolecularInteractionListener)iter.next();
						listener.availabilityRemoved(fr.curie.BiNoM.pathways.biopax.MolecularInteractionImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(commentProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						MolecularInteractionListener listener=(MolecularInteractionListener)iter.next();
						listener.commentRemoved(fr.curie.BiNoM.pathways.biopax.MolecularInteractionImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						MolecularInteractionListener listener=(MolecularInteractionListener)iter.next();
						listener.nameRemoved(fr.curie.BiNoM.pathways.biopax.MolecularInteractionImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(evidenceProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForEvidence.iterator();iter.hasNext();){
							MolecularInteractionListener listener=(MolecularInteractionListener)iter.next();
							listener.evidenceRemoved(fr.curie.BiNoM.pathways.biopax.MolecularInteractionImpl.this,_evidence);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(xrefProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForXref.iterator();iter.hasNext();){
							MolecularInteractionListener listener=(MolecularInteractionListener)iter.next();
							listener.xrefRemoved(fr.curie.BiNoM.pathways.biopax.MolecularInteractionImpl.this,_xref);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(participantProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForParticipant.iterator();iter.hasNext();){
							MolecularInteractionListener listener=(MolecularInteractionListener)iter.next();
							listener.participantRemoved(fr.curie.BiNoM.pathways.biopax.MolecularInteractionImpl.this,_participant);
						}
					}
				}
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.PhysicalEntity.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForParticipant_asPhysicalEntity.iterator();iter.hasNext();){
							MolecularInteractionListener listener=(MolecularInteractionListener)iter.next();
							listener.participantRemoved(fr.curie.BiNoM.pathways.biopax.MolecularInteractionImpl.this,_participant_asPhysicalEntity);
						}
					}
				}
				return;
