...
of SBML to store all the information contained in the graphs. Some tools are
...
values as source nodes. Then, we constructed a text file listing nodes of the influence network
...
The raw G1/S network is very detailed and may be hard to grasp at a first glance.
...
\item Project home page: \url{http://binom.curie.fr/} and \url{http://apps.cytoscape.org/apps/binom}
