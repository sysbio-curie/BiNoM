...
public class ModulationImpl extends com.ibm.adtech.jastor.ThingImpl implements fr.curie.BiNoM.pathways.biopax.Modulation {
	...
	private void initDataSource() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#dataSource properties in Modulation model not a Resource", stmt.getObject());
	...
	private void initAvailability() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#availability properties in Modulation model not a Literal", stmt.getObject());
	...
	private void initComment() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#comment properties in Modulation model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initName() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#name properties in Modulation model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initEvidence() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#evidence properties in Modulation model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initXref() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#xref properties in Modulation model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public fr.curie.BiNoM.pathways.biopax.InteractionVocabulary getInteractionType() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": interactionType getProperty() in fr.curie.BiNoM.pathways.biopax.Modulation model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	private void initParticipant() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#participant properties in Modulation model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public fr.curie.BiNoM.pathways.biopax.Catalysis getControlled_asCatalysis() throws JastorException {
		...
		if (!_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.Catalysis.TYPE))
			return null;
		controlled_asCatalysis = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getCatalysis(resource,_model);
		return controlled_asCatalysis;
	}
	...
	public fr.curie.BiNoM.pathways.biopax.Catalysis setControlled_asCatalysis() throws JastorException {
		...
		fr.curie.BiNoM.pathways.biopax.Catalysis controlled = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.createCatalysis(_model.createResource(),_model);
		this.controlled_asCatalysis = controlled;
		_model.add(_model.createStatement(_resource,controlledProperty, controlled.resource()));
		return controlled;
	}
	...
	public fr.curie.BiNoM.pathways.biopax.Catalysis setControlled_asCatalysis(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		...
		fr.curie.BiNoM.pathways.biopax.Catalysis controlled = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getCatalysis(resource,_model);
		this.controlled_asCatalysis = controlled;
		_model.add(_model.createStatement(_resource,controlledProperty, controlled.resource()));
		return controlled;
	}
	...
	private void initController_asPhysicalEntity() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#controller properties in Modulation model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	public java.lang.String getControlType() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": controlType getProperty() in fr.curie.BiNoM.pathways.biopax.Modulation model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDataSource.iterator();iter.hasNext();){
							...
							listener.dataSourceAdded(fr.curie.BiNoM.pathways.biopax.ModulationImpl.this,_dataSource);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						ModulationListener listener=(ModulationListener)iter.next();
						listener.nameAdded(fr.curie.BiNoM.pathways.biopax.ModulationImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			...
			if (stmt.getPredicate().equals(interactionTypeProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						ModulationListener listener=(ModulationListener)iter.next();
						listener.interactionTypeChanged(fr.curie.BiNoM.pathways.biopax.ModulationImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForParticipant.iterator();iter.hasNext();){
							ModulationListener listener=(ModulationListener)iter.next();
							listener.participantAdded(fr.curie.BiNoM.pathways.biopax.ModulationImpl.this,_participant);
						}
					}
				}
				return;
				...
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.PhysicalEntity.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForController_asPhysicalEntity.iterator();iter.hasNext();){
							ModulationListener listener=(ModulationListener)iter.next();
							listener.controllerAdded(fr.curie.BiNoM.pathways.biopax.ModulationImpl.this,_controller_asPhysicalEntity);
						}
					}
				}
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.Pathway.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForController_asPathway.iterator();iter.hasNext();){
							ModulationListener listener=(ModulationListener)iter.next();
							listener.controllerAdded(fr.curie.BiNoM.pathways.biopax.ModulationImpl.this,_controller_asPathway);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(controlTypeProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						ModulationListener listener=(ModulationListener)iter.next();
						listener.controlTypeChanged(fr.curie.BiNoM.pathways.biopax.ModulationImpl.this);
					}
				}
				return;
			}
...
//				return;
			if (stmt.getPredicate().equals(dataSourceProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDataSource.iterator();iter.hasNext();){
							ModulationListener listener=(ModulationListener)iter.next();
							listener.dataSourceRemoved(fr.curie.BiNoM.pathways.biopax.ModulationImpl.this,_dataSource);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						ModulationListener listener=(ModulationListener)iter.next();
						listener.nameRemoved(fr.curie.BiNoM.pathways.biopax.ModulationImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			...
			if (stmt.getPredicate().equals(participantProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForParticipant.iterator();iter.hasNext();){
							ModulationListener listener=(ModulationListener)iter.next();
							listener.participantRemoved(fr.curie.BiNoM.pathways.biopax.ModulationImpl.this,_participant);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(controllerProperty)) {
				...
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.PhysicalEntity.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForController_asPhysicalEntity.iterator();iter.hasNext();){
							ModulationListener listener=(ModulationListener)iter.next();
							listener.controllerRemoved(fr.curie.BiNoM.pathways.biopax.ModulationImpl.this,_controller_asPhysicalEntity);
						}
					}
				}
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.Pathway.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForController_asPathway.iterator();iter.hasNext();){
							ModulationListener listener=(ModulationListener)iter.next();
							listener.controllerRemoved(fr.curie.BiNoM.pathways.biopax.ModulationImpl.this,_controller_asPathway);
						}
					}
				}
				return;
