...
R, Java). NaviCell Web Service allows combining visualization of different data types
through different tools. It is scalable, based on Google Maps technology allowing working with large pathway maps,
...
We illustrate the interest of the tool  with  several case studies using pathway maps created by different research groups, 
...
in BiNoM Cytoscape plugin \cite{Zinovyev2008,Bonnet2013}, exploiting the BiNoM-specific text-based representation
of molecular entities. This method allows using with NaviCell any network that can be imported into Cytoscape environment.
