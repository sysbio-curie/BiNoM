...
public interface sequenceIntervalListener extends com.ibm.adtech.jastor.ThingListener {
	 ...
	 * @param source the affected instance of fr.curie.BiNoM.pathways.biopax.sequenceInterval
	 */
	public void SEQUENCE_DASH_INTERVAL_DASH_BEGINChanged(fr.curie.BiNoM.pathways.biopax.sequenceInterval source);

	/**
	 * Called when SEQUENCE_DASH_INTERVAL_DASH_END has changed
	 * @param source the affected instance of fr.curie.BiNoM.pathways.biopax.sequenceInterval
	 */
	public void SEQUENCE_DASH_INTERVAL_DASH_ENDChanged(fr.curie.BiNoM.pathways.biopax.sequenceInterval source);
