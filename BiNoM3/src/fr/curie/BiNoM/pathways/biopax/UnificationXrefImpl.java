...
public class UnificationXrefImpl extends com.ibm.adtech.jastor.ThingImpl implements fr.curie.BiNoM.pathways.biopax.UnificationXref {
	...
	private void initComment() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#comment properties in UnificationXref model not a Literal", stmt.getObject());
	...
	public java.lang.String getIdVersion() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": idVersion getProperty() in fr.curie.BiNoM.pathways.biopax.UnificationXref model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
		Object obj = Util.fixLiteral(literal.getValue(),"java.lang.String");
	...
	public java.lang.String getDbVersion() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": dbVersion getProperty() in fr.curie.BiNoM.pathways.biopax.UnificationXref model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
		Object obj = Util.fixLiteral(literal.getValue(),"java.lang.String");
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
			...
			if (stmt.getPredicate().equals(idVersionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						UnificationXrefListener listener=(UnificationXrefListener)iter.next();
						listener.idVersionChanged(fr.curie.BiNoM.pathways.biopax.UnificationXrefImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(dbVersionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						UnificationXrefListener listener=(UnificationXrefListener)iter.next();
						listener.dbVersionChanged(fr.curie.BiNoM.pathways.biopax.UnificationXrefImpl.this);
					}
				}
				return;
			}
