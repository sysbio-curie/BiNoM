...
public class CatalysisImpl extends com.ibm.adtech.jastor.ThingImpl implements fr.curie.BiNoM.pathways.biopax.Catalysis {
	...
	private static com.hp.hpl.jena.rdf.model.Property catalysisDirectionProperty = ResourceFactory.createProperty("http://www.biopax.org/release/biopax-level3.owl#catalysisDirection");
	private java.lang.String catalysisDirection;
	private static com.hp.hpl.jena.rdf.model.Property cofactorProperty = ResourceFactory.createProperty("http://www.biopax.org/release/biopax-level3.owl#cofactor");
	...
	void addHasValueValues() {
		if (!_model.contains(_resource, controlTypeProperty, _model.createTypedLiteral("ACTIVATION^^http://www.w3.org/2001/XMLSchema#string")))
			_model.add(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(_resource, controlTypeProperty, _model.createTypedLiteral("ACTIVATION^^http://www.w3.org/2001/XMLSchema#string")));
	}
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,catalysisDirectionProperty,(RDFNode)null);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	private void initDataSource() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#dataSource properties in Catalysis model not a Resource", stmt.getObject());
	...
	private void initAvailability() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#availability properties in Catalysis model not a Literal", stmt.getObject());
	...
	private void initComment() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#comment properties in Catalysis model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initName() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#name properties in Catalysis model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initEvidence() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#evidence properties in Catalysis model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initXref() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#xref properties in Catalysis model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public fr.curie.BiNoM.pathways.biopax.InteractionVocabulary getInteractionType() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": interactionType getProperty() in fr.curie.BiNoM.pathways.biopax.Catalysis model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	private void initParticipant() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#participant properties in Catalysis model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public fr.curie.BiNoM.pathways.biopax.Conversion getControlled_asConversion() throws JastorException {
		...
		if (!_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.Conversion.TYPE))
			return null;
		controlled_asConversion = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getConversion(resource,_model);
		return controlled_asConversion;
	}
	...
	public fr.curie.BiNoM.pathways.biopax.Conversion setControlled_asConversion() throws JastorException {
		...
		fr.curie.BiNoM.pathways.biopax.Conversion controlled = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.createConversion(_model.createResource(),_model);
		this.controlled_asConversion = controlled;
		_model.add(_model.createStatement(_resource,controlledProperty, controlled.resource()));
		return controlled;
	}
	...
	public fr.curie.BiNoM.pathways.biopax.Conversion setControlled_asConversion(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		...
		fr.curie.BiNoM.pathways.biopax.Conversion controlled = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getConversion(resource,_model);
		this.controlled_asConversion = controlled;
		_model.add(_model.createStatement(_resource,controlledProperty, controlled.resource()));
		return controlled;
	}
	...
	private void initController_asPathway() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#controller properties in Catalysis model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.Pathway.TYPE)) {
	...
	public java.lang.String getControlType() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": controlType getProperty() in fr.curie.BiNoM.pathways.biopax.Catalysis model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	public java.lang.String getCatalysisDirection() throws JastorException {
		if (catalysisDirection != null)
			return catalysisDirection;
		com.hp.hpl.jena.rdf.model.Statement stmt = _model.getProperty(_resource, catalysisDirectionProperty);
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": catalysisDirection getProperty() in fr.curie.BiNoM.pathways.biopax.Catalysis model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
		Object obj = Util.fixLiteral(literal.getValue(),"java.lang.String");
		catalysisDirection = (java.lang.String)obj;
		return catalysisDirection;
	}
	
	public void setCatalysisDirection(java.lang.String catalysisDirection) throws JastorException {
		if (_model.contains(_resource,catalysisDirectionProperty)) {
			_model.removeAll(_resource,catalysisDirectionProperty,null);
		}
		this.catalysisDirection = catalysisDirection;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
		if (catalysisDirection != null) {
			_model.add(_model.createStatement(_resource,catalysisDirectionProperty, _model.createTypedLiteral(catalysisDirection)));
		}	
	}
	...
	private void initCofactor() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#cofactor properties in Catalysis model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				fr.curie.BiNoM.pathways.biopax.PhysicalEntity cofactor = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getPhysicalEntity(resource,_model);
	...
	public void addCofactor(fr.curie.BiNoM.pathways.biopax.PhysicalEntity cofactor) throws JastorException {
	...
	public fr.curie.BiNoM.pathways.biopax.PhysicalEntity addCofactor() throws JastorException {
		fr.curie.BiNoM.pathways.biopax.PhysicalEntity cofactor = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.createPhysicalEntity(_model.createResource(),_model);
		if (this.cofactor == null)
			initCofactor();
		this.cofactor.add(cofactor);
		_model.add(_model.createStatement(_resource,cofactorProperty,cofactor.resource()));
	...
	public fr.curie.BiNoM.pathways.biopax.PhysicalEntity addCofactor(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		fr.curie.BiNoM.pathways.biopax.PhysicalEntity cofactor = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getPhysicalEntity(resource,_model);
		if (this.cofactor == null)
			initCofactor();
		if (this.cofactor.contains(cofactor))
	...
	public void removeCofactor(fr.curie.BiNoM.pathways.biopax.PhysicalEntity cofactor) throws JastorException {
		if (this.cofactor == null)
			initCofactor();
		if (!this.cofactor.contains(cofactor))
			return;
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDataSource.iterator();iter.hasNext();){
							...
							listener.dataSourceAdded(fr.curie.BiNoM.pathways.biopax.CatalysisImpl.this,_dataSource);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						CatalysisListener listener=(CatalysisListener)iter.next();
						listener.nameAdded(fr.curie.BiNoM.pathways.biopax.CatalysisImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			...
			if (stmt.getPredicate().equals(interactionTypeProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CatalysisListener listener=(CatalysisListener)iter.next();
						listener.interactionTypeChanged(fr.curie.BiNoM.pathways.biopax.CatalysisImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForParticipant.iterator();iter.hasNext();){
							CatalysisListener listener=(CatalysisListener)iter.next();
							listener.participantAdded(fr.curie.BiNoM.pathways.biopax.CatalysisImpl.this,_participant);
						}
					}
				}
				return;
				...
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.Pathway.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForController_asPathway.iterator();iter.hasNext();){
							CatalysisListener listener=(CatalysisListener)iter.next();
							listener.controllerAdded(fr.curie.BiNoM.pathways.biopax.CatalysisImpl.this,_controller_asPathway);
						}
					}
				}
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.PhysicalEntity.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForController_asPhysicalEntity.iterator();iter.hasNext();){
							CatalysisListener listener=(CatalysisListener)iter.next();
							listener.controllerAdded(fr.curie.BiNoM.pathways.biopax.CatalysisImpl.this,_controller_asPhysicalEntity);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(controlTypeProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CatalysisListener listener=(CatalysisListener)iter.next();
						listener.controlTypeChanged(fr.curie.BiNoM.pathways.biopax.CatalysisImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(catalysisDirectionProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
					return;
				com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
				catalysisDirection = (java.lang.String)Util.fixLiteral(literal.getValue(),"java.lang.String");
				if (listeners != null) {
					java.util.ArrayList consumers;
					synchronized (listeners) {
						consumers = (java.util.ArrayList) listeners.clone();
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CatalysisListener listener=(CatalysisListener)iter.next();
						listener.catalysisDirectionChanged(fr.curie.BiNoM.pathways.biopax.CatalysisImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(cofactorProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					fr.curie.BiNoM.pathways.biopax.PhysicalEntity _cofactor = null;
					try {
						_cofactor = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getPhysicalEntity(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (cofactor == null) {
...
//				return;
			if (stmt.getPredicate().equals(dataSourceProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDataSource.iterator();iter.hasNext();){
							CatalysisListener listener=(CatalysisListener)iter.next();
							listener.dataSourceRemoved(fr.curie.BiNoM.pathways.biopax.CatalysisImpl.this,_dataSource);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CatalysisListener listener=(CatalysisListener)iter.next();
						listener.nameRemoved(fr.curie.BiNoM.pathways.biopax.CatalysisImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			...
			if (stmt.getPredicate().equals(participantProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForParticipant.iterator();iter.hasNext();){
							CatalysisListener listener=(CatalysisListener)iter.next();
							listener.participantRemoved(fr.curie.BiNoM.pathways.biopax.CatalysisImpl.this,_participant);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(controllerProperty)) {
				...
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.Pathway.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForController_asPathway.iterator();iter.hasNext();){
							CatalysisListener listener=(CatalysisListener)iter.next();
							listener.controllerRemoved(fr.curie.BiNoM.pathways.biopax.CatalysisImpl.this,_controller_asPathway);
						}
					}
				}
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.PhysicalEntity.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForController_asPhysicalEntity.iterator();iter.hasNext();){
							CatalysisListener listener=(CatalysisListener)iter.next();
							listener.controllerRemoved(fr.curie.BiNoM.pathways.biopax.CatalysisImpl.this,_controller_asPhysicalEntity);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(catalysisDirectionProperty)) {
				...
				//Object obj = literal.getValue();
				Object obj = Util.fixLiteral(literal.getValue(),"java.lang.String");
				if (catalysisDirection != null && catalysisDirection.equals(obj))
					catalysisDirection = null;
				if (listeners != null) {
					java.util.ArrayList consumers;
					synchronized (listeners) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (cofactor != null) {
						...
						for (int i=0;i<cofactor.size();i++) {
							fr.curie.BiNoM.pathways.biopax.PhysicalEntity __item = (fr.curie.BiNoM.pathways.biopax.PhysicalEntity) cofactor.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_cofactor = __item;
								break;
