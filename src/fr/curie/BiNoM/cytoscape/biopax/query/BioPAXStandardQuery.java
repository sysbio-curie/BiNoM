...
public class BioPAXStandardQuery implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
    	...
    	if(beng==null){
    		...
    		if(Cytoscape.getNetworkSet().size()==0)
    			JOptionPane.showMessageDialog(Cytoscape.getDesktop(), "No query can be performed. Select some entities first.");
    		else{
