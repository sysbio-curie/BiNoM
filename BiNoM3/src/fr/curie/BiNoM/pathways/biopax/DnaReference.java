...
/**
 * Interface for DnaReference ontology class<br>
 * Use the fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory to create instances of this interface.
 * <p>(URI: http://www.biopax.org/release/biopax-level3.owl#DnaReference)</p>
 * <br>
 * RDF Schema Standard Properties <br>
 * 	comment : Definition: A DNA reference is a grouping of several DNA entities that are common in sequence.  Members can differ in celular location, sequence features, SNPs, mutations and bound partners.

Comments : Note that this is not a reference gene. Genes are non-physical,stateless continuants. Their physical manifestations can span multiple DNA molecules, sometimes even across chromosomes due to regulatory regions. Similarly a gene is not necessarily made up of deoxyribonucleic acid and can be present in multiple copies ( which are different DNA regions).^^http://www.w3.org/2001/XMLSchema#string <br>
 * <br>
 * <br>
 */
public interface DnaReference extends fr.curie.BiNoM.pathways.biopax.EntityReference, com.ibm.adtech.jastor.Thing {
	 ...
	 * @return		{@link java.util.Iterator} of {@link fr.curie.BiNoM.pathways.biopax.DnaReference}
	 * @see			#memberEntityReferenceProperty
	 */
	public java.util.Iterator getMemberEntityReference_asDnaReference() throws com.ibm.adtech.jastor.JastorException;

	/**
	 * Adds a value for the 'memberEntityReference' property
	 * @param		The {@link fr.curie.BiNoM.pathways.biopax.DnaReference} to add
	 * @see			#memberEntityReferenceProperty
	 */
	public void addMemberEntityReference(fr.curie.BiNoM.pathways.biopax.DnaReference memberEntityReference) throws com.ibm.adtech.jastor.JastorException;
	
	/**
	 * Adds an anonymous value for the 'memberEntityReference' property
	 * @return		The anoymous {@link fr.curie.BiNoM.pathways.biopax.DnaReference} created
	 * @see			#memberEntityReferenceProperty
	 */
	public fr.curie.BiNoM.pathways.biopax.DnaReference addMemberEntityReference_asDnaReference() throws com.ibm.adtech.jastor.JastorException;
	 ...
	 * and calling addMemberEntityReference(fr.curie.BiNoM.pathways.biopax.DnaReference memberEntityReference)
	 ...
	 * @see			#memberEntityReferenceProperty
	 */
	public fr.curie.BiNoM.pathways.biopax.DnaReference addMemberEntityReference_asDnaReference(com.hp.hpl.jena.rdf.model.Resource resource) throws com.ibm.adtech.jastor.JastorException;
	
	/**
	 * Removes a value for the 'memberEntityReference' property.  This method should not
	 * be invoked while iterator through values.  In that case, the remove() method of the Iterator
	 * itself should be used.
	 * @param		The {@link fr.curie.BiNoM.pathways.biopax.DnaReference} to remove
	 * @see			#memberEntityReferenceProperty
	 */
	public void removeMemberEntityReference(fr.curie.BiNoM.pathways.biopax.DnaReference memberEntityReference) throws com.ibm.adtech.jastor.JastorException;
