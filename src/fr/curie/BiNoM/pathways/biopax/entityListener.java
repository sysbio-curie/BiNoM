...
public interface entityListener extends com.ibm.adtech.jastor.ThingListener {
	 ...
	 */	
	public void DATA_DASH_SOURCEAdded(fr.curie.BiNoM.pathways.biopax.entity source, fr.curie.BiNoM.pathways.biopax.dataSource newValue);
	 ...
	 */
	public void DATA_DASH_SOURCERemoved(fr.curie.BiNoM.pathways.biopax.entity source, fr.curie.BiNoM.pathways.biopax.dataSource oldValue);
	 ...
	 * @param source the affected instance of fr.curie.BiNoM.pathways.biopax.entity
	 */
	public void SHORT_DASH_NAMEChanged(fr.curie.BiNoM.pathways.biopax.entity source);
	 ...
	 * @param newValue the object representing the new value
	 */	
	public void SYNONYMSAdded(fr.curie.BiNoM.pathways.biopax.entity source, java.lang.String newValue);
	 ...
	 * @param oldValue the object representing the removed value
	 */	
	public void SYNONYMSRemoved(fr.curie.BiNoM.pathways.biopax.entity source, java.lang.String oldValue);

	/**
	 * Called when NAME has changed
	 * @param source the affected instance of fr.curie.BiNoM.pathways.biopax.entity
	 */
	public void NAMEChanged(fr.curie.BiNoM.pathways.biopax.entity source);
