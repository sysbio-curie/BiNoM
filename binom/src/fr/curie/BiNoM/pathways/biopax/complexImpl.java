...
public class complexImpl extends com.ibm.adtech.jastor.ThingImpl implements fr.curie.BiNoM.pathways.biopax.complex {
	...
	private static com.hp.hpl.jena.rdf.model.Property COMPONENTSProperty = ResourceFactory.createProperty("http://www.biopax.org/release/biopax-level2.owl#COMPONENTS");
	...
	private java.util.ArrayList ORGANISM;
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,COMPONENTSProperty,(RDFNode)null);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	private void initDATA_DASH_SOURCE() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#DATA-SOURCE properties in complex model not a Resource", stmt.getObject());
	...
	private void initAVAILABILITY() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#AVAILABILITY properties in complex model not a Literal", stmt.getObject());
	...
	private void initCOMMENT() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#COMMENT properties in complex model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	public java.lang.String getSHORT_DASH_NAME() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": SHORT_DASH_NAME getProperty() in fr.curie.BiNoM.pathways.biopax.complex model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initSYNONYMS() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#SYNONYMS properties in complex model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	public java.lang.String getNAME() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": NAME getProperty() in fr.curie.BiNoM.pathways.biopax.complex model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
		Object obj = Util.fixLiteral(literal.getValue(),"java.lang.String");
	...
	private void initXREF() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#XREF properties in complex model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initCOMPONENTS() throws JastorException {
		this.COMPONENTS = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, COMPONENTSProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#COMPONENTS properties in complex model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				fr.curie.BiNoM.pathways.biopax.physicalEntityParticipant COMPONENTS = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level2_DOT_owlFactory.getphysicalEntityParticipant(resource,_model);
				this.COMPONENTS.add(COMPONENTS);
			}
		}
	}

	public java.util.Iterator getCOMPONENTS() throws JastorException {
		if (COMPONENTS == null)
			initCOMPONENTS();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(COMPONENTS,_resource,COMPONENTSProperty,true);
	}

	public void addCOMPONENTS(fr.curie.BiNoM.pathways.biopax.physicalEntityParticipant COMPONENTS) throws JastorException {
		if (this.COMPONENTS == null)
			initCOMPONENTS();
		if (this.COMPONENTS.contains(COMPONENTS)) {
			this.COMPONENTS.remove(COMPONENTS);
			this.COMPONENTS.add(COMPONENTS);
			return;
		}
		this.COMPONENTS.add(COMPONENTS);
		_model.add(_model.createStatement(_resource,COMPONENTSProperty,COMPONENTS.resource()));
	}
	
	public fr.curie.BiNoM.pathways.biopax.physicalEntityParticipant addCOMPONENTS() throws JastorException {
		fr.curie.BiNoM.pathways.biopax.physicalEntityParticipant COMPONENTS = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level2_DOT_owlFactory.createphysicalEntityParticipant(_model.createResource(),_model);
		if (this.COMPONENTS == null)
			initCOMPONENTS();
		this.COMPONENTS.add(COMPONENTS);
		_model.add(_model.createStatement(_resource,COMPONENTSProperty,COMPONENTS.resource()));
	...
	public fr.curie.BiNoM.pathways.biopax.physicalEntityParticipant addCOMPONENTS(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		fr.curie.BiNoM.pathways.biopax.physicalEntityParticipant COMPONENTS = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level2_DOT_owlFactory.getphysicalEntityParticipant(resource,_model);
		if (this.COMPONENTS == null)
			initCOMPONENTS();
		if (this.COMPONENTS.contains(COMPONENTS))
	...
	public void removeCOMPONENTS(fr.curie.BiNoM.pathways.biopax.physicalEntityParticipant COMPONENTS) throws JastorException {
		if (this.COMPONENTS == null)
			initCOMPONENTS();
		if (!this.COMPONENTS.contains(COMPONENTS))
			return;
		if (!_model.contains(_resource, COMPONENTSProperty, COMPONENTS.resource()))
			return;
		this.COMPONENTS.remove(COMPONENTS);
		_model.removeAll(_resource, COMPONENTSProperty, COMPONENTS.resource());
	}
		 

	private void initORGANISM() throws JastorException {
		this.ORGANISM = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, ORGANISMProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#ORGANISM properties in complex model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				...
				this.ORGANISM.add(ORGANISM);
			}
		}
	}

	public java.util.Iterator getORGANISM() throws JastorException {
		if (ORGANISM == null)
			initORGANISM();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(ORGANISM,_resource,ORGANISMProperty,true);
	}

	public void addORGANISM(fr.curie.BiNoM.pathways.biopax.bioSource ORGANISM) throws JastorException {
		if (this.ORGANISM == null)
			initORGANISM();
		if (this.ORGANISM.contains(ORGANISM)) {
			this.ORGANISM.remove(ORGANISM);
			this.ORGANISM.add(ORGANISM);
			return;
		}
		this.ORGANISM.add(ORGANISM);
	...
	public fr.curie.BiNoM.pathways.biopax.bioSource addORGANISM() throws JastorException {
	...
	public fr.curie.BiNoM.pathways.biopax.bioSource addORGANISM(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		fr.curie.BiNoM.pathways.biopax.bioSource ORGANISM = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level2_DOT_owlFactory.getbioSource(resource,_model);
		if (this.ORGANISM == null)
			initORGANISM();
		if (this.ORGANISM.contains(ORGANISM))
	...
	public void removeORGANISM(fr.curie.BiNoM.pathways.biopax.bioSource ORGANISM) throws JastorException {
		if (this.ORGANISM == null)
			initORGANISM();
		if (!this.ORGANISM.contains(ORGANISM))
			return;
		if (!_model.contains(_resource, ORGANISMProperty, ORGANISM.resource()))
			return;
		this.ORGANISM.remove(ORGANISM);
		_model.removeAll(_resource, ORGANISMProperty, ORGANISM.resource());
	}
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDATA_DASH_SOURCE.iterator();iter.hasNext();){
							...
							listener.DATA_DASH_SOURCEAdded(fr.curie.BiNoM.pathways.biopax.complexImpl.this,_DATA_DASH_SOURCE);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(SHORT_DASH_NAMEProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						complexListener listener=(complexListener)iter.next();
						listener.SHORT_DASH_NAMEChanged(fr.curie.BiNoM.pathways.biopax.complexImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(SYNONYMSProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForSYNONYMS.iterator();iter.hasNext();){
						complexListener listener=(complexListener)iter.next();
						listener.SYNONYMSAdded(fr.curie.BiNoM.pathways.biopax.complexImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(NAMEProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						complexListener listener=(complexListener)iter.next();
						listener.NAMEChanged(fr.curie.BiNoM.pathways.biopax.complexImpl.this);
					}
				}
				return;
			}
			...
			if (stmt.getPredicate().equals(COMPONENTSProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
					return;
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					fr.curie.BiNoM.pathways.biopax.physicalEntityParticipant _COMPONENTS = null;
					try {
						_COMPONENTS = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level2_DOT_owlFactory.getphysicalEntityParticipant(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (COMPONENTS == null) {
					...
					if (!COMPONENTS.contains(_COMPONENTS))
						COMPONENTS.add(_COMPONENTS);
					if (listeners != null) {
						java.util.ArrayList consumersForCOMPONENTS;
						synchronized (listeners) {
							consumersForCOMPONENTS = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForCOMPONENTS.iterator();iter.hasNext();){
							complexListener listener=(complexListener)iter.next();
							listener.COMPONENTSAdded(fr.curie.BiNoM.pathways.biopax.complexImpl.this,_COMPONENTS);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(ORGANISMProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					fr.curie.BiNoM.pathways.biopax.bioSource _ORGANISM = null;
					try {
						_ORGANISM = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level2_DOT_owlFactory.getbioSource(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (ORGANISM == null) {
					...
					if (!ORGANISM.contains(_ORGANISM))
						ORGANISM.add(_ORGANISM);
					if (listeners != null) {
						java.util.ArrayList consumersForORGANISM;
						synchronized (listeners) {
							consumersForORGANISM = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForORGANISM.iterator();iter.hasNext();){
							complexListener listener=(complexListener)iter.next();
							listener.ORGANISMAdded(fr.curie.BiNoM.pathways.biopax.complexImpl.this,_ORGANISM);
						}
					}
				}
				return;
...
//				return;
			if (stmt.getPredicate().equals(DATA_DASH_SOURCEProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDATA_DASH_SOURCE.iterator();iter.hasNext();){
							complexListener listener=(complexListener)iter.next();
							listener.DATA_DASH_SOURCERemoved(fr.curie.BiNoM.pathways.biopax.complexImpl.this,_DATA_DASH_SOURCE);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(SYNONYMSProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						complexListener listener=(complexListener)iter.next();
						listener.SYNONYMSRemoved(fr.curie.BiNoM.pathways.biopax.complexImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (COMPONENTS != null) {
						...
						for (int i=0;i<COMPONENTS.size();i++) {
							fr.curie.BiNoM.pathways.biopax.physicalEntityParticipant __item = (fr.curie.BiNoM.pathways.biopax.physicalEntityParticipant) COMPONENTS.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_COMPONENTS = __item;
								break;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForCOMPONENTS.iterator();iter.hasNext();){
							complexListener listener=(complexListener)iter.next();
							listener.COMPONENTSRemoved(fr.curie.BiNoM.pathways.biopax.complexImpl.this,_COMPONENTS);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (ORGANISM != null) {
						...
						for (int i=0;i<ORGANISM.size();i++) {
							fr.curie.BiNoM.pathways.biopax.bioSource __item = (fr.curie.BiNoM.pathways.biopax.bioSource) ORGANISM.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_ORGANISM = __item;
								break;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForORGANISM.iterator();iter.hasNext();){
							complexListener listener=(complexListener)iter.next();
							listener.ORGANISMRemoved(fr.curie.BiNoM.pathways.biopax.complexImpl.this,_ORGANISM);
						}
					}
				}
				return;
