...
/**
 * Implementation of {@link fr.curie.BiNoM.pathways.biopax.DnaReference}
 * Use the fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory to create instances of this class.
 * <p>(URI: http://www.biopax.org/release/biopax-level3.owl#DnaReference)</p>
 * <br>
 */
public class DnaReferenceImpl extends com.ibm.adtech.jastor.ThingImpl implements fr.curie.BiNoM.pathways.biopax.DnaReference {
	...
	private java.util.ArrayList memberEntityReference_asDnaReference;
	...
	DnaReferenceImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static DnaReferenceImpl getDnaReference(Resource resource, Model model) throws JastorException {
		return new DnaReferenceImpl(resource, model);
	}
	    
	static DnaReferenceImpl createDnaReference(Resource resource, Model model) throws JastorException {
		DnaReferenceImpl impl = new DnaReferenceImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, DnaReference.TYPE)))
			impl._model.add(impl._resource, RDF.type, DnaReference.TYPE);
		impl.addSuperTypes();
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, fr.curie.BiNoM.pathways.biopax.DnaReference.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	public void clearCache() {
		...
		memberEntityReference_asDnaReference = null;
	...
	private void initComment() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#comment properties in DnaReference model not a Literal", stmt.getObject());
	...
	private void initMemberEntityReference() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#memberEntityReference properties in DnaReference model not a Resource", stmt.getObject());
	...
	private void initMemberEntityReference_asDnaReference() throws JastorException {
		this.memberEntityReference_asDnaReference = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, memberEntityReferenceProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			...
			if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.DnaReference.TYPE)) {
				fr.curie.BiNoM.pathways.biopax.DnaReference memberEntityReference = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getDnaReference(resource,_model);
				this.memberEntityReference_asDnaReference.add(memberEntityReference);
			}
		}
	}

	public java.util.Iterator getMemberEntityReference_asDnaReference() throws JastorException {
		if (memberEntityReference_asDnaReference == null)
			initMemberEntityReference_asDnaReference();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(memberEntityReference_asDnaReference,_resource,memberEntityReferenceProperty,true);
	}

	public void addMemberEntityReference(fr.curie.BiNoM.pathways.biopax.DnaReference memberEntityReference) throws JastorException {
		if (this.memberEntityReference_asDnaReference == null)
			initMemberEntityReference_asDnaReference();
		if (this.memberEntityReference_asDnaReference.contains(memberEntityReference)) {
			this.memberEntityReference_asDnaReference.remove(memberEntityReference);
			this.memberEntityReference_asDnaReference.add(memberEntityReference);
			return;
		}
		this.memberEntityReference_asDnaReference.add(memberEntityReference);
	...
	public fr.curie.BiNoM.pathways.biopax.DnaReference addMemberEntityReference_asDnaReference() throws JastorException {
		fr.curie.BiNoM.pathways.biopax.DnaReference memberEntityReference = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.createDnaReference(_model.createResource(),_model);
		if (this.memberEntityReference_asDnaReference == null)
			initMemberEntityReference_asDnaReference();
		this.memberEntityReference_asDnaReference.add(memberEntityReference);
		_model.add(_model.createStatement(_resource,memberEntityReferenceProperty,memberEntityReference.resource()));
	...
	public fr.curie.BiNoM.pathways.biopax.DnaReference addMemberEntityReference_asDnaReference(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		fr.curie.BiNoM.pathways.biopax.DnaReference memberEntityReference = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getDnaReference(resource,_model);
		if (this.memberEntityReference_asDnaReference == null)
			initMemberEntityReference_asDnaReference();
		if (this.memberEntityReference_asDnaReference.contains(memberEntityReference))
	...
	public void removeMemberEntityReference(fr.curie.BiNoM.pathways.biopax.DnaReference memberEntityReference) throws JastorException {
		if (this.memberEntityReference_asDnaReference == null)
			initMemberEntityReference_asDnaReference();
		if (!this.memberEntityReference_asDnaReference.contains(memberEntityReference))
			return;
	...
	public fr.curie.BiNoM.pathways.biopax.EntityReferenceTypeVocabulary getEntityReferenceType() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": entityReferenceType getProperty() in fr.curie.BiNoM.pathways.biopax.DnaReference model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	private void initEntityFeature() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#entityFeature properties in DnaReference model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initName() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#name properties in DnaReference model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initEvidence() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#evidence properties in DnaReference model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initXref() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#xref properties in DnaReference model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public java.lang.String getSequence() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": sequence getProperty() in fr.curie.BiNoM.pathways.biopax.DnaReference model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initSubRegion_asDnaRegionReference() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#subRegion properties in DnaReference model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	public fr.curie.BiNoM.pathways.biopax.BioSource getOrganism() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": organism getProperty() in fr.curie.BiNoM.pathways.biopax.DnaReference model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof DnaReferenceListener))
			throw new IllegalArgumentException("ThingListener must be instance of DnaReferenceListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((DnaReferenceListener)listener);
		}
	}
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
			...
			if (stmt.getPredicate().equals(commentProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForComment.iterator();iter.hasNext();){
						DnaReferenceListener listener=(DnaReferenceListener)iter.next();
						listener.commentAdded(fr.curie.BiNoM.pathways.biopax.DnaReferenceImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMemberEntityReference.iterator();iter.hasNext();){
							DnaReferenceListener listener=(DnaReferenceListener)iter.next();
							listener.memberEntityReferenceAdded(fr.curie.BiNoM.pathways.biopax.DnaReferenceImpl.this,_memberEntityReference);
						}
					}
				}
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.DnaReference.TYPE)) {
					fr.curie.BiNoM.pathways.biopax.DnaReference _memberEntityReference_asDnaReference = null;
					try {
						_memberEntityReference_asDnaReference = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getDnaReference(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (memberEntityReference_asDnaReference == null) {
					...
					if (!memberEntityReference_asDnaReference.contains(_memberEntityReference_asDnaReference))
						memberEntityReference_asDnaReference.add(_memberEntityReference_asDnaReference);
					if (listeners != null) {
						java.util.ArrayList consumersForMemberEntityReference_asDnaReference;
						synchronized (listeners) {
							consumersForMemberEntityReference_asDnaReference = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForMemberEntityReference_asDnaReference.iterator();iter.hasNext();){
							DnaReferenceListener listener=(DnaReferenceListener)iter.next();
							listener.memberEntityReferenceAdded(fr.curie.BiNoM.pathways.biopax.DnaReferenceImpl.this,_memberEntityReference_asDnaReference);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(entityReferenceTypeProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DnaReferenceListener listener=(DnaReferenceListener)iter.next();
						listener.entityReferenceTypeChanged(fr.curie.BiNoM.pathways.biopax.DnaReferenceImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForEntityFeature.iterator();iter.hasNext();){
							DnaReferenceListener listener=(DnaReferenceListener)iter.next();
							listener.entityFeatureAdded(fr.curie.BiNoM.pathways.biopax.DnaReferenceImpl.this,_entityFeature);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						DnaReferenceListener listener=(DnaReferenceListener)iter.next();
						listener.nameAdded(fr.curie.BiNoM.pathways.biopax.DnaReferenceImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForEvidence.iterator();iter.hasNext();){
							DnaReferenceListener listener=(DnaReferenceListener)iter.next();
							listener.evidenceAdded(fr.curie.BiNoM.pathways.biopax.DnaReferenceImpl.this,_evidence);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForXref.iterator();iter.hasNext();){
							DnaReferenceListener listener=(DnaReferenceListener)iter.next();
							listener.xrefAdded(fr.curie.BiNoM.pathways.biopax.DnaReferenceImpl.this,_xref);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(sequenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DnaReferenceListener listener=(DnaReferenceListener)iter.next();
						listener.sequenceChanged(fr.curie.BiNoM.pathways.biopax.DnaReferenceImpl.this);
					}
				}
				return;
			}
				...
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.DnaRegionReference.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubRegion_asDnaRegionReference.iterator();iter.hasNext();){
							DnaReferenceListener listener=(DnaReferenceListener)iter.next();
							listener.subRegionAdded(fr.curie.BiNoM.pathways.biopax.DnaReferenceImpl.this,_subRegion_asDnaRegionReference);
						}
					}
				}
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.RnaRegionReference.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubRegion_asRnaRegionReference.iterator();iter.hasNext();){
							DnaReferenceListener listener=(DnaReferenceListener)iter.next();
							listener.subRegionAdded(fr.curie.BiNoM.pathways.biopax.DnaReferenceImpl.this,_subRegion_asRnaRegionReference);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(organismProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DnaReferenceListener listener=(DnaReferenceListener)iter.next();
						listener.organismChanged(fr.curie.BiNoM.pathways.biopax.DnaReferenceImpl.this);
					}
				}
				return;
			}
...
//				return;
			if (stmt.getPredicate().equals(commentProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DnaReferenceListener listener=(DnaReferenceListener)iter.next();
						listener.commentRemoved(fr.curie.BiNoM.pathways.biopax.DnaReferenceImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(memberEntityReferenceProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMemberEntityReference.iterator();iter.hasNext();){
							DnaReferenceListener listener=(DnaReferenceListener)iter.next();
							listener.memberEntityReferenceRemoved(fr.curie.BiNoM.pathways.biopax.DnaReferenceImpl.this,_memberEntityReference);
						}
					}
				}
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.DnaReference.TYPE)) {
					...
					if (memberEntityReference_asDnaReference != null) {
						boolean found = false;
						for (int i=0;i<memberEntityReference_asDnaReference.size();i++) {
							fr.curie.BiNoM.pathways.biopax.DnaReference __item = (fr.curie.BiNoM.pathways.biopax.DnaReference) memberEntityReference_asDnaReference.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_memberEntityReference_asDnaReference = __item;
								break;
							}
						}
						if (found)
							memberEntityReference_asDnaReference.remove(_memberEntityReference_asDnaReference);
						else {
							try {
								_memberEntityReference_asDnaReference = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getDnaReference(resource,_model);
							} catch (JastorException e) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMemberEntityReference_asDnaReference.iterator();iter.hasNext();){
							DnaReferenceListener listener=(DnaReferenceListener)iter.next();
							listener.memberEntityReferenceRemoved(fr.curie.BiNoM.pathways.biopax.DnaReferenceImpl.this,_memberEntityReference_asDnaReference);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(entityFeatureProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForEntityFeature.iterator();iter.hasNext();){
							DnaReferenceListener listener=(DnaReferenceListener)iter.next();
							listener.entityFeatureRemoved(fr.curie.BiNoM.pathways.biopax.DnaReferenceImpl.this,_entityFeature);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DnaReferenceListener listener=(DnaReferenceListener)iter.next();
						listener.nameRemoved(fr.curie.BiNoM.pathways.biopax.DnaReferenceImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(evidenceProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForEvidence.iterator();iter.hasNext();){
							DnaReferenceListener listener=(DnaReferenceListener)iter.next();
							listener.evidenceRemoved(fr.curie.BiNoM.pathways.biopax.DnaReferenceImpl.this,_evidence);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(xrefProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForXref.iterator();iter.hasNext();){
							DnaReferenceListener listener=(DnaReferenceListener)iter.next();
							listener.xrefRemoved(fr.curie.BiNoM.pathways.biopax.DnaReferenceImpl.this,_xref);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(subRegionProperty)) {
				...
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.DnaRegionReference.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubRegion_asDnaRegionReference.iterator();iter.hasNext();){
							DnaReferenceListener listener=(DnaReferenceListener)iter.next();
							listener.subRegionRemoved(fr.curie.BiNoM.pathways.biopax.DnaReferenceImpl.this,_subRegion_asDnaRegionReference);
						}
					}
				}
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.RnaRegionReference.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubRegion_asRnaRegionReference.iterator();iter.hasNext();){
							DnaReferenceListener listener=(DnaReferenceListener)iter.next();
							listener.subRegionRemoved(fr.curie.BiNoM.pathways.biopax.DnaReferenceImpl.this,_subRegion_asRnaRegionReference);
						}
					}
				}
				return;
