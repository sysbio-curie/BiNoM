...
public interface InteractionListener extends com.ibm.adtech.jastor.ThingListener {
	 ...
	 */	
	public void dataSourceAdded(fr.curie.BiNoM.pathways.biopax.Interaction source, fr.curie.BiNoM.pathways.biopax.Provenance newValue);
	 ...
	 */
	public void dataSourceRemoved(fr.curie.BiNoM.pathways.biopax.Interaction source, fr.curie.BiNoM.pathways.biopax.Provenance oldValue);
	 ...
	 * @param newValue the object representing the new value
	 */	
	public void nameAdded(fr.curie.BiNoM.pathways.biopax.Interaction source, java.lang.String newValue);
	 ...
	 * @param oldValue the object representing the removed value
	 */	
	public void nameRemoved(fr.curie.BiNoM.pathways.biopax.Interaction source, java.lang.String oldValue);
	 ...
	 * @param source the affected instance of fr.curie.BiNoM.pathways.biopax.Interaction
	 */
	public void interactionTypeChanged(fr.curie.BiNoM.pathways.biopax.Interaction source);
	 ...
	 * @param newValue the object representing the new value
	 */	
	public void participantAdded(fr.curie.BiNoM.pathways.biopax.Interaction source, fr.curie.BiNoM.pathways.biopax.Entity newValue);
	 ...
	 * @param oldValue the object representing the removed value
	 */
	public void participantRemoved(fr.curie.BiNoM.pathways.biopax.Interaction source, fr.curie.BiNoM.pathways.biopax.Entity oldValue);
