...
/**
 * Implementation of {@link fr.curie.BiNoM.pathways.biopax.CellVocabulary}
 ...
 * <br>
 */
public class CellVocabularyImpl extends com.ibm.adtech.jastor.ThingImpl implements fr.curie.BiNoM.pathways.biopax.CellVocabulary {
	...
	CellVocabularyImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static CellVocabularyImpl getCellVocabulary(Resource resource, Model model) throws JastorException {
		return new CellVocabularyImpl(resource, model);
	}
	    
	static CellVocabularyImpl createCellVocabulary(Resource resource, Model model) throws JastorException {
		CellVocabularyImpl impl = new CellVocabularyImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, CellVocabulary.TYPE)))
			impl._model.add(impl._resource, RDF.type, CellVocabulary.TYPE);
		impl.addSuperTypes();
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, fr.curie.BiNoM.pathways.biopax.CellVocabulary.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	private void initComment() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#comment properties in CellVocabulary model not a Literal", stmt.getObject());
	...
	private void initTerm() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#term properties in CellVocabulary model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initXref() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#xref properties in CellVocabulary model not a Resource", stmt.getObject());
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof CellVocabularyListener))
			throw new IllegalArgumentException("ThingListener must be instance of CellVocabularyListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((CellVocabularyListener)listener);
		}
	}
			...
			if (stmt.getPredicate().equals(commentProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForComment.iterator();iter.hasNext();){
						CellVocabularyListener listener=(CellVocabularyListener)iter.next();
						listener.commentAdded(fr.curie.BiNoM.pathways.biopax.CellVocabularyImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(termProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForTerm.iterator();iter.hasNext();){
						CellVocabularyListener listener=(CellVocabularyListener)iter.next();
						listener.termAdded(fr.curie.BiNoM.pathways.biopax.CellVocabularyImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForXref.iterator();iter.hasNext();){
							CellVocabularyListener listener=(CellVocabularyListener)iter.next();
							listener.xrefAdded(fr.curie.BiNoM.pathways.biopax.CellVocabularyImpl.this,_xref);
						}
					}
				}
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.UnificationXref.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForXref_asUnificationXref.iterator();iter.hasNext();){
							CellVocabularyListener listener=(CellVocabularyListener)iter.next();
							listener.xrefAdded(fr.curie.BiNoM.pathways.biopax.CellVocabularyImpl.this,_xref_asUnificationXref);
						}
					}
				}
				return;
...
//				return;
			if (stmt.getPredicate().equals(commentProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CellVocabularyListener listener=(CellVocabularyListener)iter.next();
						listener.commentRemoved(fr.curie.BiNoM.pathways.biopax.CellVocabularyImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(termProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CellVocabularyListener listener=(CellVocabularyListener)iter.next();
						listener.termRemoved(fr.curie.BiNoM.pathways.biopax.CellVocabularyImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(xrefProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForXref.iterator();iter.hasNext();){
							CellVocabularyListener listener=(CellVocabularyListener)iter.next();
							listener.xrefRemoved(fr.curie.BiNoM.pathways.biopax.CellVocabularyImpl.this,_xref);
						}
					}
				}
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.UnificationXref.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForXref_asUnificationXref.iterator();iter.hasNext();){
							CellVocabularyListener listener=(CellVocabularyListener)iter.next();
							listener.xrefRemoved(fr.curie.BiNoM.pathways.biopax.CellVocabularyImpl.this,_xref_asUnificationXref);
						}
					}
				}
				return;
