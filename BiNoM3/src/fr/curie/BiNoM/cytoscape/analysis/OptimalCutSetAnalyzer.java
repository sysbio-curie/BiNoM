	...
	public OptimalCutSetAnalyzer(){
	   ...
	   public void actionPerformed(ActionEvent e){
	    	if(Launcher.getAdapter().getCyApplicationManager().getCurrentNetwork()!=null){
	    		...
	    		OptimalCutSetAnalyzerDialog dialog = new OptimalCutSetAnalyzerDialog(Launcher.getCySwingAppAdapter().getCySwingApplication().getJFrame(),"Optimal Combinations of Intervention (CI) Strategies for Network Analysis",true);
