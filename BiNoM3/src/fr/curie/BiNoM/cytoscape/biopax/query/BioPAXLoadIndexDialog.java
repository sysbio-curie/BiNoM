...
public class BioPAXLoadIndexDialog extends JFrame {
    ...
    private BioPAXLoadIndexDialog() {
	super("Load BioPAX Index");
	final JPanel panel = new JPanel(new GridBagLayout());
	GridBagConstraints c;
	int y = 0;
	int x = 0;

	JLabel title = new JLabel("Load BioPAX Index");
	...
	JLabel lab1 = new JLabel("  Index File  ");
	c = new GridBagConstraints();
	c.gridx = x++;
	c.gridy = y;
	c.ipady = 10;	
...
//		    toFront();
	...
	JLabel lab2 = new JLabel("  Accession Number File  ");
	x = 0;
	c = new GridBagConstraints();
	c.ipady = 20;	
	c.gridx = x++;
	...
	browseAccNum.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent e) {
			...
			fileChooser.setDialogTitle("Load Accession Number File");
...
//		    File file = FileUtil.getFile
//			("Load Accession Number File", FileUtil.LOAD);
...
//		    toFront();
    ...
    public static BioPAXLoadIndexDialog instance;

    public static BioPAXLoadIndexDialog getInstance() {
	if (instance == null)
	    instance = new BioPAXLoadIndexDialog();
	return instance;
    }
