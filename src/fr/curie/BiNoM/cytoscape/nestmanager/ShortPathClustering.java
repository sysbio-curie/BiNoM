...
public class ShortPathClustering {
	...
	protected class Cluster{
		...
		public String toString(){
			...
			String txt="["+Launcher.findNetworkofNode(cBFS.nodes.get(it.next()).getSUID()).getRow(cBFS.nodes.get(it.next())).get(CyNetwork.NAME, String.class);
			while(it.hasNext()) txt=txt+","+Launcher.findNetworkofNode(cBFS.nodes.get(it.next()).getSUID()).getRow(cBFS.nodes.get(it.next())).get(CyNetwork.NAME, String.class);
			return (txt+"]");
		}
	}
