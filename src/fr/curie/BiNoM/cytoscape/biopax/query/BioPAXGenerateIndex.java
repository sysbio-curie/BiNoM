...
public class BioPAXGenerateIndex implements ActionListener {

    public BioPAXGenerateIndex() {
    }

    public void actionPerformed(ActionEvent e) {
        System.out.println("BioPAXGenerateIndex");
	BioPAXGenerateIndexDialog.getInstance().raise(null);
    }
}
