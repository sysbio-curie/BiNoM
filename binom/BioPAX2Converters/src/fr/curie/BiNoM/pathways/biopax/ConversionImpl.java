...
public class ConversionImpl extends com.ibm.adtech.jastor.ThingImpl implements fr.curie.BiNoM.pathways.biopax.Conversion {
	...
	private void initDataSource() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#dataSource properties in Conversion model not a Resource", stmt.getObject());
	...
	private void initAvailability() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#availability properties in Conversion model not a Literal", stmt.getObject());
	...
	private void initComment() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#comment properties in Conversion model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initName() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#name properties in Conversion model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initEvidence() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#evidence properties in Conversion model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initXref() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#xref properties in Conversion model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public fr.curie.BiNoM.pathways.biopax.InteractionVocabulary getInteractionType() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": interactionType getProperty() in fr.curie.BiNoM.pathways.biopax.Conversion model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	private void initParticipant() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#participant properties in Conversion model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initParticipantStoichiometry() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#participantStoichiometry properties in Conversion model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initLeft() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#left properties in Conversion model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public java.lang.String getConversionDirection() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": conversionDirection getProperty() in fr.curie.BiNoM.pathways.biopax.Conversion model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initRight() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#right properties in Conversion model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDataSource.iterator();iter.hasNext();){
							...
							listener.dataSourceAdded(fr.curie.BiNoM.pathways.biopax.ConversionImpl.this,_dataSource);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						ConversionListener listener=(ConversionListener)iter.next();
						listener.nameAdded(fr.curie.BiNoM.pathways.biopax.ConversionImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			...
			if (stmt.getPredicate().equals(interactionTypeProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						ConversionListener listener=(ConversionListener)iter.next();
						listener.interactionTypeChanged(fr.curie.BiNoM.pathways.biopax.ConversionImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForParticipant.iterator();iter.hasNext();){
							ConversionListener listener=(ConversionListener)iter.next();
							listener.participantAdded(fr.curie.BiNoM.pathways.biopax.ConversionImpl.this,_participant);
						}
					}
				}
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.PhysicalEntity.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForParticipant_asPhysicalEntity.iterator();iter.hasNext();){
							ConversionListener listener=(ConversionListener)iter.next();
							listener.participantAdded(fr.curie.BiNoM.pathways.biopax.ConversionImpl.this,_participant_asPhysicalEntity);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForParticipantStoichiometry.iterator();iter.hasNext();){
							ConversionListener listener=(ConversionListener)iter.next();
							listener.participantStoichiometryAdded(fr.curie.BiNoM.pathways.biopax.ConversionImpl.this,_participantStoichiometry);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(conversionDirectionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						ConversionListener listener=(ConversionListener)iter.next();
						listener.conversionDirectionChanged(fr.curie.BiNoM.pathways.biopax.ConversionImpl.this);
					}
				}
				return;
			}
...
//				return;
			if (stmt.getPredicate().equals(dataSourceProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDataSource.iterator();iter.hasNext();){
							ConversionListener listener=(ConversionListener)iter.next();
							listener.dataSourceRemoved(fr.curie.BiNoM.pathways.biopax.ConversionImpl.this,_dataSource);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						ConversionListener listener=(ConversionListener)iter.next();
						listener.nameRemoved(fr.curie.BiNoM.pathways.biopax.ConversionImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			...
			if (stmt.getPredicate().equals(participantProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForParticipant.iterator();iter.hasNext();){
							ConversionListener listener=(ConversionListener)iter.next();
							listener.participantRemoved(fr.curie.BiNoM.pathways.biopax.ConversionImpl.this,_participant);
						}
					}
				}
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.PhysicalEntity.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForParticipant_asPhysicalEntity.iterator();iter.hasNext();){
							ConversionListener listener=(ConversionListener)iter.next();
							listener.participantRemoved(fr.curie.BiNoM.pathways.biopax.ConversionImpl.this,_participant_asPhysicalEntity);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(participantStoichiometryProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForParticipantStoichiometry.iterator();iter.hasNext();){
							ConversionListener listener=(ConversionListener)iter.next();
							listener.participantStoichiometryRemoved(fr.curie.BiNoM.pathways.biopax.ConversionImpl.this,_participantStoichiometry);
						}
					}
				}
				return;
