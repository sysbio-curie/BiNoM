...
\textbf{Plugins$\Rightarrow$BiNoM 2.0$\Rightarrow$BiNoM  I/O$\Rightarrow$Import BioPAX 3 Document from file}\\
...
\end{itemize}\
\textbf{Plugins$\Rightarrow$BiNoM 2.0$\Rightarrow$BiNoM I/O$\Rightarrow$Import BioPAX 3 Document from URL}\\
...
\textbf{Plugins$\Rightarrow$BiNoM 2.0$\Rightarrow$BiNoM I/O$\Rightarrow$Import CellDesigner Document from file}\\
...
\textbf{Plugins$\Rightarrow$BiNoM 2.0$\Rightarrow$BiNoM I/O$\Rightarrow$Import CSML document}\\
...
\textbf{Plugins$\Rightarrow$BiNoM 2.0$\Rightarrow$BiNoM I/O$\Rightarrow$Import AIN file}\\
...
\begin{itemize}
\item \textbf{Plugins$\Rightarrow$BiNoM 2.0$\Rightarrow$BiNoM I/O$\Rightarrow$Export current network to BioPAX 3}
\item \textbf{Plugins$\Rightarrow$BiNoM 2.0$\Rightarrow$BiNoM I/O$\Rightarrow$Export current network to CellDesigner}
\end{itemize}
...
\textbf{Plugins$\Rightarrow$BiNoM 2.0$\Rightarrow$BiNoM I/O$\Rightarrow$Export current network to SBML}\\
Export the current network to pure SBML level 2.

\subsection{Associate BioPAX 3 Source} \label{Associate_BioPAX_Source}
\textbf{Plugins$\Rightarrow$BiNoM 2.0$\Rightarrow$BiNoM I/O$\Rightarrow$Associate BioPAX 3 Source}\\
...
\textbf{Plugins$\Rightarrow$BiNoM 2.0$\Rightarrow$BiNoM I/O$\Rightarrow$Save whole associated BioPAX 3 as}\\
...
\textbf{Plugins$\Rightarrow$BiNoM 2.0$\Rightarrow$BiNoM I/O$\Rightarrow$List all reactions} \\
Display list of reactions, can be copied by control+A then control+C.

\subsection{List all nodes}
\textbf{Plugins$\Rightarrow$BiNoM 2.0$\Rightarrow$BiNoM I/O$\Rightarrow$List all nodes} \\
Display list of nodes, can be copied by control+A then control+C.

\subsection{Color CellDesigner proteins}
\textbf{Plugins$\Rightarrow$BiNoM 2.0$\Rightarrow$BiNoM I/O$\Rightarrow$Color CellDesigner proteins}\\
