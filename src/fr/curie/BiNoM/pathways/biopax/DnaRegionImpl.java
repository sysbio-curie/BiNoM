...
/**
 * Implementation of {@link fr.curie.BiNoM.pathways.biopax.DnaRegion}
 ...
 * <br>
 */
public class DnaRegionImpl extends com.ibm.adtech.jastor.ThingImpl implements fr.curie.BiNoM.pathways.biopax.DnaRegion {
	...
	private java.util.ArrayList memberPhysicalEntity_asDnaRegion;
	...
	private fr.curie.BiNoM.pathways.biopax.DnaRegionReference entityReference_asDnaRegionReference;

	DnaRegionImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static DnaRegionImpl getDnaRegion(Resource resource, Model model) throws JastorException {
		return new DnaRegionImpl(resource, model);
	}
	    
	static DnaRegionImpl createDnaRegion(Resource resource, Model model) throws JastorException {
		DnaRegionImpl impl = new DnaRegionImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, DnaRegion.TYPE)))
			impl._model.add(impl._resource, RDF.type, DnaRegion.TYPE);
		impl.addSuperTypes();
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, fr.curie.BiNoM.pathways.biopax.DnaRegion.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	public void clearCache() {
		...
		memberPhysicalEntity_asDnaRegion = null;
		cellularLocation = null;
		entityReference = null;
		entityReference_asDnaRegionReference = null;
	}
	...
	private void initDataSource() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#dataSource properties in DnaRegion model not a Resource", stmt.getObject());
	...
	private void initAvailability() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#availability properties in DnaRegion model not a Literal", stmt.getObject());
	...
	private void initComment() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#comment properties in DnaRegion model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initName() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#name properties in DnaRegion model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initEvidence() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#evidence properties in DnaRegion model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initXref() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#xref properties in DnaRegion model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initFeature() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#feature properties in DnaRegion model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initNotFeature() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#notFeature properties in DnaRegion model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initMemberPhysicalEntity() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#memberPhysicalEntity properties in DnaRegion model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initMemberPhysicalEntity_asDnaRegion() throws JastorException {
		this.memberPhysicalEntity_asDnaRegion = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, memberPhysicalEntityProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			...
			if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.DnaRegion.TYPE)) {
				fr.curie.BiNoM.pathways.biopax.DnaRegion memberPhysicalEntity = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getDnaRegion(resource,_model);
				this.memberPhysicalEntity_asDnaRegion.add(memberPhysicalEntity);
			}
		}
	}

	public java.util.Iterator getMemberPhysicalEntity_asDnaRegion() throws JastorException {
		if (memberPhysicalEntity_asDnaRegion == null)
			initMemberPhysicalEntity_asDnaRegion();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(memberPhysicalEntity_asDnaRegion,_resource,memberPhysicalEntityProperty,true);
	}

	public void addMemberPhysicalEntity(fr.curie.BiNoM.pathways.biopax.DnaRegion memberPhysicalEntity) throws JastorException {
		if (this.memberPhysicalEntity_asDnaRegion == null)
			initMemberPhysicalEntity_asDnaRegion();
		if (this.memberPhysicalEntity_asDnaRegion.contains(memberPhysicalEntity)) {
			this.memberPhysicalEntity_asDnaRegion.remove(memberPhysicalEntity);
			this.memberPhysicalEntity_asDnaRegion.add(memberPhysicalEntity);
			return;
		}
		this.memberPhysicalEntity_asDnaRegion.add(memberPhysicalEntity);
	...
	public fr.curie.BiNoM.pathways.biopax.DnaRegion addMemberPhysicalEntity_asDnaRegion() throws JastorException {
		fr.curie.BiNoM.pathways.biopax.DnaRegion memberPhysicalEntity = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.createDnaRegion(_model.createResource(),_model);
		if (this.memberPhysicalEntity_asDnaRegion == null)
			initMemberPhysicalEntity_asDnaRegion();
		this.memberPhysicalEntity_asDnaRegion.add(memberPhysicalEntity);
		_model.add(_model.createStatement(_resource,memberPhysicalEntityProperty,memberPhysicalEntity.resource()));
	...
	public fr.curie.BiNoM.pathways.biopax.DnaRegion addMemberPhysicalEntity_asDnaRegion(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		fr.curie.BiNoM.pathways.biopax.DnaRegion memberPhysicalEntity = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getDnaRegion(resource,_model);
		if (this.memberPhysicalEntity_asDnaRegion == null)
			initMemberPhysicalEntity_asDnaRegion();
		if (this.memberPhysicalEntity_asDnaRegion.contains(memberPhysicalEntity))
	...
	public void removeMemberPhysicalEntity(fr.curie.BiNoM.pathways.biopax.DnaRegion memberPhysicalEntity) throws JastorException {
		if (this.memberPhysicalEntity_asDnaRegion == null)
			initMemberPhysicalEntity_asDnaRegion();
		if (!this.memberPhysicalEntity_asDnaRegion.contains(memberPhysicalEntity))
			return;
	...
	public fr.curie.BiNoM.pathways.biopax.CellularLocationVocabulary getCellularLocation() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": cellularLocation getProperty() in fr.curie.BiNoM.pathways.biopax.DnaRegion model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	public fr.curie.BiNoM.pathways.biopax.EntityReference getEntityReference() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": entityReference getProperty() in fr.curie.BiNoM.pathways.biopax.DnaRegion model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	public fr.curie.BiNoM.pathways.biopax.DnaRegionReference getEntityReference_asDnaRegionReference() throws JastorException {
		if (entityReference_asDnaRegionReference != null)
			return entityReference_asDnaRegionReference;
		com.hp.hpl.jena.rdf.model.Statement stmt = _model.getProperty(_resource, entityReferenceProperty);
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": entityReference_asDnaRegionReference getProperty() in fr.curie.BiNoM.pathways.biopax.DnaRegion model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
		if (!_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.DnaRegionReference.TYPE))
			return null;
		entityReference_asDnaRegionReference = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getDnaRegionReference(resource,_model);
		return entityReference_asDnaRegionReference;
	}

	public void setEntityReference(fr.curie.BiNoM.pathways.biopax.DnaRegionReference entityReference) throws JastorException {
		if (_model.contains(_resource,entityReferenceProperty)) {
			_model.removeAll(_resource,entityReferenceProperty,null);
		}
		this.entityReference_asDnaRegionReference = entityReference;
		if (entityReference != null) {
			_model.add(_model.createStatement(_resource,entityReferenceProperty, entityReference.resource()));
		}			
	}
		
	public fr.curie.BiNoM.pathways.biopax.DnaRegionReference setEntityReference_asDnaRegionReference() throws JastorException {
		if (_model.contains(_resource,entityReferenceProperty)) {
			_model.removeAll(_resource,entityReferenceProperty,null);
		}
		fr.curie.BiNoM.pathways.biopax.DnaRegionReference entityReference = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.createDnaRegionReference(_model.createResource(),_model);
		this.entityReference_asDnaRegionReference = entityReference;
		_model.add(_model.createStatement(_resource,entityReferenceProperty, entityReference.resource()));
		return entityReference;
	}
	
	public fr.curie.BiNoM.pathways.biopax.DnaRegionReference setEntityReference_asDnaRegionReference(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		if (_model.contains(_resource,entityReferenceProperty)) {
			_model.removeAll(_resource,entityReferenceProperty,null);
		}
		fr.curie.BiNoM.pathways.biopax.DnaRegionReference entityReference = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getDnaRegionReference(resource,_model);
		this.entityReference_asDnaRegionReference = entityReference;
		_model.add(_model.createStatement(_resource,entityReferenceProperty, entityReference.resource()));
		return entityReference;
	}
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof DnaRegionListener))
			throw new IllegalArgumentException("ThingListener must be instance of DnaRegionListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((DnaRegionListener)listener);
		}
	}
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDataSource.iterator();iter.hasNext();){
							DnaRegionListener listener=(DnaRegionListener)iter.next();
							listener.dataSourceAdded(fr.curie.BiNoM.pathways.biopax.DnaRegionImpl.this,_dataSource);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(availabilityProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForAvailability.iterator();iter.hasNext();){
						DnaRegionListener listener=(DnaRegionListener)iter.next();
						listener.availabilityAdded(fr.curie.BiNoM.pathways.biopax.DnaRegionImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(commentProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForComment.iterator();iter.hasNext();){
						DnaRegionListener listener=(DnaRegionListener)iter.next();
						listener.commentAdded(fr.curie.BiNoM.pathways.biopax.DnaRegionImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						DnaRegionListener listener=(DnaRegionListener)iter.next();
						listener.nameAdded(fr.curie.BiNoM.pathways.biopax.DnaRegionImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForEvidence.iterator();iter.hasNext();){
							DnaRegionListener listener=(DnaRegionListener)iter.next();
							listener.evidenceAdded(fr.curie.BiNoM.pathways.biopax.DnaRegionImpl.this,_evidence);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForXref.iterator();iter.hasNext();){
							DnaRegionListener listener=(DnaRegionListener)iter.next();
							listener.xrefAdded(fr.curie.BiNoM.pathways.biopax.DnaRegionImpl.this,_xref);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeature.iterator();iter.hasNext();){
							DnaRegionListener listener=(DnaRegionListener)iter.next();
							listener.featureAdded(fr.curie.BiNoM.pathways.biopax.DnaRegionImpl.this,_feature);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForNotFeature.iterator();iter.hasNext();){
							DnaRegionListener listener=(DnaRegionListener)iter.next();
							listener.notFeatureAdded(fr.curie.BiNoM.pathways.biopax.DnaRegionImpl.this,_notFeature);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMemberPhysicalEntity.iterator();iter.hasNext();){
							DnaRegionListener listener=(DnaRegionListener)iter.next();
							listener.memberPhysicalEntityAdded(fr.curie.BiNoM.pathways.biopax.DnaRegionImpl.this,_memberPhysicalEntity);
						}
					}
				}
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.DnaRegion.TYPE)) {
					fr.curie.BiNoM.pathways.biopax.DnaRegion _memberPhysicalEntity_asDnaRegion = null;
					try {
						_memberPhysicalEntity_asDnaRegion = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getDnaRegion(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (memberPhysicalEntity_asDnaRegion == null) {
					...
					if (!memberPhysicalEntity_asDnaRegion.contains(_memberPhysicalEntity_asDnaRegion))
						memberPhysicalEntity_asDnaRegion.add(_memberPhysicalEntity_asDnaRegion);
					if (listeners != null) {
						java.util.ArrayList consumersForMemberPhysicalEntity_asDnaRegion;
						synchronized (listeners) {
							consumersForMemberPhysicalEntity_asDnaRegion = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForMemberPhysicalEntity_asDnaRegion.iterator();iter.hasNext();){
							DnaRegionListener listener=(DnaRegionListener)iter.next();
							listener.memberPhysicalEntityAdded(fr.curie.BiNoM.pathways.biopax.DnaRegionImpl.this,_memberPhysicalEntity_asDnaRegion);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(cellularLocationProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DnaRegionListener listener=(DnaRegionListener)iter.next();
						listener.cellularLocationChanged(fr.curie.BiNoM.pathways.biopax.DnaRegionImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(entityReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DnaRegionListener listener=(DnaRegionListener)iter.next();
						listener.entityReferenceChanged(fr.curie.BiNoM.pathways.biopax.DnaRegionImpl.this);
					}
				}
				return;
			}
...
//				return;
			if (stmt.getPredicate().equals(dataSourceProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDataSource.iterator();iter.hasNext();){
							DnaRegionListener listener=(DnaRegionListener)iter.next();
							listener.dataSourceRemoved(fr.curie.BiNoM.pathways.biopax.DnaRegionImpl.this,_dataSource);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(availabilityProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DnaRegionListener listener=(DnaRegionListener)iter.next();
						listener.availabilityRemoved(fr.curie.BiNoM.pathways.biopax.DnaRegionImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(commentProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DnaRegionListener listener=(DnaRegionListener)iter.next();
						listener.commentRemoved(fr.curie.BiNoM.pathways.biopax.DnaRegionImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DnaRegionListener listener=(DnaRegionListener)iter.next();
						listener.nameRemoved(fr.curie.BiNoM.pathways.biopax.DnaRegionImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(evidenceProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForEvidence.iterator();iter.hasNext();){
							DnaRegionListener listener=(DnaRegionListener)iter.next();
							listener.evidenceRemoved(fr.curie.BiNoM.pathways.biopax.DnaRegionImpl.this,_evidence);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(xrefProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForXref.iterator();iter.hasNext();){
							DnaRegionListener listener=(DnaRegionListener)iter.next();
							listener.xrefRemoved(fr.curie.BiNoM.pathways.biopax.DnaRegionImpl.this,_xref);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(featureProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeature.iterator();iter.hasNext();){
							DnaRegionListener listener=(DnaRegionListener)iter.next();
							listener.featureRemoved(fr.curie.BiNoM.pathways.biopax.DnaRegionImpl.this,_feature);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(notFeatureProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForNotFeature.iterator();iter.hasNext();){
							DnaRegionListener listener=(DnaRegionListener)iter.next();
							listener.notFeatureRemoved(fr.curie.BiNoM.pathways.biopax.DnaRegionImpl.this,_notFeature);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(memberPhysicalEntityProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMemberPhysicalEntity.iterator();iter.hasNext();){
							DnaRegionListener listener=(DnaRegionListener)iter.next();
							listener.memberPhysicalEntityRemoved(fr.curie.BiNoM.pathways.biopax.DnaRegionImpl.this,_memberPhysicalEntity);
						}
					}
				}
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.DnaRegion.TYPE)) {
					...
					if (memberPhysicalEntity_asDnaRegion != null) {
						boolean found = false;
						for (int i=0;i<memberPhysicalEntity_asDnaRegion.size();i++) {
							fr.curie.BiNoM.pathways.biopax.DnaRegion __item = (fr.curie.BiNoM.pathways.biopax.DnaRegion) memberPhysicalEntity_asDnaRegion.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_memberPhysicalEntity_asDnaRegion = __item;
								break;
							}
						}
						if (found)
							memberPhysicalEntity_asDnaRegion.remove(_memberPhysicalEntity_asDnaRegion);
						else {
							try {
								_memberPhysicalEntity_asDnaRegion = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getDnaRegion(resource,_model);
							} catch (JastorException e) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMemberPhysicalEntity_asDnaRegion.iterator();iter.hasNext();){
							DnaRegionListener listener=(DnaRegionListener)iter.next();
							listener.memberPhysicalEntityRemoved(fr.curie.BiNoM.pathways.biopax.DnaRegionImpl.this,_memberPhysicalEntity_asDnaRegion);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(entityReferenceProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
					if (entityReference != null && entityReference.resource().equals(resource))
						entityReference = null;				
					if (entityReference_asDnaRegionReference != null && entityReference_asDnaRegionReference.resource().equals(resource))
						entityReference_asDnaRegionReference = null;				
				if (listeners != null) {
					java.util.ArrayList consumers;
					synchronized (listeners) {
