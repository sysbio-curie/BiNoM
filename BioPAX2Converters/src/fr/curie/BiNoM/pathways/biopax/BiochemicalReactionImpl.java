...
/**
 * Implementation of {@link fr.curie.BiNoM.pathways.biopax.BiochemicalReaction}
 ...
 * <br>
 */
public class BiochemicalReactionImpl extends com.ibm.adtech.jastor.ThingImpl implements fr.curie.BiNoM.pathways.biopax.BiochemicalReaction {
	...
	private static com.hp.hpl.jena.rdf.model.Property deltaGProperty = ResourceFactory.createProperty("http://www.biopax.org/release/biopax-level3.owl#deltaG");
	private java.util.ArrayList deltaG;
	private static com.hp.hpl.jena.rdf.model.Property deltaHProperty = ResourceFactory.createProperty("http://www.biopax.org/release/biopax-level3.owl#deltaH");
	private java.util.ArrayList deltaH;
	private static com.hp.hpl.jena.rdf.model.Property kEQProperty = ResourceFactory.createProperty("http://www.biopax.org/release/biopax-level3.owl#kEQ");
	private java.util.ArrayList kEQ;
	private static com.hp.hpl.jena.rdf.model.Property eCNumberProperty = ResourceFactory.createProperty("http://www.biopax.org/release/biopax-level3.owl#eCNumber");
	private java.util.ArrayList eCNumber;
	private static com.hp.hpl.jena.rdf.model.Property deltaSProperty = ResourceFactory.createProperty("http://www.biopax.org/release/biopax-level3.owl#deltaS");
	private java.util.ArrayList deltaS;

	BiochemicalReactionImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static BiochemicalReactionImpl getBiochemicalReaction(Resource resource, Model model) throws JastorException {
		return new BiochemicalReactionImpl(resource, model);
	}
	    
	static BiochemicalReactionImpl createBiochemicalReaction(Resource resource, Model model) throws JastorException {
		BiochemicalReactionImpl impl = new BiochemicalReactionImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, BiochemicalReaction.TYPE)))
			impl._model.add(impl._resource, RDF.type, BiochemicalReaction.TYPE);
		impl.addSuperTypes();
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,deltaGProperty,(RDFNode)null);
		while (it.hasNext()) {
			list.add(it.next());
		}
		it = _model.listStatements(_resource,deltaHProperty,(RDFNode)null);
		while (it.hasNext()) {
			list.add(it.next());
		}
		...
		it = _model.listStatements(_resource,eCNumberProperty,(RDFNode)null);
		while (it.hasNext()) {
			list.add(it.next());
		}
		it = _model.listStatements(_resource,deltaSProperty,(RDFNode)null);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	private void initDataSource() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#dataSource properties in BiochemicalReaction model not a Resource", stmt.getObject());
	...
	private void initAvailability() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#availability properties in BiochemicalReaction model not a Literal", stmt.getObject());
	...
	private void initComment() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#comment properties in BiochemicalReaction model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initName() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#name properties in BiochemicalReaction model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initEvidence() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#evidence properties in BiochemicalReaction model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initXref() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#xref properties in BiochemicalReaction model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public fr.curie.BiNoM.pathways.biopax.InteractionVocabulary getInteractionType() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": interactionType getProperty() in fr.curie.BiNoM.pathways.biopax.BiochemicalReaction model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	private void initParticipant() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#participant properties in BiochemicalReaction model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initParticipantStoichiometry() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#participantStoichiometry properties in BiochemicalReaction model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public java.lang.Boolean getSpontaneous() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": spontaneous getProperty() in fr.curie.BiNoM.pathways.biopax.BiochemicalReaction model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initLeft() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#left properties in BiochemicalReaction model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public java.lang.String getConversionDirection() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": conversionDirection getProperty() in fr.curie.BiNoM.pathways.biopax.BiochemicalReaction model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initRight() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#right properties in BiochemicalReaction model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initDeltaG() throws JastorException {
		this.deltaG = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, deltaGProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#deltaG properties in BiochemicalReaction model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				fr.curie.BiNoM.pathways.biopax.DeltaG deltaG = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getDeltaG(resource,_model);
				this.deltaG.add(deltaG);
			}
		}
	}

	public java.util.Iterator getDeltaG() throws JastorException {
		if (deltaG == null)
			initDeltaG();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(deltaG,_resource,deltaGProperty,true);
	}

	public void addDeltaG(fr.curie.BiNoM.pathways.biopax.DeltaG deltaG) throws JastorException {
		if (this.deltaG == null)
			initDeltaG();
		if (this.deltaG.contains(deltaG)) {
			this.deltaG.remove(deltaG);
			this.deltaG.add(deltaG);
			return;
		}
		this.deltaG.add(deltaG);
		_model.add(_model.createStatement(_resource,deltaGProperty,deltaG.resource()));
	}
	
	public fr.curie.BiNoM.pathways.biopax.DeltaG addDeltaG() throws JastorException {
		fr.curie.BiNoM.pathways.biopax.DeltaG deltaG = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.createDeltaG(_model.createResource(),_model);
		if (this.deltaG == null)
			initDeltaG();
		this.deltaG.add(deltaG);
		_model.add(_model.createStatement(_resource,deltaGProperty,deltaG.resource()));
	...
	public fr.curie.BiNoM.pathways.biopax.DeltaG addDeltaG(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		fr.curie.BiNoM.pathways.biopax.DeltaG deltaG = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getDeltaG(resource,_model);
		if (this.deltaG == null)
			initDeltaG();
		if (this.deltaG.contains(deltaG))
	...
	public void removeDeltaG(fr.curie.BiNoM.pathways.biopax.DeltaG deltaG) throws JastorException {
		if (this.deltaG == null)
			initDeltaG();
		if (!this.deltaG.contains(deltaG))
			return;
		if (!_model.contains(_resource, deltaGProperty, deltaG.resource()))
			return;
		this.deltaG.remove(deltaG);
		_model.removeAll(_resource, deltaGProperty, deltaG.resource());
	}
		 

	private void initDeltaH() throws JastorException {
		deltaH = new java.util.ArrayList();
		
		StmtIterator it = _model.listStatements(_resource, deltaHProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#deltaH properties in BiochemicalReaction model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			deltaH.add(Util.fixLiteral(literal.getValue(),"java.lang.Float"));
		}
	}

	public java.util.Iterator getDeltaH() throws JastorException {
		if (deltaH == null)
			initDeltaH();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(deltaH,_resource,deltaHProperty,false);
	}

	public void addDeltaH(java.lang.Float deltaH) throws JastorException {
		if (this.deltaH == null)
			initDeltaH();
		if (this.deltaH.contains(deltaH))
			return;
		if (_model.contains(_resource, deltaHProperty, _model.createTypedLiteral(deltaH)))
			return;
		this.deltaH.add(deltaH);
		_model.add(_resource, deltaHProperty, _model.createTypedLiteral(deltaH));
	}
	
	public void removeDeltaH(java.lang.Float deltaH) throws JastorException {
		if (this.deltaH == null)
			initDeltaH();
		if (!this.deltaH.contains(deltaH))
			return;
		...
		_model.removeAll(_resource, deltaHProperty, _model.createTypedLiteral(deltaH));
	}
	...
	private void initKEQ() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#kEQ properties in BiochemicalReaction model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				fr.curie.BiNoM.pathways.biopax.KPrime kEQ = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getKPrime(resource,_model);
				this.kEQ.add(kEQ);
			}
		}
	}
	...
	public fr.curie.BiNoM.pathways.biopax.KPrime addKEQ() throws JastorException {
		fr.curie.BiNoM.pathways.biopax.KPrime kEQ = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.createKPrime(_model.createResource(),_model);
		if (this.kEQ == null)
			initKEQ();
		this.kEQ.add(kEQ);
		_model.add(_model.createStatement(_resource,kEQProperty,kEQ.resource()));
	...
	private void initECNumber() throws JastorException {
		eCNumber = new java.util.ArrayList();
		
		StmtIterator it = _model.listStatements(_resource, eCNumberProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#eCNumber properties in BiochemicalReaction model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			eCNumber.add(Util.fixLiteral(literal.getValue(),"java.lang.String"));
		}
	}

	public java.util.Iterator getECNumber() throws JastorException {
		if (eCNumber == null)
			initECNumber();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(eCNumber,_resource,eCNumberProperty,false);
	}

	public void addECNumber(java.lang.String eCNumber) throws JastorException {
		if (this.eCNumber == null)
			initECNumber();
		if (this.eCNumber.contains(eCNumber))
			return;
		if (_model.contains(_resource, eCNumberProperty, _model.createTypedLiteral(eCNumber)))
			return;
		this.eCNumber.add(eCNumber);
		_model.add(_resource, eCNumberProperty, _model.createTypedLiteral(eCNumber));
	}
	
	public void removeECNumber(java.lang.String eCNumber) throws JastorException {
		if (this.eCNumber == null)
			initECNumber();
		if (!this.eCNumber.contains(eCNumber))
			return;
		...
		_model.removeAll(_resource, eCNumberProperty, _model.createTypedLiteral(eCNumber));
	}


	private void initDeltaS() throws JastorException {
		deltaS = new java.util.ArrayList();
		
		StmtIterator it = _model.listStatements(_resource, deltaSProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#deltaS properties in BiochemicalReaction model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			deltaS.add(Util.fixLiteral(literal.getValue(),"java.lang.Float"));
		}
	}

	public java.util.Iterator getDeltaS() throws JastorException {
		if (deltaS == null)
			initDeltaS();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(deltaS,_resource,deltaSProperty,false);
	}

	public void addDeltaS(java.lang.Float deltaS) throws JastorException {
		if (this.deltaS == null)
			initDeltaS();
		if (this.deltaS.contains(deltaS))
			return;
		if (_model.contains(_resource, deltaSProperty, _model.createTypedLiteral(deltaS)))
			return;
		this.deltaS.add(deltaS);
		_model.add(_resource, deltaSProperty, _model.createTypedLiteral(deltaS));
	}
	
	public void removeDeltaS(java.lang.Float deltaS) throws JastorException {
		if (this.deltaS == null)
			initDeltaS();
		if (!this.deltaS.contains(deltaS))
			return;
		if (!_model.contains(_resource, deltaSProperty, _model.createTypedLiteral(deltaS)))
			return;
		this.deltaS.remove(deltaS);
		_model.removeAll(_resource, deltaSProperty, _model.createTypedLiteral(deltaS));
	}
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof BiochemicalReactionListener))
			throw new IllegalArgumentException("ThingListener must be instance of BiochemicalReactionListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((BiochemicalReactionListener)listener);
		}
	}
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDataSource.iterator();iter.hasNext();){
							BiochemicalReactionListener listener=(BiochemicalReactionListener)iter.next();
							listener.dataSourceAdded(fr.curie.BiNoM.pathways.biopax.BiochemicalReactionImpl.this,_dataSource);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(availabilityProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForAvailability.iterator();iter.hasNext();){
						BiochemicalReactionListener listener=(BiochemicalReactionListener)iter.next();
						listener.availabilityAdded(fr.curie.BiNoM.pathways.biopax.BiochemicalReactionImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(commentProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForComment.iterator();iter.hasNext();){
						BiochemicalReactionListener listener=(BiochemicalReactionListener)iter.next();
						listener.commentAdded(fr.curie.BiNoM.pathways.biopax.BiochemicalReactionImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						BiochemicalReactionListener listener=(BiochemicalReactionListener)iter.next();
						listener.nameAdded(fr.curie.BiNoM.pathways.biopax.BiochemicalReactionImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForEvidence.iterator();iter.hasNext();){
							BiochemicalReactionListener listener=(BiochemicalReactionListener)iter.next();
							listener.evidenceAdded(fr.curie.BiNoM.pathways.biopax.BiochemicalReactionImpl.this,_evidence);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForXref.iterator();iter.hasNext();){
							BiochemicalReactionListener listener=(BiochemicalReactionListener)iter.next();
							listener.xrefAdded(fr.curie.BiNoM.pathways.biopax.BiochemicalReactionImpl.this,_xref);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(interactionTypeProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						BiochemicalReactionListener listener=(BiochemicalReactionListener)iter.next();
						listener.interactionTypeChanged(fr.curie.BiNoM.pathways.biopax.BiochemicalReactionImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForParticipant.iterator();iter.hasNext();){
							BiochemicalReactionListener listener=(BiochemicalReactionListener)iter.next();
							listener.participantAdded(fr.curie.BiNoM.pathways.biopax.BiochemicalReactionImpl.this,_participant);
						}
					}
				}
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.PhysicalEntity.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForParticipant_asPhysicalEntity.iterator();iter.hasNext();){
							BiochemicalReactionListener listener=(BiochemicalReactionListener)iter.next();
							listener.participantAdded(fr.curie.BiNoM.pathways.biopax.BiochemicalReactionImpl.this,_participant_asPhysicalEntity);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForParticipantStoichiometry.iterator();iter.hasNext();){
							BiochemicalReactionListener listener=(BiochemicalReactionListener)iter.next();
							listener.participantStoichiometryAdded(fr.curie.BiNoM.pathways.biopax.BiochemicalReactionImpl.this,_participantStoichiometry);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(spontaneousProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						BiochemicalReactionListener listener=(BiochemicalReactionListener)iter.next();
						listener.spontaneousChanged(fr.curie.BiNoM.pathways.biopax.BiochemicalReactionImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLeft.iterator();iter.hasNext();){
							BiochemicalReactionListener listener=(BiochemicalReactionListener)iter.next();
							listener.leftAdded(fr.curie.BiNoM.pathways.biopax.BiochemicalReactionImpl.this,_left);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(conversionDirectionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						BiochemicalReactionListener listener=(BiochemicalReactionListener)iter.next();
						listener.conversionDirectionChanged(fr.curie.BiNoM.pathways.biopax.BiochemicalReactionImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForRight.iterator();iter.hasNext();){
							BiochemicalReactionListener listener=(BiochemicalReactionListener)iter.next();
							listener.rightAdded(fr.curie.BiNoM.pathways.biopax.BiochemicalReactionImpl.this,_right);
						}
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(deltaGProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
					return;
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					fr.curie.BiNoM.pathways.biopax.DeltaG _deltaG = null;
					try {
						_deltaG = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getDeltaG(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (deltaG == null) {
					...
					if (!deltaG.contains(_deltaG))
						deltaG.add(_deltaG);
					if (listeners != null) {
						java.util.ArrayList consumersForDeltaG;
						synchronized (listeners) {
							consumersForDeltaG = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForDeltaG.iterator();iter.hasNext();){
							BiochemicalReactionListener listener=(BiochemicalReactionListener)iter.next();
							listener.deltaGAdded(fr.curie.BiNoM.pathways.biopax.BiochemicalReactionImpl.this,_deltaG);
						}
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(deltaHProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
					return;
				com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
				//Object obj = literal.getValue();
				...
				if (!deltaH.contains(obj))
					deltaH.add(obj);
				java.util.ArrayList consumersForDeltaH;
				if (listeners != null) {
					synchronized (listeners) {
						consumersForDeltaH = (java.util.ArrayList) listeners.clone();
					}
					for(java.util.Iterator iter=consumersForDeltaH.iterator();iter.hasNext();){
						BiochemicalReactionListener listener=(BiochemicalReactionListener)iter.next();
						listener.deltaHAdded(fr.curie.BiNoM.pathways.biopax.BiochemicalReactionImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(kEQProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					try {
						_kEQ = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getKPrime(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (kEQ == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForKEQ.iterator();iter.hasNext();){
							BiochemicalReactionListener listener=(BiochemicalReactionListener)iter.next();
							listener.kEQAdded(fr.curie.BiNoM.pathways.biopax.BiochemicalReactionImpl.this,_kEQ);
						}
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(eCNumberProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
					return;
				com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
				//Object obj = literal.getValue();
				...
				if (!eCNumber.contains(obj))
					eCNumber.add(obj);
				java.util.ArrayList consumersForECNumber;
				if (listeners != null) {
					synchronized (listeners) {
						consumersForECNumber = (java.util.ArrayList) listeners.clone();
					}
					for(java.util.Iterator iter=consumersForECNumber.iterator();iter.hasNext();){
						BiochemicalReactionListener listener=(BiochemicalReactionListener)iter.next();
						listener.eCNumberAdded(fr.curie.BiNoM.pathways.biopax.BiochemicalReactionImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(deltaSProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
					return;
				com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
				//Object obj = literal.getValue();
				...
				if (!deltaS.contains(obj))
					deltaS.add(obj);
				java.util.ArrayList consumersForDeltaS;
				if (listeners != null) {
					synchronized (listeners) {
						consumersForDeltaS = (java.util.ArrayList) listeners.clone();
					}
					for(java.util.Iterator iter=consumersForDeltaS.iterator();iter.hasNext();){
						BiochemicalReactionListener listener=(BiochemicalReactionListener)iter.next();
						listener.deltaSAdded(fr.curie.BiNoM.pathways.biopax.BiochemicalReactionImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
...
//				return;
			if (stmt.getPredicate().equals(dataSourceProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDataSource.iterator();iter.hasNext();){
							BiochemicalReactionListener listener=(BiochemicalReactionListener)iter.next();
							listener.dataSourceRemoved(fr.curie.BiNoM.pathways.biopax.BiochemicalReactionImpl.this,_dataSource);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(availabilityProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						BiochemicalReactionListener listener=(BiochemicalReactionListener)iter.next();
						listener.availabilityRemoved(fr.curie.BiNoM.pathways.biopax.BiochemicalReactionImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(commentProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						BiochemicalReactionListener listener=(BiochemicalReactionListener)iter.next();
						listener.commentRemoved(fr.curie.BiNoM.pathways.biopax.BiochemicalReactionImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						BiochemicalReactionListener listener=(BiochemicalReactionListener)iter.next();
						listener.nameRemoved(fr.curie.BiNoM.pathways.biopax.BiochemicalReactionImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(evidenceProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForEvidence.iterator();iter.hasNext();){
							BiochemicalReactionListener listener=(BiochemicalReactionListener)iter.next();
							listener.evidenceRemoved(fr.curie.BiNoM.pathways.biopax.BiochemicalReactionImpl.this,_evidence);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(xrefProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForXref.iterator();iter.hasNext();){
							BiochemicalReactionListener listener=(BiochemicalReactionListener)iter.next();
							listener.xrefRemoved(fr.curie.BiNoM.pathways.biopax.BiochemicalReactionImpl.this,_xref);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(participantProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForParticipant.iterator();iter.hasNext();){
							BiochemicalReactionListener listener=(BiochemicalReactionListener)iter.next();
							listener.participantRemoved(fr.curie.BiNoM.pathways.biopax.BiochemicalReactionImpl.this,_participant);
						}
					}
				}
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.PhysicalEntity.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForParticipant_asPhysicalEntity.iterator();iter.hasNext();){
							BiochemicalReactionListener listener=(BiochemicalReactionListener)iter.next();
							listener.participantRemoved(fr.curie.BiNoM.pathways.biopax.BiochemicalReactionImpl.this,_participant_asPhysicalEntity);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(participantStoichiometryProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForParticipantStoichiometry.iterator();iter.hasNext();){
							BiochemicalReactionListener listener=(BiochemicalReactionListener)iter.next();
							listener.participantStoichiometryRemoved(fr.curie.BiNoM.pathways.biopax.BiochemicalReactionImpl.this,_participantStoichiometry);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(leftProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLeft.iterator();iter.hasNext();){
							BiochemicalReactionListener listener=(BiochemicalReactionListener)iter.next();
							listener.leftRemoved(fr.curie.BiNoM.pathways.biopax.BiochemicalReactionImpl.this,_left);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(rightProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForRight.iterator();iter.hasNext();){
							BiochemicalReactionListener listener=(BiochemicalReactionListener)iter.next();
							listener.rightRemoved(fr.curie.BiNoM.pathways.biopax.BiochemicalReactionImpl.this,_right);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (deltaG != null) {
						...
						for (int i=0;i<deltaG.size();i++) {
							fr.curie.BiNoM.pathways.biopax.DeltaG __item = (fr.curie.BiNoM.pathways.biopax.DeltaG) deltaG.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_deltaG = __item;
								break;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDeltaG.iterator();iter.hasNext();){
							BiochemicalReactionListener listener=(BiochemicalReactionListener)iter.next();
							listener.deltaGRemoved(fr.curie.BiNoM.pathways.biopax.BiochemicalReactionImpl.this,_deltaG);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(deltaHProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						BiochemicalReactionListener listener=(BiochemicalReactionListener)iter.next();
						listener.deltaHRemoved(fr.curie.BiNoM.pathways.biopax.BiochemicalReactionImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(kEQProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForKEQ.iterator();iter.hasNext();){
							BiochemicalReactionListener listener=(BiochemicalReactionListener)iter.next();
							listener.kEQRemoved(fr.curie.BiNoM.pathways.biopax.BiochemicalReactionImpl.this,_kEQ);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(eCNumberProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						BiochemicalReactionListener listener=(BiochemicalReactionListener)iter.next();
						listener.eCNumberRemoved(fr.curie.BiNoM.pathways.biopax.BiochemicalReactionImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(deltaSProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						BiochemicalReactionListener listener=(BiochemicalReactionListener)iter.next();
						listener.deltaSRemoved(fr.curie.BiNoM.pathways.biopax.BiochemicalReactionImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
