...
public class LinearizeNetworkTask implements AbstractTask {

    private CellDesignerPlugin plugin;
    private GraphDocument graphDocument;

    public LinearizeNetworkTask(CellDesignerPlugin plugin, GraphDocument graphDocument) {
	this.plugin = plugin;
	this.graphDocument = graphDocument;
    }

    public String getTitle() {
	return "BiNoM: Linearize Network";
    }
