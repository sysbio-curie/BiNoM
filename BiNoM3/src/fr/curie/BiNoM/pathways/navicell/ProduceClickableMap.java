/* Stuart Pook & Eric Viara (Sysra) $Id: ProduceClickableMap.java 25377 2014-12-18 14:57:24Z eviara $
 *
 *
...
//			System.exit(0);
	...
	private static String make_tag_for_comments()
	{
		...
		sb.append("$Id: ProduceClickableMap.java 25377 2014-12-18 14:57:24Z eviara $\n");
...
//			assert !cls.equals(COMPLEX_CLASS_NAME) : id + " " + label;
	...
	static class MarkerManager
	{
		...
		MarkerManager(final File outfile) throws IOException
		{
			...
			markers.write("<!-- " + formatter.format(new Date()) + " " + System.getProperty("user.name") + " $Id: ProduceClickableMap.java 25377 2014-12-18 14:57:24Z eviara $ -->\n");
		...
		void _create_(String entity_class, String body, final String title, String shape_id, final int x, final int y)
		throws IOException
		{
						    ...
						    boolean is_php) throws FileNotFoundException
	{
		...
		out.println("<!-- $Id: ProduceClickableMap.java 25377 2014-12-18 14:57:24Z eviara $ -->");
		out.println("<head>");
...
//		out.println("<script src='/javascript/jquery/jquery.js' type='text/javascript'></script>");
		...
		if (NV2) {
			...
			out.println("<script src=\"" + jslib_dir + "/jxcolor.js" + "\" type='text/javascript'></script>");
