...
nodes. A path $k$ is defined as a the sequence of consecutive connected nodes
...
For example, a very simple influence network composed of seven nodes is shown on figure~\ref{piquantnetworks}.


\begin{figure}[h]
 \caption{\label{piquantnetworks}  \textbf{A simple influence network (a) and
two paths (b,c) extracted from the network ending to the same node.}}
