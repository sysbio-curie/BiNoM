...
/**
 * Implementation of {@link fr.curie.BiNoM.pathways.biopax.RnaRegionReference}
 ...
 * <br>
 */
public class RnaRegionReferenceImpl extends com.ibm.adtech.jastor.ThingImpl implements fr.curie.BiNoM.pathways.biopax.RnaRegionReference {
	...
	static RnaRegionReferenceImpl getRnaRegionReference(Resource resource, Model model) throws JastorException {
		return new RnaRegionReferenceImpl(resource, model);
	}
	    
	static RnaRegionReferenceImpl createRnaRegionReference(Resource resource, Model model) throws JastorException {
		RnaRegionReferenceImpl impl = new RnaRegionReferenceImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, RnaRegionReference.TYPE)))
			impl._model.add(impl._resource, RDF.type, RnaRegionReference.TYPE);
		impl.addSuperTypes();
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, fr.curie.BiNoM.pathways.biopax.RnaRegionReference.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	private void initComment() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#comment properties in RnaRegionReference model not a Literal", stmt.getObject());
	...
	private void initMemberEntityReference() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#memberEntityReference properties in RnaRegionReference model not a Resource", stmt.getObject());
	...
	public fr.curie.BiNoM.pathways.biopax.EntityReferenceTypeVocabulary getEntityReferenceType() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": entityReferenceType getProperty() in fr.curie.BiNoM.pathways.biopax.RnaRegionReference model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	private void initEntityFeature() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#entityFeature properties in RnaRegionReference model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initName() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#name properties in RnaRegionReference model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initEvidence() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#evidence properties in RnaRegionReference model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initXref() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#xref properties in RnaRegionReference model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public java.lang.String getSequence() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": sequence getProperty() in fr.curie.BiNoM.pathways.biopax.RnaRegionReference model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initSubRegion_asRnaRegionReference() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#subRegion properties in RnaRegionReference model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	public fr.curie.BiNoM.pathways.biopax.SequenceRegionVocabulary getRegionType() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": regionType getProperty() in fr.curie.BiNoM.pathways.biopax.RnaRegionReference model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	public fr.curie.BiNoM.pathways.biopax.BioSource getOrganism() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": organism getProperty() in fr.curie.BiNoM.pathways.biopax.RnaRegionReference model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	public fr.curie.BiNoM.pathways.biopax.SequenceLocation getAbsoluteRegion() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": absoluteRegion getProperty() in fr.curie.BiNoM.pathways.biopax.RnaRegionReference model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof RnaRegionReferenceListener))
			throw new IllegalArgumentException("ThingListener must be instance of RnaRegionReferenceListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((RnaRegionReferenceListener)listener);
		}
	}
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
			...
			if (stmt.getPredicate().equals(commentProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForComment.iterator();iter.hasNext();){
						RnaRegionReferenceListener listener=(RnaRegionReferenceListener)iter.next();
						listener.commentAdded(fr.curie.BiNoM.pathways.biopax.RnaRegionReferenceImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMemberEntityReference.iterator();iter.hasNext();){
							RnaRegionReferenceListener listener=(RnaRegionReferenceListener)iter.next();
							listener.memberEntityReferenceAdded(fr.curie.BiNoM.pathways.biopax.RnaRegionReferenceImpl.this,_memberEntityReference);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(entityReferenceTypeProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						RnaRegionReferenceListener listener=(RnaRegionReferenceListener)iter.next();
						listener.entityReferenceTypeChanged(fr.curie.BiNoM.pathways.biopax.RnaRegionReferenceImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForEntityFeature.iterator();iter.hasNext();){
							RnaRegionReferenceListener listener=(RnaRegionReferenceListener)iter.next();
							listener.entityFeatureAdded(fr.curie.BiNoM.pathways.biopax.RnaRegionReferenceImpl.this,_entityFeature);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						RnaRegionReferenceListener listener=(RnaRegionReferenceListener)iter.next();
						listener.nameAdded(fr.curie.BiNoM.pathways.biopax.RnaRegionReferenceImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForEvidence.iterator();iter.hasNext();){
							RnaRegionReferenceListener listener=(RnaRegionReferenceListener)iter.next();
							listener.evidenceAdded(fr.curie.BiNoM.pathways.biopax.RnaRegionReferenceImpl.this,_evidence);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForXref.iterator();iter.hasNext();){
							RnaRegionReferenceListener listener=(RnaRegionReferenceListener)iter.next();
							listener.xrefAdded(fr.curie.BiNoM.pathways.biopax.RnaRegionReferenceImpl.this,_xref);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(sequenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						RnaRegionReferenceListener listener=(RnaRegionReferenceListener)iter.next();
						listener.sequenceChanged(fr.curie.BiNoM.pathways.biopax.RnaRegionReferenceImpl.this);
					}
				}
				return;
			}
				...
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.RnaRegionReference.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubRegion_asRnaRegionReference.iterator();iter.hasNext();){
							RnaRegionReferenceListener listener=(RnaRegionReferenceListener)iter.next();
							listener.subRegionAdded(fr.curie.BiNoM.pathways.biopax.RnaRegionReferenceImpl.this,_subRegion_asRnaRegionReference);
						}
					}
				}
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.DnaRegionReference.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubRegion_asDnaRegionReference.iterator();iter.hasNext();){
							RnaRegionReferenceListener listener=(RnaRegionReferenceListener)iter.next();
							listener.subRegionAdded(fr.curie.BiNoM.pathways.biopax.RnaRegionReferenceImpl.this,_subRegion_asDnaRegionReference);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(regionTypeProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						RnaRegionReferenceListener listener=(RnaRegionReferenceListener)iter.next();
						listener.regionTypeChanged(fr.curie.BiNoM.pathways.biopax.RnaRegionReferenceImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(organismProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						RnaRegionReferenceListener listener=(RnaRegionReferenceListener)iter.next();
						listener.organismChanged(fr.curie.BiNoM.pathways.biopax.RnaRegionReferenceImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(absoluteRegionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						RnaRegionReferenceListener listener=(RnaRegionReferenceListener)iter.next();
						listener.absoluteRegionChanged(fr.curie.BiNoM.pathways.biopax.RnaRegionReferenceImpl.this);
					}
				}
				return;
			}
...
//				return;
			if (stmt.getPredicate().equals(commentProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						RnaRegionReferenceListener listener=(RnaRegionReferenceListener)iter.next();
						listener.commentRemoved(fr.curie.BiNoM.pathways.biopax.RnaRegionReferenceImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(memberEntityReferenceProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMemberEntityReference.iterator();iter.hasNext();){
							RnaRegionReferenceListener listener=(RnaRegionReferenceListener)iter.next();
							listener.memberEntityReferenceRemoved(fr.curie.BiNoM.pathways.biopax.RnaRegionReferenceImpl.this,_memberEntityReference);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(entityFeatureProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForEntityFeature.iterator();iter.hasNext();){
							RnaRegionReferenceListener listener=(RnaRegionReferenceListener)iter.next();
							listener.entityFeatureRemoved(fr.curie.BiNoM.pathways.biopax.RnaRegionReferenceImpl.this,_entityFeature);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						RnaRegionReferenceListener listener=(RnaRegionReferenceListener)iter.next();
						listener.nameRemoved(fr.curie.BiNoM.pathways.biopax.RnaRegionReferenceImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(evidenceProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForEvidence.iterator();iter.hasNext();){
							RnaRegionReferenceListener listener=(RnaRegionReferenceListener)iter.next();
							listener.evidenceRemoved(fr.curie.BiNoM.pathways.biopax.RnaRegionReferenceImpl.this,_evidence);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(xrefProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForXref.iterator();iter.hasNext();){
							RnaRegionReferenceListener listener=(RnaRegionReferenceListener)iter.next();
							listener.xrefRemoved(fr.curie.BiNoM.pathways.biopax.RnaRegionReferenceImpl.this,_xref);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(subRegionProperty)) {
				...
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.RnaRegionReference.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubRegion_asRnaRegionReference.iterator();iter.hasNext();){
							RnaRegionReferenceListener listener=(RnaRegionReferenceListener)iter.next();
							listener.subRegionRemoved(fr.curie.BiNoM.pathways.biopax.RnaRegionReferenceImpl.this,_subRegion_asRnaRegionReference);
						}
					}
				}
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.DnaRegionReference.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubRegion_asDnaRegionReference.iterator();iter.hasNext();){
							RnaRegionReferenceListener listener=(RnaRegionReferenceListener)iter.next();
							listener.subRegionRemoved(fr.curie.BiNoM.pathways.biopax.RnaRegionReferenceImpl.this,_subRegion_asDnaRegionReference);
						}
					}
				}
				return;
