...
/**
 * Implementation of {@link fr.curie.BiNoM.pathways.biopax.Rna}
 ...
 * <br>
 */
public class RnaImpl extends com.ibm.adtech.jastor.ThingImpl implements fr.curie.BiNoM.pathways.biopax.Rna {
	...
	private java.util.ArrayList memberPhysicalEntity_asRna;
	...
	private fr.curie.BiNoM.pathways.biopax.RnaReference entityReference_asRnaReference;

	RnaImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static RnaImpl getRna(Resource resource, Model model) throws JastorException {
		return new RnaImpl(resource, model);
	}
	    
	static RnaImpl createRna(Resource resource, Model model) throws JastorException {
		RnaImpl impl = new RnaImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, Rna.TYPE)))
			impl._model.add(impl._resource, RDF.type, Rna.TYPE);
		impl.addSuperTypes();
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, fr.curie.BiNoM.pathways.biopax.Rna.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	public void clearCache() {
		...
		memberPhysicalEntity_asRna = null;
		cellularLocation = null;
		entityReference = null;
		entityReference_asRnaReference = null;
	}
	...
	private void initDataSource() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#dataSource properties in Rna model not a Resource", stmt.getObject());
	...
	private void initAvailability() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#availability properties in Rna model not a Literal", stmt.getObject());
	...
	private void initComment() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#comment properties in Rna model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initName() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#name properties in Rna model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initEvidence() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#evidence properties in Rna model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initXref() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#xref properties in Rna model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initFeature() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#feature properties in Rna model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initNotFeature() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#notFeature properties in Rna model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initMemberPhysicalEntity() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#memberPhysicalEntity properties in Rna model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initMemberPhysicalEntity_asRna() throws JastorException {
		this.memberPhysicalEntity_asRna = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, memberPhysicalEntityProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			...
			if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.Rna.TYPE)) {
				fr.curie.BiNoM.pathways.biopax.Rna memberPhysicalEntity = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getRna(resource,_model);
				this.memberPhysicalEntity_asRna.add(memberPhysicalEntity);
			}
		}
	}

	public java.util.Iterator getMemberPhysicalEntity_asRna() throws JastorException {
		if (memberPhysicalEntity_asRna == null)
			initMemberPhysicalEntity_asRna();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(memberPhysicalEntity_asRna,_resource,memberPhysicalEntityProperty,true);
	}

	public void addMemberPhysicalEntity(fr.curie.BiNoM.pathways.biopax.Rna memberPhysicalEntity) throws JastorException {
		if (this.memberPhysicalEntity_asRna == null)
			initMemberPhysicalEntity_asRna();
		if (this.memberPhysicalEntity_asRna.contains(memberPhysicalEntity)) {
			this.memberPhysicalEntity_asRna.remove(memberPhysicalEntity);
			this.memberPhysicalEntity_asRna.add(memberPhysicalEntity);
			return;
		}
		this.memberPhysicalEntity_asRna.add(memberPhysicalEntity);
	...
	public fr.curie.BiNoM.pathways.biopax.Rna addMemberPhysicalEntity_asRna() throws JastorException {
		fr.curie.BiNoM.pathways.biopax.Rna memberPhysicalEntity = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.createRna(_model.createResource(),_model);
		if (this.memberPhysicalEntity_asRna == null)
			initMemberPhysicalEntity_asRna();
		this.memberPhysicalEntity_asRna.add(memberPhysicalEntity);
		_model.add(_model.createStatement(_resource,memberPhysicalEntityProperty,memberPhysicalEntity.resource()));
	...
	public fr.curie.BiNoM.pathways.biopax.Rna addMemberPhysicalEntity_asRna(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		fr.curie.BiNoM.pathways.biopax.Rna memberPhysicalEntity = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getRna(resource,_model);
		if (this.memberPhysicalEntity_asRna == null)
			initMemberPhysicalEntity_asRna();
		if (this.memberPhysicalEntity_asRna.contains(memberPhysicalEntity))
	...
	public void removeMemberPhysicalEntity(fr.curie.BiNoM.pathways.biopax.Rna memberPhysicalEntity) throws JastorException {
		if (this.memberPhysicalEntity_asRna == null)
			initMemberPhysicalEntity_asRna();
		if (!this.memberPhysicalEntity_asRna.contains(memberPhysicalEntity))
			return;
	...
	public fr.curie.BiNoM.pathways.biopax.CellularLocationVocabulary getCellularLocation() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": cellularLocation getProperty() in fr.curie.BiNoM.pathways.biopax.Rna model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	public fr.curie.BiNoM.pathways.biopax.EntityReference getEntityReference() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": entityReference getProperty() in fr.curie.BiNoM.pathways.biopax.Rna model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	public fr.curie.BiNoM.pathways.biopax.RnaReference getEntityReference_asRnaReference() throws JastorException {
		if (entityReference_asRnaReference != null)
			return entityReference_asRnaReference;
		com.hp.hpl.jena.rdf.model.Statement stmt = _model.getProperty(_resource, entityReferenceProperty);
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": entityReference_asRnaReference getProperty() in fr.curie.BiNoM.pathways.biopax.Rna model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
		if (!_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.RnaReference.TYPE))
			return null;
		entityReference_asRnaReference = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getRnaReference(resource,_model);
		return entityReference_asRnaReference;
	}

	public void setEntityReference(fr.curie.BiNoM.pathways.biopax.RnaReference entityReference) throws JastorException {
		if (_model.contains(_resource,entityReferenceProperty)) {
			_model.removeAll(_resource,entityReferenceProperty,null);
		}
		this.entityReference_asRnaReference = entityReference;
		if (entityReference != null) {
			_model.add(_model.createStatement(_resource,entityReferenceProperty, entityReference.resource()));
		}			
	}
		
	public fr.curie.BiNoM.pathways.biopax.RnaReference setEntityReference_asRnaReference() throws JastorException {
		if (_model.contains(_resource,entityReferenceProperty)) {
			_model.removeAll(_resource,entityReferenceProperty,null);
		}
		fr.curie.BiNoM.pathways.biopax.RnaReference entityReference = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.createRnaReference(_model.createResource(),_model);
		this.entityReference_asRnaReference = entityReference;
		_model.add(_model.createStatement(_resource,entityReferenceProperty, entityReference.resource()));
		return entityReference;
	}
	
	public fr.curie.BiNoM.pathways.biopax.RnaReference setEntityReference_asRnaReference(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		if (_model.contains(_resource,entityReferenceProperty)) {
			_model.removeAll(_resource,entityReferenceProperty,null);
		}
		fr.curie.BiNoM.pathways.biopax.RnaReference entityReference = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getRnaReference(resource,_model);
		this.entityReference_asRnaReference = entityReference;
		_model.add(_model.createStatement(_resource,entityReferenceProperty, entityReference.resource()));
		return entityReference;
	}
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof RnaListener))
			throw new IllegalArgumentException("ThingListener must be instance of RnaListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((RnaListener)listener);
		}
	}
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDataSource.iterator();iter.hasNext();){
							RnaListener listener=(RnaListener)iter.next();
							listener.dataSourceAdded(fr.curie.BiNoM.pathways.biopax.RnaImpl.this,_dataSource);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(availabilityProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForAvailability.iterator();iter.hasNext();){
						RnaListener listener=(RnaListener)iter.next();
						listener.availabilityAdded(fr.curie.BiNoM.pathways.biopax.RnaImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(commentProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForComment.iterator();iter.hasNext();){
						RnaListener listener=(RnaListener)iter.next();
						listener.commentAdded(fr.curie.BiNoM.pathways.biopax.RnaImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						RnaListener listener=(RnaListener)iter.next();
						listener.nameAdded(fr.curie.BiNoM.pathways.biopax.RnaImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForEvidence.iterator();iter.hasNext();){
							RnaListener listener=(RnaListener)iter.next();
							listener.evidenceAdded(fr.curie.BiNoM.pathways.biopax.RnaImpl.this,_evidence);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForXref.iterator();iter.hasNext();){
							RnaListener listener=(RnaListener)iter.next();
							listener.xrefAdded(fr.curie.BiNoM.pathways.biopax.RnaImpl.this,_xref);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeature.iterator();iter.hasNext();){
							RnaListener listener=(RnaListener)iter.next();
							listener.featureAdded(fr.curie.BiNoM.pathways.biopax.RnaImpl.this,_feature);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForNotFeature.iterator();iter.hasNext();){
							RnaListener listener=(RnaListener)iter.next();
							listener.notFeatureAdded(fr.curie.BiNoM.pathways.biopax.RnaImpl.this,_notFeature);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMemberPhysicalEntity.iterator();iter.hasNext();){
							RnaListener listener=(RnaListener)iter.next();
							listener.memberPhysicalEntityAdded(fr.curie.BiNoM.pathways.biopax.RnaImpl.this,_memberPhysicalEntity);
						}
					}
				}
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.Rna.TYPE)) {
					fr.curie.BiNoM.pathways.biopax.Rna _memberPhysicalEntity_asRna = null;
					try {
						_memberPhysicalEntity_asRna = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getRna(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (memberPhysicalEntity_asRna == null) {
					...
					if (!memberPhysicalEntity_asRna.contains(_memberPhysicalEntity_asRna))
						memberPhysicalEntity_asRna.add(_memberPhysicalEntity_asRna);
					if (listeners != null) {
						java.util.ArrayList consumersForMemberPhysicalEntity_asRna;
						synchronized (listeners) {
							consumersForMemberPhysicalEntity_asRna = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForMemberPhysicalEntity_asRna.iterator();iter.hasNext();){
							RnaListener listener=(RnaListener)iter.next();
							listener.memberPhysicalEntityAdded(fr.curie.BiNoM.pathways.biopax.RnaImpl.this,_memberPhysicalEntity_asRna);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(cellularLocationProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						RnaListener listener=(RnaListener)iter.next();
						listener.cellularLocationChanged(fr.curie.BiNoM.pathways.biopax.RnaImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(entityReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						RnaListener listener=(RnaListener)iter.next();
						listener.entityReferenceChanged(fr.curie.BiNoM.pathways.biopax.RnaImpl.this);
					}
				}
				return;
			}
...
//				return;
			if (stmt.getPredicate().equals(dataSourceProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDataSource.iterator();iter.hasNext();){
							RnaListener listener=(RnaListener)iter.next();
							listener.dataSourceRemoved(fr.curie.BiNoM.pathways.biopax.RnaImpl.this,_dataSource);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(availabilityProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						RnaListener listener=(RnaListener)iter.next();
						listener.availabilityRemoved(fr.curie.BiNoM.pathways.biopax.RnaImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(commentProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						RnaListener listener=(RnaListener)iter.next();
						listener.commentRemoved(fr.curie.BiNoM.pathways.biopax.RnaImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						RnaListener listener=(RnaListener)iter.next();
						listener.nameRemoved(fr.curie.BiNoM.pathways.biopax.RnaImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(evidenceProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForEvidence.iterator();iter.hasNext();){
							RnaListener listener=(RnaListener)iter.next();
							listener.evidenceRemoved(fr.curie.BiNoM.pathways.biopax.RnaImpl.this,_evidence);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(xrefProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForXref.iterator();iter.hasNext();){
							RnaListener listener=(RnaListener)iter.next();
							listener.xrefRemoved(fr.curie.BiNoM.pathways.biopax.RnaImpl.this,_xref);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(featureProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeature.iterator();iter.hasNext();){
							RnaListener listener=(RnaListener)iter.next();
							listener.featureRemoved(fr.curie.BiNoM.pathways.biopax.RnaImpl.this,_feature);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(notFeatureProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForNotFeature.iterator();iter.hasNext();){
							RnaListener listener=(RnaListener)iter.next();
							listener.notFeatureRemoved(fr.curie.BiNoM.pathways.biopax.RnaImpl.this,_notFeature);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(memberPhysicalEntityProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMemberPhysicalEntity.iterator();iter.hasNext();){
							RnaListener listener=(RnaListener)iter.next();
							listener.memberPhysicalEntityRemoved(fr.curie.BiNoM.pathways.biopax.RnaImpl.this,_memberPhysicalEntity);
						}
					}
				}
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.Rna.TYPE)) {
					...
					if (memberPhysicalEntity_asRna != null) {
						boolean found = false;
						for (int i=0;i<memberPhysicalEntity_asRna.size();i++) {
							fr.curie.BiNoM.pathways.biopax.Rna __item = (fr.curie.BiNoM.pathways.biopax.Rna) memberPhysicalEntity_asRna.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_memberPhysicalEntity_asRna = __item;
								break;
							}
						}
						if (found)
							memberPhysicalEntity_asRna.remove(_memberPhysicalEntity_asRna);
						else {
							try {
								_memberPhysicalEntity_asRna = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getRna(resource,_model);
							} catch (JastorException e) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMemberPhysicalEntity_asRna.iterator();iter.hasNext();){
							RnaListener listener=(RnaListener)iter.next();
							listener.memberPhysicalEntityRemoved(fr.curie.BiNoM.pathways.biopax.RnaImpl.this,_memberPhysicalEntity_asRna);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(entityReferenceProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
					if (entityReference != null && entityReference.resource().equals(resource))
						entityReference = null;				
					if (entityReference_asRnaReference != null && entityReference_asRnaReference.resource().equals(resource))
						entityReference_asRnaReference = null;				
				if (listeners != null) {
					java.util.ArrayList consumers;
					synchronized (listeners) {
