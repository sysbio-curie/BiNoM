...
/**
 * Implementation of {@link fr.curie.BiNoM.pathways.biopax.BindingFeature}
 ...
 * <br>
 */
public class BindingFeatureImpl extends com.ibm.adtech.jastor.ThingImpl implements fr.curie.BiNoM.pathways.biopax.BindingFeature {
	...
	BindingFeatureImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static BindingFeatureImpl getBindingFeature(Resource resource, Model model) throws JastorException {
		return new BindingFeatureImpl(resource, model);
	}
	    
	static BindingFeatureImpl createBindingFeature(Resource resource, Model model) throws JastorException {
		BindingFeatureImpl impl = new BindingFeatureImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, BindingFeature.TYPE)))
			impl._model.add(impl._resource, RDF.type, BindingFeature.TYPE);
		impl.addSuperTypes();
	...
	private void initComment() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#comment properties in BindingFeature model not a Literal", stmt.getObject());
	...
	private void initMemberFeature() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#memberFeature properties in BindingFeature model not a Resource", stmt.getObject());
	...
	private void initFeatureLocation() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#featureLocation properties in BindingFeature model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initFeatureLocationType() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#featureLocationType properties in BindingFeature model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initEvidence() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#evidence properties in BindingFeature model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public java.lang.Boolean getIntraMolecular() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": intraMolecular getProperty() in fr.curie.BiNoM.pathways.biopax.BindingFeature model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	public fr.curie.BiNoM.pathways.biopax.BindingFeature getBindsTo() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": bindsTo getProperty() in fr.curie.BiNoM.pathways.biopax.BindingFeature model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof BindingFeatureListener))
			throw new IllegalArgumentException("ThingListener must be instance of BindingFeatureListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((BindingFeatureListener)listener);
		}
	}
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
			...
			if (stmt.getPredicate().equals(commentProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForComment.iterator();iter.hasNext();){
						BindingFeatureListener listener=(BindingFeatureListener)iter.next();
						listener.commentAdded(fr.curie.BiNoM.pathways.biopax.BindingFeatureImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMemberFeature.iterator();iter.hasNext();){
							BindingFeatureListener listener=(BindingFeatureListener)iter.next();
							listener.memberFeatureAdded(fr.curie.BiNoM.pathways.biopax.BindingFeatureImpl.this,_memberFeature);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeatureLocation.iterator();iter.hasNext();){
							BindingFeatureListener listener=(BindingFeatureListener)iter.next();
							listener.featureLocationAdded(fr.curie.BiNoM.pathways.biopax.BindingFeatureImpl.this,_featureLocation);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeatureLocationType.iterator();iter.hasNext();){
							BindingFeatureListener listener=(BindingFeatureListener)iter.next();
							listener.featureLocationTypeAdded(fr.curie.BiNoM.pathways.biopax.BindingFeatureImpl.this,_featureLocationType);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForEvidence.iterator();iter.hasNext();){
							BindingFeatureListener listener=(BindingFeatureListener)iter.next();
							listener.evidenceAdded(fr.curie.BiNoM.pathways.biopax.BindingFeatureImpl.this,_evidence);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(intraMolecularProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						BindingFeatureListener listener=(BindingFeatureListener)iter.next();
						listener.intraMolecularChanged(fr.curie.BiNoM.pathways.biopax.BindingFeatureImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(bindsToProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						BindingFeatureListener listener=(BindingFeatureListener)iter.next();
						listener.bindsToChanged(fr.curie.BiNoM.pathways.biopax.BindingFeatureImpl.this);
					}
				}
				return;
			}
...
//				return;
			if (stmt.getPredicate().equals(commentProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						BindingFeatureListener listener=(BindingFeatureListener)iter.next();
						listener.commentRemoved(fr.curie.BiNoM.pathways.biopax.BindingFeatureImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(memberFeatureProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMemberFeature.iterator();iter.hasNext();){
							BindingFeatureListener listener=(BindingFeatureListener)iter.next();
							listener.memberFeatureRemoved(fr.curie.BiNoM.pathways.biopax.BindingFeatureImpl.this,_memberFeature);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(featureLocationProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeatureLocation.iterator();iter.hasNext();){
							BindingFeatureListener listener=(BindingFeatureListener)iter.next();
							listener.featureLocationRemoved(fr.curie.BiNoM.pathways.biopax.BindingFeatureImpl.this,_featureLocation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(featureLocationTypeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeatureLocationType.iterator();iter.hasNext();){
							BindingFeatureListener listener=(BindingFeatureListener)iter.next();
							listener.featureLocationTypeRemoved(fr.curie.BiNoM.pathways.biopax.BindingFeatureImpl.this,_featureLocationType);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(evidenceProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForEvidence.iterator();iter.hasNext();){
							BindingFeatureListener listener=(BindingFeatureListener)iter.next();
							listener.evidenceRemoved(fr.curie.BiNoM.pathways.biopax.BindingFeatureImpl.this,_evidence);
						}
					}
				}
				return;
