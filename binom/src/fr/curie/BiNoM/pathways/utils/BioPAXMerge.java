...
//public String namespace = "http://www.biopax.org/release/biopax-level2.owl#";
//public String importString = "http://www.biopax.org/Downloads/Level2v0.92/biopax-level2.owl";
...
public void mergeMainWithReferences() throws Exception{
	  ...
	  for(int i=0;i<referenceFiles.size();i++){
	    ...
	    while(itr.hasNext()){
	    	...
	    	com.ibm.adtech.jastor.Thing thing = biopax_DASH_level2_DOT_owlFactory.getThing(r.getURI(),mainfile);
	        k++;
	        if(k==(int)(0.001f*k)*1000)
	        	System.out.print(k+"\t");
	        uris.put(thing.uri(),thing);
	        //if(BioPAXUtilities.numberOfStatements(thing)==1){
	            com.ibm.adtech.jastor.Thing ref = biopax_DASH_level2_DOT_owlFactory.getThing(r.toString(),mref);
	             if(ref!=null){
	    ...
	    while(addIt.hasNext()){
	    	...
	    	com.ibm.adtech.jastor.Thing thing = biopax_DASH_level2_DOT_owlFactory.getThing(r.getURI(),mref);
	        k++;
	        if(k==(int)(0.001f*k)*1000)
	        	System.out.print(k+"\t");
