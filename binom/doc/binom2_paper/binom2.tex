...
on the target node. This assumption might not be true for all types of biological networks, but more complex Then the PIQuant score for a set of $q$ paths (from a set of 
