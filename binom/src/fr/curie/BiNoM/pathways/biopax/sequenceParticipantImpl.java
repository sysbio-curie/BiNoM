...
/**
 * Implementation of {@link fr.curie.BiNoM.pathways.biopax.sequenceParticipant}
 ...
 * <br>
 */
public class sequenceParticipantImpl extends com.ibm.adtech.jastor.ThingImpl implements fr.curie.BiNoM.pathways.biopax.sequenceParticipant {
	...
	private static com.hp.hpl.jena.rdf.model.Property SEQUENCE_DASH_FEATURE_DASH_LISTProperty = ResourceFactory.createProperty("http://www.biopax.org/release/biopax-level2.owl#SEQUENCE-FEATURE-LIST");
	private java.util.ArrayList SEQUENCE_DASH_FEATURE_DASH_LIST;
	...
	static sequenceParticipantImpl getsequenceParticipant(Resource resource, Model model) throws JastorException {
		return new sequenceParticipantImpl(resource, model);
	}
	    
	static sequenceParticipantImpl createsequenceParticipant(Resource resource, Model model) throws JastorException {
		sequenceParticipantImpl impl = new sequenceParticipantImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, sequenceParticipant.TYPE)))
			impl._model.add(impl._resource, RDF.type, sequenceParticipant.TYPE);
		//impl.addSuperTypes();
	...
	void addSuperTypes() {
		...
		if (!_model.contains(_resource, RDF.type, fr.curie.BiNoM.pathways.biopax.physicalEntityParticipant.TYPE))
			_model.add(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(_resource, RDF.type, fr.curie.BiNoM.pathways.biopax.physicalEntityParticipant.TYPE));     
	}
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,SEQUENCE_DASH_FEATURE_DASH_LISTProperty,(RDFNode)null);
		while (it.hasNext()) {
			list.add(it.next());
		}
		it = _model.listStatements(_resource,RDF.type, fr.curie.BiNoM.pathways.biopax.sequenceParticipant.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	public void clearCache() {
		...
		SEQUENCE_DASH_FEATURE_DASH_LIST = null;
	}
	...
	private void initCOMMENT() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#COMMENT properties in sequenceParticipant model not a Literal", stmt.getObject());
	...
	public fr.curie.BiNoM.pathways.biopax.physicalEntity getPHYSICAL_DASH_ENTITY() throws JastorException {
		...
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": PHYSICAL_DASH_ENTITY getProperty() in fr.curie.BiNoM.pathways.biopax.sequenceParticipant model not Resource", stmt.getObject());
	...
	public java.lang.Double getSTOICHIOMETRIC_DASH_COEFFICIENT() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": STOICHIOMETRIC_DASH_COEFFICIENT getProperty() in fr.curie.BiNoM.pathways.biopax.sequenceParticipant model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	public fr.curie.BiNoM.pathways.biopax.openControlledVocabulary getCELLULAR_DASH_LOCATION() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": CELLULAR_DASH_LOCATION getProperty() in fr.curie.BiNoM.pathways.biopax.sequenceParticipant model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	private void initSEQUENCE_DASH_FEATURE_DASH_LIST() throws JastorException {
		this.SEQUENCE_DASH_FEATURE_DASH_LIST = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, SEQUENCE_DASH_FEATURE_DASH_LISTProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#SEQUENCE-FEATURE-LIST properties in sequenceParticipant model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				fr.curie.BiNoM.pathways.biopax.sequenceFeature SEQUENCE_DASH_FEATURE_DASH_LIST = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level2_DOT_owlFactory.getsequenceFeature(resource,_model);
				this.SEQUENCE_DASH_FEATURE_DASH_LIST.add(SEQUENCE_DASH_FEATURE_DASH_LIST);
			}
		}
	}

	public java.util.Iterator getSEQUENCE_DASH_FEATURE_DASH_LIST() throws JastorException {
		if (SEQUENCE_DASH_FEATURE_DASH_LIST == null)
			initSEQUENCE_DASH_FEATURE_DASH_LIST();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(SEQUENCE_DASH_FEATURE_DASH_LIST,_resource,SEQUENCE_DASH_FEATURE_DASH_LISTProperty,true);
	}

	public void addSEQUENCE_DASH_FEATURE_DASH_LIST(fr.curie.BiNoM.pathways.biopax.sequenceFeature SEQUENCE_DASH_FEATURE_DASH_LIST) throws JastorException {
		if (this.SEQUENCE_DASH_FEATURE_DASH_LIST == null)
			initSEQUENCE_DASH_FEATURE_DASH_LIST();
		if (this.SEQUENCE_DASH_FEATURE_DASH_LIST.contains(SEQUENCE_DASH_FEATURE_DASH_LIST)) {
			this.SEQUENCE_DASH_FEATURE_DASH_LIST.remove(SEQUENCE_DASH_FEATURE_DASH_LIST);
			this.SEQUENCE_DASH_FEATURE_DASH_LIST.add(SEQUENCE_DASH_FEATURE_DASH_LIST);
			return;
		}
		this.SEQUENCE_DASH_FEATURE_DASH_LIST.add(SEQUENCE_DASH_FEATURE_DASH_LIST);
		_model.add(_model.createStatement(_resource,SEQUENCE_DASH_FEATURE_DASH_LISTProperty,SEQUENCE_DASH_FEATURE_DASH_LIST.resource()));
	}
	
	public fr.curie.BiNoM.pathways.biopax.sequenceFeature addSEQUENCE_DASH_FEATURE_DASH_LIST() throws JastorException {
		fr.curie.BiNoM.pathways.biopax.sequenceFeature SEQUENCE_DASH_FEATURE_DASH_LIST = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level2_DOT_owlFactory.createsequenceFeature(_model.createResource(),_model);
		if (this.SEQUENCE_DASH_FEATURE_DASH_LIST == null)
			initSEQUENCE_DASH_FEATURE_DASH_LIST();
		this.SEQUENCE_DASH_FEATURE_DASH_LIST.add(SEQUENCE_DASH_FEATURE_DASH_LIST);
		_model.add(_model.createStatement(_resource,SEQUENCE_DASH_FEATURE_DASH_LISTProperty,SEQUENCE_DASH_FEATURE_DASH_LIST.resource()));
		return SEQUENCE_DASH_FEATURE_DASH_LIST;
	}
	
	public fr.curie.BiNoM.pathways.biopax.sequenceFeature addSEQUENCE_DASH_FEATURE_DASH_LIST(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		fr.curie.BiNoM.pathways.biopax.sequenceFeature SEQUENCE_DASH_FEATURE_DASH_LIST = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level2_DOT_owlFactory.getsequenceFeature(resource,_model);
		if (this.SEQUENCE_DASH_FEATURE_DASH_LIST == null)
			initSEQUENCE_DASH_FEATURE_DASH_LIST();
		if (this.SEQUENCE_DASH_FEATURE_DASH_LIST.contains(SEQUENCE_DASH_FEATURE_DASH_LIST))
	...
	public void removeSEQUENCE_DASH_FEATURE_DASH_LIST(fr.curie.BiNoM.pathways.biopax.sequenceFeature SEQUENCE_DASH_FEATURE_DASH_LIST) throws JastorException {
		if (this.SEQUENCE_DASH_FEATURE_DASH_LIST == null)
			initSEQUENCE_DASH_FEATURE_DASH_LIST();
		if (!this.SEQUENCE_DASH_FEATURE_DASH_LIST.contains(SEQUENCE_DASH_FEATURE_DASH_LIST))
			return;
		if (!_model.contains(_resource, SEQUENCE_DASH_FEATURE_DASH_LISTProperty, SEQUENCE_DASH_FEATURE_DASH_LIST.resource()))
			return;
		this.SEQUENCE_DASH_FEATURE_DASH_LIST.remove(SEQUENCE_DASH_FEATURE_DASH_LIST);
		_model.removeAll(_resource, SEQUENCE_DASH_FEATURE_DASH_LISTProperty, SEQUENCE_DASH_FEATURE_DASH_LIST.resource());
	}
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof sequenceParticipantListener))
			throw new IllegalArgumentException("ThingListener must be instance of sequenceParticipantListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((sequenceParticipantListener)listener);
		}
	}
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
			...
			if (stmt.getPredicate().equals(COMMENTProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForCOMMENT.iterator();iter.hasNext();){
						sequenceParticipantListener listener=(sequenceParticipantListener)iter.next();
						listener.COMMENTAdded(fr.curie.BiNoM.pathways.biopax.sequenceParticipantImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(PHYSICAL_DASH_ENTITYProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						sequenceParticipantListener listener=(sequenceParticipantListener)iter.next();
						listener.PHYSICAL_DASH_ENTITYChanged(fr.curie.BiNoM.pathways.biopax.sequenceParticipantImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(STOICHIOMETRIC_DASH_COEFFICIENTProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						sequenceParticipantListener listener=(sequenceParticipantListener)iter.next();
						listener.STOICHIOMETRIC_DASH_COEFFICIENTChanged(fr.curie.BiNoM.pathways.biopax.sequenceParticipantImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(CELLULAR_DASH_LOCATIONProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						sequenceParticipantListener listener=(sequenceParticipantListener)iter.next();
						listener.CELLULAR_DASH_LOCATIONChanged(fr.curie.BiNoM.pathways.biopax.sequenceParticipantImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(SEQUENCE_DASH_FEATURE_DASH_LISTProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
					return;
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					fr.curie.BiNoM.pathways.biopax.sequenceFeature _SEQUENCE_DASH_FEATURE_DASH_LIST = null;
					try {
						_SEQUENCE_DASH_FEATURE_DASH_LIST = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level2_DOT_owlFactory.getsequenceFeature(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (SEQUENCE_DASH_FEATURE_DASH_LIST == null) {
					...
					if (!SEQUENCE_DASH_FEATURE_DASH_LIST.contains(_SEQUENCE_DASH_FEATURE_DASH_LIST))
						SEQUENCE_DASH_FEATURE_DASH_LIST.add(_SEQUENCE_DASH_FEATURE_DASH_LIST);
					if (listeners != null) {
						java.util.ArrayList consumersForSEQUENCE_DASH_FEATURE_DASH_LIST;
						synchronized (listeners) {
							consumersForSEQUENCE_DASH_FEATURE_DASH_LIST = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForSEQUENCE_DASH_FEATURE_DASH_LIST.iterator();iter.hasNext();){
							sequenceParticipantListener listener=(sequenceParticipantListener)iter.next();
							listener.SEQUENCE_DASH_FEATURE_DASH_LISTAdded(fr.curie.BiNoM.pathways.biopax.sequenceParticipantImpl.this,_SEQUENCE_DASH_FEATURE_DASH_LIST);
						}
					}
				}
				return;
...
//				return;
			if (stmt.getPredicate().equals(COMMENTProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						sequenceParticipantListener listener=(sequenceParticipantListener)iter.next();
						listener.COMMENTRemoved(fr.curie.BiNoM.pathways.biopax.sequenceParticipantImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			...
			if (stmt.getPredicate().equals(SEQUENCE_DASH_FEATURE_DASH_LISTProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (SEQUENCE_DASH_FEATURE_DASH_LIST != null) {
						boolean found = false;
						for (int i=0;i<SEQUENCE_DASH_FEATURE_DASH_LIST.size();i++) {
							fr.curie.BiNoM.pathways.biopax.sequenceFeature __item = (fr.curie.BiNoM.pathways.biopax.sequenceFeature) SEQUENCE_DASH_FEATURE_DASH_LIST.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_SEQUENCE_DASH_FEATURE_DASH_LIST = __item;
								break;
							}
						}
						if (found)
							SEQUENCE_DASH_FEATURE_DASH_LIST.remove(_SEQUENCE_DASH_FEATURE_DASH_LIST);
						else {
							try {
								_SEQUENCE_DASH_FEATURE_DASH_LIST = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level2_DOT_owlFactory.getsequenceFeature(resource,_model);
							} catch (JastorException e) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSEQUENCE_DASH_FEATURE_DASH_LIST.iterator();iter.hasNext();){
							sequenceParticipantListener listener=(sequenceParticipantListener)iter.next();
							listener.SEQUENCE_DASH_FEATURE_DASH_LISTRemoved(fr.curie.BiNoM.pathways.biopax.sequenceParticipantImpl.this,_SEQUENCE_DASH_FEATURE_DASH_LIST);
						}
					}
				}
				return;
