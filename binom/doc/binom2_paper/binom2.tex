...
\hl{[[ Andrei: check description of shortest path and sub-optimal path search and add a description for all non intersecting paths ]]}
...
biological function, such as cell proliferation or apopotosis. 
...
sign of the experimental data value for a node is not consistent with the sign
of the path.
