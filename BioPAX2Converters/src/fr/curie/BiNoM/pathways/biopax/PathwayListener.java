...
public interface PathwayListener extends com.ibm.adtech.jastor.ThingListener {
	 ...
	 */	
	public void dataSourceAdded(fr.curie.BiNoM.pathways.biopax.Pathway source, fr.curie.BiNoM.pathways.biopax.Provenance newValue);
	 ...
	 */
	public void dataSourceRemoved(fr.curie.BiNoM.pathways.biopax.Pathway source, fr.curie.BiNoM.pathways.biopax.Provenance oldValue);
	 ...
	 * @param newValue the object representing the new value
	 */	
	public void nameAdded(fr.curie.BiNoM.pathways.biopax.Pathway source, java.lang.String newValue);
	 ...
	 * @param oldValue the object representing the removed value
	 */	
	public void nameRemoved(fr.curie.BiNoM.pathways.biopax.Pathway source, java.lang.String oldValue);
	 ...
	 * @param newValue the object representing the new value
	 */	
	public void pathwayOrderAdded(fr.curie.BiNoM.pathways.biopax.Pathway source, fr.curie.BiNoM.pathways.biopax.PathwayStep newValue);
	 ...
	 * @param oldValue the object representing the removed value
	 */
	public void pathwayOrderRemoved(fr.curie.BiNoM.pathways.biopax.Pathway source, fr.curie.BiNoM.pathways.biopax.PathwayStep oldValue);
	 ...
	 * @param newValue the object representing the new value
	 */	
	public void pathwayComponentAdded(fr.curie.BiNoM.pathways.biopax.Pathway source, fr.curie.BiNoM.pathways.biopax.Interaction newValue);
	 ...
	 * @param oldValue the object representing the removed value
	 */
	public void pathwayComponentRemoved(fr.curie.BiNoM.pathways.biopax.Pathway source, fr.curie.BiNoM.pathways.biopax.Interaction oldValue);
	 ...
	 * @param newValue the object representing the new value
	 */	
	public void pathwayComponentAdded(fr.curie.BiNoM.pathways.biopax.Pathway source, fr.curie.BiNoM.pathways.biopax.Pathway newValue);
	 ...
	 * @param oldValue the object representing the removed value
	 */
	public void pathwayComponentRemoved(fr.curie.BiNoM.pathways.biopax.Pathway source, fr.curie.BiNoM.pathways.biopax.Pathway oldValue);
