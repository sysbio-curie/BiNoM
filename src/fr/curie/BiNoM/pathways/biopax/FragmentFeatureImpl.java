...
/**
 * Implementation of {@link fr.curie.BiNoM.pathways.biopax.FragmentFeature}
 ...
 * <br>
 */
public class FragmentFeatureImpl extends com.ibm.adtech.jastor.ThingImpl implements fr.curie.BiNoM.pathways.biopax.FragmentFeature {
	...
	FragmentFeatureImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static FragmentFeatureImpl getFragmentFeature(Resource resource, Model model) throws JastorException {
		return new FragmentFeatureImpl(resource, model);
	}
	    
	static FragmentFeatureImpl createFragmentFeature(Resource resource, Model model) throws JastorException {
		FragmentFeatureImpl impl = new FragmentFeatureImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, FragmentFeature.TYPE)))
			impl._model.add(impl._resource, RDF.type, FragmentFeature.TYPE);
		impl.addSuperTypes();
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, fr.curie.BiNoM.pathways.biopax.FragmentFeature.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	private void initComment() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#comment properties in FragmentFeature model not a Literal", stmt.getObject());
	...
	private void initMemberFeature() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#memberFeature properties in FragmentFeature model not a Resource", stmt.getObject());
	...
	private void initFeatureLocation() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#featureLocation properties in FragmentFeature model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initFeatureLocationType() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#featureLocationType properties in FragmentFeature model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initEvidence() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#evidence properties in FragmentFeature model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof FragmentFeatureListener))
			throw new IllegalArgumentException("ThingListener must be instance of FragmentFeatureListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((FragmentFeatureListener)listener);
		}
	}
			...
			if (stmt.getPredicate().equals(commentProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForComment.iterator();iter.hasNext();){
						FragmentFeatureListener listener=(FragmentFeatureListener)iter.next();
						listener.commentAdded(fr.curie.BiNoM.pathways.biopax.FragmentFeatureImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMemberFeature.iterator();iter.hasNext();){
							FragmentFeatureListener listener=(FragmentFeatureListener)iter.next();
							listener.memberFeatureAdded(fr.curie.BiNoM.pathways.biopax.FragmentFeatureImpl.this,_memberFeature);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeatureLocation.iterator();iter.hasNext();){
							FragmentFeatureListener listener=(FragmentFeatureListener)iter.next();
							listener.featureLocationAdded(fr.curie.BiNoM.pathways.biopax.FragmentFeatureImpl.this,_featureLocation);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeatureLocationType.iterator();iter.hasNext();){
							FragmentFeatureListener listener=(FragmentFeatureListener)iter.next();
							listener.featureLocationTypeAdded(fr.curie.BiNoM.pathways.biopax.FragmentFeatureImpl.this,_featureLocationType);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForEvidence.iterator();iter.hasNext();){
							FragmentFeatureListener listener=(FragmentFeatureListener)iter.next();
							listener.evidenceAdded(fr.curie.BiNoM.pathways.biopax.FragmentFeatureImpl.this,_evidence);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(commentProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						FragmentFeatureListener listener=(FragmentFeatureListener)iter.next();
						listener.commentRemoved(fr.curie.BiNoM.pathways.biopax.FragmentFeatureImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(memberFeatureProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMemberFeature.iterator();iter.hasNext();){
							FragmentFeatureListener listener=(FragmentFeatureListener)iter.next();
							listener.memberFeatureRemoved(fr.curie.BiNoM.pathways.biopax.FragmentFeatureImpl.this,_memberFeature);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(featureLocationProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeatureLocation.iterator();iter.hasNext();){
							FragmentFeatureListener listener=(FragmentFeatureListener)iter.next();
							listener.featureLocationRemoved(fr.curie.BiNoM.pathways.biopax.FragmentFeatureImpl.this,_featureLocation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(featureLocationTypeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeatureLocationType.iterator();iter.hasNext();){
							FragmentFeatureListener listener=(FragmentFeatureListener)iter.next();
							listener.featureLocationTypeRemoved(fr.curie.BiNoM.pathways.biopax.FragmentFeatureImpl.this,_featureLocationType);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(evidenceProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForEvidence.iterator();iter.hasNext();){
							FragmentFeatureListener listener=(FragmentFeatureListener)iter.next();
							listener.evidenceRemoved(fr.curie.BiNoM.pathways.biopax.FragmentFeatureImpl.this,_evidence);
						}
					}
				}
				return;
