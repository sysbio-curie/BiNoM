...
reactions (Figure \ref{Network_RB-E2F_G1S}.
...
\begin{figure}
%\centering
%\includegraphics{Network_Rb_E2F_G1S}
...
activating (pointed arrows) or inhibiting (T-shape arrows) influences according
to what is known biologically about the interactions between these modules. A
detailed method on the construction of this modular network is described below:

% T arrows = blocking arrows
% pointed arrows = > activation
% LC : je ne sais pas comment le dire
...
Cdc2. 
  ...
  \subsection*{Figure xxx - BiNoM BioPAX property editor}
      Example of the properties related to the entity CDC2 of the cell cycle
model of Novak et al. \cite{novak1998model}.

  \subsection*{Figure xxx - BiNoM Query result}
      Subnetwork extracted from the human Apoptosis pathway, starting with the
Caspase8 protein (=MCH5) and expanding to all protein complexes where this
