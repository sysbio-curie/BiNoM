...
public class BioPAXViewQueryLog implements ActionListener {

    public BioPAXViewQueryLog() {
    }

    public void actionPerformed(ActionEvent e) {
        System.out.println("BioPAXViewQueryLog");
    	...
    	if(beng==null){
    		...
    		BioPAXViewQueryLogDialog.getInstance().raise();
    }
}
