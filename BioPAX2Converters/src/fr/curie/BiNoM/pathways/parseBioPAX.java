...
public class parseBioPAX extends BioPAXToSBMLConverter{
  public static void main(String[] args) {
     ...
     // Listing entities
     List lst = biopax_DASH_level3_DOT_owlFactory.getAllProtein(pb.biopax.model);
     ...
     lst = biopax_DASH_level3_DOT_owlFactory.getAllDna(pb.biopax.model);
     it = lst.iterator();
     k = 1;
     while(it.hasNext()){
       Dna pe = (Dna)it.next();
     ...
     lst = biopax_DASH_level3_DOT_owlFactory.getAllRna(pb.biopax.model);
     it = lst.iterator();
     k = 1;
     while(it.hasNext()){
       Rna pe = (Rna)it.next();
     ...
     lst = biopax_DASH_level3_DOT_owlFactory.getAllSmallMolecule(pb.biopax.model);
     it = lst.iterator();
     k = 1;
     while(it.hasNext()){
     ...
     lst = biopax_DASH_level3_DOT_owlFactory.getAllComplex(pb.biopax.model);
     it = lst.iterator();
     k = 1;
     while(it.hasNext()){
