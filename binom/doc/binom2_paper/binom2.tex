...
In order to annotate the input nodes of this network, we used expression  data
...
analysis''. We took all annotated nodes as active nodes, the grey nodes of
Figure~\ref{InflAnnotNet} as targets, and we selected optimal and sub-optimal 
shortest path as the algorithm to extract the paths. We ran a test significance
and got the report table. In this
