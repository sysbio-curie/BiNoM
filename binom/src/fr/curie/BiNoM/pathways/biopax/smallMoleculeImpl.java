...
public class smallMoleculeImpl extends com.ibm.adtech.jastor.ThingImpl implements fr.curie.BiNoM.pathways.biopax.smallMolecule {
	...
	private static com.hp.hpl.jena.rdf.model.Property MOLECULAR_DASH_WEIGHTProperty = ResourceFactory.createProperty("http://www.biopax.org/release/biopax-level2.owl#MOLECULAR-WEIGHT");
	private java.lang.Double MOLECULAR_DASH_WEIGHT;
	private static com.hp.hpl.jena.rdf.model.Property STRUCTUREProperty = ResourceFactory.createProperty("http://www.biopax.org/release/biopax-level2.owl#STRUCTURE");
	private java.util.ArrayList STRUCTURE;
	private static com.hp.hpl.jena.rdf.model.Property CHEMICAL_DASH_FORMULAProperty = ResourceFactory.createProperty("http://www.biopax.org/release/biopax-level2.owl#CHEMICAL-FORMULA");
	private java.lang.String CHEMICAL_DASH_FORMULA;
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,MOLECULAR_DASH_WEIGHTProperty,(RDFNode)null);
		while (it.hasNext()) {
			list.add(it.next());
		}
		...
		it = _model.listStatements(_resource,CHEMICAL_DASH_FORMULAProperty,(RDFNode)null);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	public void clearCache() {
		...
		NAME = null;
		XREF = null;
		MOLECULAR_DASH_WEIGHT = null;
		STRUCTURE = null;
		CHEMICAL_DASH_FORMULA = null;
	}
	...
	private void initDATA_DASH_SOURCE() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#DATA-SOURCE properties in smallMolecule model not a Resource", stmt.getObject());
	...
	private void initAVAILABILITY() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#AVAILABILITY properties in smallMolecule model not a Literal", stmt.getObject());
	...
	private void initCOMMENT() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#COMMENT properties in smallMolecule model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	public java.lang.String getSHORT_DASH_NAME() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": SHORT_DASH_NAME getProperty() in fr.curie.BiNoM.pathways.biopax.smallMolecule model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initSYNONYMS() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#SYNONYMS properties in smallMolecule model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	public java.lang.String getNAME() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": NAME getProperty() in fr.curie.BiNoM.pathways.biopax.smallMolecule model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
		Object obj = Util.fixLiteral(literal.getValue(),"java.lang.String");
	...
	private void initXREF() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#XREF properties in smallMolecule model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public java.lang.Double getMOLECULAR_DASH_WEIGHT() throws JastorException {
		if (MOLECULAR_DASH_WEIGHT != null)
			return MOLECULAR_DASH_WEIGHT;
		com.hp.hpl.jena.rdf.model.Statement stmt = _model.getProperty(_resource, MOLECULAR_DASH_WEIGHTProperty);
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": MOLECULAR_DASH_WEIGHT getProperty() in fr.curie.BiNoM.pathways.biopax.smallMolecule model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
		Object obj = Util.fixLiteral(literal.getValue(),"java.lang.Double");
		MOLECULAR_DASH_WEIGHT = (java.lang.Double)obj;
		return MOLECULAR_DASH_WEIGHT;
	}
	
	public void setMOLECULAR_DASH_WEIGHT(java.lang.Double MOLECULAR_DASH_WEIGHT) throws JastorException {
		if (_model.contains(_resource,MOLECULAR_DASH_WEIGHTProperty)) {
			_model.removeAll(_resource,MOLECULAR_DASH_WEIGHTProperty,null);
		}
		this.MOLECULAR_DASH_WEIGHT = MOLECULAR_DASH_WEIGHT;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
		if (MOLECULAR_DASH_WEIGHT != null) {
			_model.add(_model.createStatement(_resource,MOLECULAR_DASH_WEIGHTProperty, _model.createTypedLiteral(MOLECULAR_DASH_WEIGHT)));
		}	
	}


	private void initSTRUCTURE() throws JastorException {
		this.STRUCTURE = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, STRUCTUREProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#STRUCTURE properties in smallMolecule model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				fr.curie.BiNoM.pathways.biopax.chemicalStructure STRUCTURE = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level2_DOT_owlFactory.getchemicalStructure(resource,_model);
				this.STRUCTURE.add(STRUCTURE);
			}
		}
	}

	public java.util.Iterator getSTRUCTURE() throws JastorException {
		if (STRUCTURE == null)
			initSTRUCTURE();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(STRUCTURE,_resource,STRUCTUREProperty,true);
	}

	public void addSTRUCTURE(fr.curie.BiNoM.pathways.biopax.chemicalStructure STRUCTURE) throws JastorException {
	...
	public fr.curie.BiNoM.pathways.biopax.chemicalStructure addSTRUCTURE() throws JastorException {
		fr.curie.BiNoM.pathways.biopax.chemicalStructure STRUCTURE = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level2_DOT_owlFactory.createchemicalStructure(_model.createResource(),_model);
		if (this.STRUCTURE == null)
			initSTRUCTURE();
		this.STRUCTURE.add(STRUCTURE);
		_model.add(_model.createStatement(_resource,STRUCTUREProperty,STRUCTURE.resource()));
	...
	public fr.curie.BiNoM.pathways.biopax.chemicalStructure addSTRUCTURE(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		fr.curie.BiNoM.pathways.biopax.chemicalStructure STRUCTURE = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level2_DOT_owlFactory.getchemicalStructure(resource,_model);
		if (this.STRUCTURE == null)
			initSTRUCTURE();
		if (this.STRUCTURE.contains(STRUCTURE))
	...
	public void removeSTRUCTURE(fr.curie.BiNoM.pathways.biopax.chemicalStructure STRUCTURE) throws JastorException {
		if (this.STRUCTURE == null)
			initSTRUCTURE();
		if (!this.STRUCTURE.contains(STRUCTURE))
			return;
		if (!_model.contains(_resource, STRUCTUREProperty, STRUCTURE.resource()))
			return;
		this.STRUCTURE.remove(STRUCTURE);
		_model.removeAll(_resource, STRUCTUREProperty, STRUCTURE.resource());
	}
		 
	public java.lang.String getCHEMICAL_DASH_FORMULA() throws JastorException {
		if (CHEMICAL_DASH_FORMULA != null)
			return CHEMICAL_DASH_FORMULA;
		com.hp.hpl.jena.rdf.model.Statement stmt = _model.getProperty(_resource, CHEMICAL_DASH_FORMULAProperty);
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": CHEMICAL_DASH_FORMULA getProperty() in fr.curie.BiNoM.pathways.biopax.smallMolecule model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
		Object obj = Util.fixLiteral(literal.getValue(),"java.lang.String");
		CHEMICAL_DASH_FORMULA = (java.lang.String)obj;
		return CHEMICAL_DASH_FORMULA;
	}
	
	public void setCHEMICAL_DASH_FORMULA(java.lang.String CHEMICAL_DASH_FORMULA) throws JastorException {
		if (_model.contains(_resource,CHEMICAL_DASH_FORMULAProperty)) {
			_model.removeAll(_resource,CHEMICAL_DASH_FORMULAProperty,null);
		}
		this.CHEMICAL_DASH_FORMULA = CHEMICAL_DASH_FORMULA;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
		if (CHEMICAL_DASH_FORMULA != null) {
			_model.add(_model.createStatement(_resource,CHEMICAL_DASH_FORMULAProperty, _model.createTypedLiteral(CHEMICAL_DASH_FORMULA)));
		}	
	}
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDATA_DASH_SOURCE.iterator();iter.hasNext();){
							...
							listener.DATA_DASH_SOURCEAdded(fr.curie.BiNoM.pathways.biopax.smallMoleculeImpl.this,_DATA_DASH_SOURCE);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(SHORT_DASH_NAMEProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						smallMoleculeListener listener=(smallMoleculeListener)iter.next();
						listener.SHORT_DASH_NAMEChanged(fr.curie.BiNoM.pathways.biopax.smallMoleculeImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(SYNONYMSProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForSYNONYMS.iterator();iter.hasNext();){
						smallMoleculeListener listener=(smallMoleculeListener)iter.next();
						listener.SYNONYMSAdded(fr.curie.BiNoM.pathways.biopax.smallMoleculeImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(NAMEProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						smallMoleculeListener listener=(smallMoleculeListener)iter.next();
						listener.NAMEChanged(fr.curie.BiNoM.pathways.biopax.smallMoleculeImpl.this);
					}
				}
				return;
			}
			...
			if (stmt.getPredicate().equals(MOLECULAR_DASH_WEIGHTProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
					return;
				com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
				MOLECULAR_DASH_WEIGHT = (java.lang.Double)Util.fixLiteral(literal.getValue(),"java.lang.Double");
				if (listeners != null) {
					java.util.ArrayList consumers;
					synchronized (listeners) {
						consumers = (java.util.ArrayList) listeners.clone();
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						smallMoleculeListener listener=(smallMoleculeListener)iter.next();
						listener.MOLECULAR_DASH_WEIGHTChanged(fr.curie.BiNoM.pathways.biopax.smallMoleculeImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(STRUCTUREProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					fr.curie.BiNoM.pathways.biopax.chemicalStructure _STRUCTURE = null;
					try {
						_STRUCTURE = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level2_DOT_owlFactory.getchemicalStructure(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (STRUCTURE == null) {
					...
					if (!STRUCTURE.contains(_STRUCTURE))
						STRUCTURE.add(_STRUCTURE);
					if (listeners != null) {
						java.util.ArrayList consumersForSTRUCTURE;
						synchronized (listeners) {
							consumersForSTRUCTURE = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForSTRUCTURE.iterator();iter.hasNext();){
							smallMoleculeListener listener=(smallMoleculeListener)iter.next();
							listener.STRUCTUREAdded(fr.curie.BiNoM.pathways.biopax.smallMoleculeImpl.this,_STRUCTURE);
						}
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(CHEMICAL_DASH_FORMULAProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
					return;
				com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
				CHEMICAL_DASH_FORMULA = (java.lang.String)Util.fixLiteral(literal.getValue(),"java.lang.String");
				if (listeners != null) {
					java.util.ArrayList consumers;
					synchronized (listeners) {
						consumers = (java.util.ArrayList) listeners.clone();
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						smallMoleculeListener listener=(smallMoleculeListener)iter.next();
						listener.CHEMICAL_DASH_FORMULAChanged(fr.curie.BiNoM.pathways.biopax.smallMoleculeImpl.this);
					}
				}
				return;
			}
...
//				return;
			if (stmt.getPredicate().equals(DATA_DASH_SOURCEProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDATA_DASH_SOURCE.iterator();iter.hasNext();){
							smallMoleculeListener listener=(smallMoleculeListener)iter.next();
							listener.DATA_DASH_SOURCERemoved(fr.curie.BiNoM.pathways.biopax.smallMoleculeImpl.this,_DATA_DASH_SOURCE);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(SYNONYMSProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						smallMoleculeListener listener=(smallMoleculeListener)iter.next();
						listener.SYNONYMSRemoved(fr.curie.BiNoM.pathways.biopax.smallMoleculeImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			...
			if (stmt.getPredicate().equals(MOLECULAR_DASH_WEIGHTProperty)) {
				...
				//Object obj = literal.getValue();
				Object obj = Util.fixLiteral(literal.getValue(),"java.lang.Double");
				if (MOLECULAR_DASH_WEIGHT != null && MOLECULAR_DASH_WEIGHT.equals(obj))
					MOLECULAR_DASH_WEIGHT = null;
				if (listeners != null) {
					java.util.ArrayList consumers;
					synchronized (listeners) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (STRUCTURE != null) {
						...
						for (int i=0;i<STRUCTURE.size();i++) {
							fr.curie.BiNoM.pathways.biopax.chemicalStructure __item = (fr.curie.BiNoM.pathways.biopax.chemicalStructure) STRUCTURE.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_STRUCTURE = __item;
								break;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSTRUCTURE.iterator();iter.hasNext();){
							smallMoleculeListener listener=(smallMoleculeListener)iter.next();
							listener.STRUCTURERemoved(fr.curie.BiNoM.pathways.biopax.smallMoleculeImpl.this,_STRUCTURE);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(CHEMICAL_DASH_FORMULAProperty)) {
				...
				//Object obj = literal.getValue();
				Object obj = Util.fixLiteral(literal.getValue(),"java.lang.String");
				if (CHEMICAL_DASH_FORMULA != null && CHEMICAL_DASH_FORMULA.equals(obj))
					CHEMICAL_DASH_FORMULA = null;
				if (listeners != null) {
					java.util.ArrayList consumers;
					synchronized (listeners) {
