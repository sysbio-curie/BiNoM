...
public class BioPAXClassDesc {
    ...
    private static Class owlFactCls = biopax_DASH_level2_DOT_owlFactory.class;
	...
	while (iter.hasNext()) {
	    ...
	    try {
		com.ibm.adtech.jastor.Thing rthing = biopax_DASH_level2_DOT_owlFactory.getThing(thing.uri(), biopax.model);
