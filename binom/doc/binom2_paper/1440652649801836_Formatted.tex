...
pathway databases (e.g. human Reactome). BiNoM also implements a collection of
powerful graph-based functions and algorithms such as path analysis,
decomposition by name or cycle, subnetworks clustering and decomposition of a
large network in modules.
