...
abstract public class VisualStyleDefinition {
    ...
    public LineType getDefaultNodeBorderLineStyle() {
    ...
    public BioPAXVisualStyleDefinition.Arrow getDefaultEdgeSourceArrow() {
	return defaultEdgeSourceArrow;
    }

    public BioPAXVisualStyleDefinition.Arrow getDefaultEdgeTargetArrow() {
    ...
    protected org.cytoscape.view.presentation.property.values.NodeShape defaultNodeShape;
    protected Double defaultNodeSize;
    protected Color defaultNodeColor;
    protected LineType defaultNodeBorderLineStyle;
    protected int defaultNodeBorderLineWidth;
    protected Color defaultNodeBorderColor;

    protected BioPAXVisualStyleDefinition.Arrow defaultEdgeSourceArrow;
    protected fr.curie.BiNoM.cytoscape.biopax.BioPAXVisualStyleDefinition.Arrow defaultEdgeTargetArrow;
    protected LineType defaultEdgeLineType;
