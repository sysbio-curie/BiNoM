...
public class BioPAXDoubleListAttrDesc extends BioPAXAttrDesc {
    ...
    public BioPAXDoubleListAttrDesc(BioPAXClassDesc clsDesc, String name, Vector<CMethod> getMthV, Vector<CMethod> addMthV, Vector<CMethod> rmvMthV) {
	super(clsDesc, name);
	getMth = getOne(getMthV, "BioPAXDoubleListAttrDesc", "get");
	addMth = getOne(addMthV, "BioPAXDoubleListAttrDesc", "add");
	rmvMth = getOne(rmvMthV, "BioPAXDoubleListAttrDesc", "rmv");
    }
