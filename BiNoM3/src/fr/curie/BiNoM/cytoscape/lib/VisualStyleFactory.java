...
//		}
  ...
  private void createNodeShape(VisualStyleDefinition vizsty_def, VisualStyle vs) {
	  ...
	  NodeShapeVisualProperty nsvp = new NodeShapeVisualProperty(vizsty_def.getDefaultNodeShape(), "", "pippo", CyNode.class);
...
//    		if(m.getMappingValue() != null)
//	    		discreteMappingColor.putMapValue(m.getAttributeValue(), ((BioPAXVisualStyleDefinition.Arrow)(m.getMappingValue())).getColor());
		}
		
		vs.addVisualMappingFunction(discreteMappingShape);
//		vs.addVisualMappingFunction(discreteMappingColor);
