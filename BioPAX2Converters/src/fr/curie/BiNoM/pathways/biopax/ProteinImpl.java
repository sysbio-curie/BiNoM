...
/**
 * Implementation of {@link fr.curie.BiNoM.pathways.biopax.Protein}
 ...
 * <br>
 */
public class ProteinImpl extends com.ibm.adtech.jastor.ThingImpl implements fr.curie.BiNoM.pathways.biopax.Protein {
	...
	private java.util.ArrayList memberPhysicalEntity_asProtein;
	...
	private fr.curie.BiNoM.pathways.biopax.ProteinReference entityReference_asProteinReference;

	ProteinImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static ProteinImpl getProtein(Resource resource, Model model) throws JastorException {
		return new ProteinImpl(resource, model);
	}
	    
	static ProteinImpl createProtein(Resource resource, Model model) throws JastorException {
		ProteinImpl impl = new ProteinImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, Protein.TYPE)))
			impl._model.add(impl._resource, RDF.type, Protein.TYPE);
		impl.addSuperTypes();
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, fr.curie.BiNoM.pathways.biopax.Protein.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	public void clearCache() {
		...
		memberPhysicalEntity_asProtein = null;
		cellularLocation = null;
		entityReference = null;
		entityReference_asProteinReference = null;
	}
	...
	private void initDataSource() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#dataSource properties in Protein model not a Resource", stmt.getObject());
	...
	private void initAvailability() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#availability properties in Protein model not a Literal", stmt.getObject());
	...
	private void initComment() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#comment properties in Protein model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initName() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#name properties in Protein model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initEvidence() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#evidence properties in Protein model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initXref() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#xref properties in Protein model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initFeature() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#feature properties in Protein model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initNotFeature() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#notFeature properties in Protein model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initMemberPhysicalEntity() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#memberPhysicalEntity properties in Protein model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initMemberPhysicalEntity_asProtein() throws JastorException {
		this.memberPhysicalEntity_asProtein = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, memberPhysicalEntityProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			...
			if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.Protein.TYPE)) {
				fr.curie.BiNoM.pathways.biopax.Protein memberPhysicalEntity = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getProtein(resource,_model);
				this.memberPhysicalEntity_asProtein.add(memberPhysicalEntity);
			}
		}
	}

	public java.util.Iterator getMemberPhysicalEntity_asProtein() throws JastorException {
		if (memberPhysicalEntity_asProtein == null)
			initMemberPhysicalEntity_asProtein();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(memberPhysicalEntity_asProtein,_resource,memberPhysicalEntityProperty,true);
	}

	public void addMemberPhysicalEntity(fr.curie.BiNoM.pathways.biopax.Protein memberPhysicalEntity) throws JastorException {
		if (this.memberPhysicalEntity_asProtein == null)
			initMemberPhysicalEntity_asProtein();
		if (this.memberPhysicalEntity_asProtein.contains(memberPhysicalEntity)) {
			this.memberPhysicalEntity_asProtein.remove(memberPhysicalEntity);
			this.memberPhysicalEntity_asProtein.add(memberPhysicalEntity);
			return;
		}
		this.memberPhysicalEntity_asProtein.add(memberPhysicalEntity);
	...
	public fr.curie.BiNoM.pathways.biopax.Protein addMemberPhysicalEntity_asProtein() throws JastorException {
		fr.curie.BiNoM.pathways.biopax.Protein memberPhysicalEntity = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.createProtein(_model.createResource(),_model);
		if (this.memberPhysicalEntity_asProtein == null)
			initMemberPhysicalEntity_asProtein();
		this.memberPhysicalEntity_asProtein.add(memberPhysicalEntity);
		_model.add(_model.createStatement(_resource,memberPhysicalEntityProperty,memberPhysicalEntity.resource()));
	...
	public fr.curie.BiNoM.pathways.biopax.Protein addMemberPhysicalEntity_asProtein(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		fr.curie.BiNoM.pathways.biopax.Protein memberPhysicalEntity = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getProtein(resource,_model);
		if (this.memberPhysicalEntity_asProtein == null)
			initMemberPhysicalEntity_asProtein();
		if (this.memberPhysicalEntity_asProtein.contains(memberPhysicalEntity))
	...
	public void removeMemberPhysicalEntity(fr.curie.BiNoM.pathways.biopax.Protein memberPhysicalEntity) throws JastorException {
		if (this.memberPhysicalEntity_asProtein == null)
			initMemberPhysicalEntity_asProtein();
		if (!this.memberPhysicalEntity_asProtein.contains(memberPhysicalEntity))
			return;
	...
	public fr.curie.BiNoM.pathways.biopax.CellularLocationVocabulary getCellularLocation() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": cellularLocation getProperty() in fr.curie.BiNoM.pathways.biopax.Protein model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	public fr.curie.BiNoM.pathways.biopax.EntityReference getEntityReference() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": entityReference getProperty() in fr.curie.BiNoM.pathways.biopax.Protein model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	public fr.curie.BiNoM.pathways.biopax.ProteinReference getEntityReference_asProteinReference() throws JastorException {
		if (entityReference_asProteinReference != null)
			return entityReference_asProteinReference;
		com.hp.hpl.jena.rdf.model.Statement stmt = _model.getProperty(_resource, entityReferenceProperty);
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": entityReference_asProteinReference getProperty() in fr.curie.BiNoM.pathways.biopax.Protein model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
		if (!_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.ProteinReference.TYPE))
			return null;
		entityReference_asProteinReference = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getProteinReference(resource,_model);
		return entityReference_asProteinReference;
	}

	public void setEntityReference(fr.curie.BiNoM.pathways.biopax.ProteinReference entityReference) throws JastorException {
		if (_model.contains(_resource,entityReferenceProperty)) {
			_model.removeAll(_resource,entityReferenceProperty,null);
		}
		this.entityReference_asProteinReference = entityReference;
		if (entityReference != null) {
			_model.add(_model.createStatement(_resource,entityReferenceProperty, entityReference.resource()));
		}			
	}
		
	public fr.curie.BiNoM.pathways.biopax.ProteinReference setEntityReference_asProteinReference() throws JastorException {
		if (_model.contains(_resource,entityReferenceProperty)) {
			_model.removeAll(_resource,entityReferenceProperty,null);
		}
		fr.curie.BiNoM.pathways.biopax.ProteinReference entityReference = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.createProteinReference(_model.createResource(),_model);
		this.entityReference_asProteinReference = entityReference;
		_model.add(_model.createStatement(_resource,entityReferenceProperty, entityReference.resource()));
		return entityReference;
	}
	
	public fr.curie.BiNoM.pathways.biopax.ProteinReference setEntityReference_asProteinReference(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		if (_model.contains(_resource,entityReferenceProperty)) {
			_model.removeAll(_resource,entityReferenceProperty,null);
		}
		fr.curie.BiNoM.pathways.biopax.ProteinReference entityReference = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getProteinReference(resource,_model);
		this.entityReference_asProteinReference = entityReference;
		_model.add(_model.createStatement(_resource,entityReferenceProperty, entityReference.resource()));
		return entityReference;
	}
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof ProteinListener))
			throw new IllegalArgumentException("ThingListener must be instance of ProteinListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((ProteinListener)listener);
		}
	}
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDataSource.iterator();iter.hasNext();){
							ProteinListener listener=(ProteinListener)iter.next();
							listener.dataSourceAdded(fr.curie.BiNoM.pathways.biopax.ProteinImpl.this,_dataSource);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(availabilityProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForAvailability.iterator();iter.hasNext();){
						ProteinListener listener=(ProteinListener)iter.next();
						listener.availabilityAdded(fr.curie.BiNoM.pathways.biopax.ProteinImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(commentProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForComment.iterator();iter.hasNext();){
						ProteinListener listener=(ProteinListener)iter.next();
						listener.commentAdded(fr.curie.BiNoM.pathways.biopax.ProteinImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						ProteinListener listener=(ProteinListener)iter.next();
						listener.nameAdded(fr.curie.BiNoM.pathways.biopax.ProteinImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForEvidence.iterator();iter.hasNext();){
							ProteinListener listener=(ProteinListener)iter.next();
							listener.evidenceAdded(fr.curie.BiNoM.pathways.biopax.ProteinImpl.this,_evidence);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForXref.iterator();iter.hasNext();){
							ProteinListener listener=(ProteinListener)iter.next();
							listener.xrefAdded(fr.curie.BiNoM.pathways.biopax.ProteinImpl.this,_xref);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeature.iterator();iter.hasNext();){
							ProteinListener listener=(ProteinListener)iter.next();
							listener.featureAdded(fr.curie.BiNoM.pathways.biopax.ProteinImpl.this,_feature);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForNotFeature.iterator();iter.hasNext();){
							ProteinListener listener=(ProteinListener)iter.next();
							listener.notFeatureAdded(fr.curie.BiNoM.pathways.biopax.ProteinImpl.this,_notFeature);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMemberPhysicalEntity.iterator();iter.hasNext();){
							ProteinListener listener=(ProteinListener)iter.next();
							listener.memberPhysicalEntityAdded(fr.curie.BiNoM.pathways.biopax.ProteinImpl.this,_memberPhysicalEntity);
						}
					}
				}
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.Protein.TYPE)) {
					fr.curie.BiNoM.pathways.biopax.Protein _memberPhysicalEntity_asProtein = null;
					try {
						_memberPhysicalEntity_asProtein = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getProtein(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (memberPhysicalEntity_asProtein == null) {
					...
					if (!memberPhysicalEntity_asProtein.contains(_memberPhysicalEntity_asProtein))
						memberPhysicalEntity_asProtein.add(_memberPhysicalEntity_asProtein);
					if (listeners != null) {
						java.util.ArrayList consumersForMemberPhysicalEntity_asProtein;
						synchronized (listeners) {
							consumersForMemberPhysicalEntity_asProtein = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForMemberPhysicalEntity_asProtein.iterator();iter.hasNext();){
							ProteinListener listener=(ProteinListener)iter.next();
							listener.memberPhysicalEntityAdded(fr.curie.BiNoM.pathways.biopax.ProteinImpl.this,_memberPhysicalEntity_asProtein);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(cellularLocationProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						ProteinListener listener=(ProteinListener)iter.next();
						listener.cellularLocationChanged(fr.curie.BiNoM.pathways.biopax.ProteinImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(entityReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						ProteinListener listener=(ProteinListener)iter.next();
						listener.entityReferenceChanged(fr.curie.BiNoM.pathways.biopax.ProteinImpl.this);
					}
				}
				return;
			}
...
//				return;
			if (stmt.getPredicate().equals(dataSourceProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDataSource.iterator();iter.hasNext();){
							ProteinListener listener=(ProteinListener)iter.next();
							listener.dataSourceRemoved(fr.curie.BiNoM.pathways.biopax.ProteinImpl.this,_dataSource);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(availabilityProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						ProteinListener listener=(ProteinListener)iter.next();
						listener.availabilityRemoved(fr.curie.BiNoM.pathways.biopax.ProteinImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(commentProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						ProteinListener listener=(ProteinListener)iter.next();
						listener.commentRemoved(fr.curie.BiNoM.pathways.biopax.ProteinImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						ProteinListener listener=(ProteinListener)iter.next();
						listener.nameRemoved(fr.curie.BiNoM.pathways.biopax.ProteinImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(evidenceProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForEvidence.iterator();iter.hasNext();){
							ProteinListener listener=(ProteinListener)iter.next();
							listener.evidenceRemoved(fr.curie.BiNoM.pathways.biopax.ProteinImpl.this,_evidence);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(xrefProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForXref.iterator();iter.hasNext();){
							ProteinListener listener=(ProteinListener)iter.next();
							listener.xrefRemoved(fr.curie.BiNoM.pathways.biopax.ProteinImpl.this,_xref);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(featureProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeature.iterator();iter.hasNext();){
							ProteinListener listener=(ProteinListener)iter.next();
							listener.featureRemoved(fr.curie.BiNoM.pathways.biopax.ProteinImpl.this,_feature);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(notFeatureProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForNotFeature.iterator();iter.hasNext();){
							ProteinListener listener=(ProteinListener)iter.next();
							listener.notFeatureRemoved(fr.curie.BiNoM.pathways.biopax.ProteinImpl.this,_notFeature);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(memberPhysicalEntityProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMemberPhysicalEntity.iterator();iter.hasNext();){
							ProteinListener listener=(ProteinListener)iter.next();
							listener.memberPhysicalEntityRemoved(fr.curie.BiNoM.pathways.biopax.ProteinImpl.this,_memberPhysicalEntity);
						}
					}
				}
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.Protein.TYPE)) {
					...
					if (memberPhysicalEntity_asProtein != null) {
						boolean found = false;
						for (int i=0;i<memberPhysicalEntity_asProtein.size();i++) {
							fr.curie.BiNoM.pathways.biopax.Protein __item = (fr.curie.BiNoM.pathways.biopax.Protein) memberPhysicalEntity_asProtein.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_memberPhysicalEntity_asProtein = __item;
								break;
							}
						}
						if (found)
							memberPhysicalEntity_asProtein.remove(_memberPhysicalEntity_asProtein);
						else {
							try {
								_memberPhysicalEntity_asProtein = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getProtein(resource,_model);
							} catch (JastorException e) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMemberPhysicalEntity_asProtein.iterator();iter.hasNext();){
							ProteinListener listener=(ProteinListener)iter.next();
							listener.memberPhysicalEntityRemoved(fr.curie.BiNoM.pathways.biopax.ProteinImpl.this,_memberPhysicalEntity_asProtein);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(entityReferenceProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
					if (entityReference != null && entityReference.resource().equals(resource))
						entityReference = null;				
					if (entityReference_asProteinReference != null && entityReference_asProteinReference.resource().equals(resource))
						entityReference_asProteinReference = null;				
				if (listeners != null) {
					java.util.ArrayList consumers;
					synchronized (listeners) {
