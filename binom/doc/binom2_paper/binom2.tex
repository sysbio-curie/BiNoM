...
\begin{itemize}
\item Import network. \textbf{Plugins - BiNoM IO - Import CellDesigner document
from file}.  Choose G1S.xml

\item	Get material decomposition: 36 modules are created.Plugins BiNoM
analysis - Get material components.
\item	Clustering. \textbf{Plugins - BiNoM analysis - Cluster networks}. Select
all networks except G1S and choose 25\% overlap. 7 networks are created.
