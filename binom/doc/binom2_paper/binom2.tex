...
For this study, we chose to concentrate on the G1 to S transition. We
...
different cell-cycle phases: G1 (PRB_star), S (CDK2/Cyclin E1 complex), M (CDC2/Cyclin E1 complex).}
