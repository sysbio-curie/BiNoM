...
non self-intersecting paths, see previous paragraph). The activity
$\alpha_k$ of the path $k$ is defined as the annotation
of the node. We define the sign $\sigma_k$
...
of interest, between a selection of annotated and target nodes defined by the user. A summary of the input data types is shown in table 2.
...
S phases (red coloring on the heatmap), indicating an enhanced proliferation for tumor cells.
