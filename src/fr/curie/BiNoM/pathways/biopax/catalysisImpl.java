...
/**
 * Implementation of {@link fr.curie.BiNoM.pathways.biopax.catalysis}
 ...
 * <br>
 */
public class catalysisImpl extends com.ibm.adtech.jastor.ThingImpl implements fr.curie.BiNoM.pathways.biopax.catalysis {
	...
	private fr.curie.BiNoM.pathways.biopax.conversion CONTROLLED_asconversion;
	...
	private static com.hp.hpl.jena.rdf.model.Property DIRECTIONProperty = ResourceFactory.createProperty("http://www.biopax.org/release/biopax-level2.owl#DIRECTION");
	private java.lang.String DIRECTION;
	private static com.hp.hpl.jena.rdf.model.Property COFACTORProperty = ResourceFactory.createProperty("http://www.biopax.org/release/biopax-level2.owl#COFACTOR");
	private java.util.ArrayList COFACTOR;

	catalysisImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static catalysisImpl getcatalysis(Resource resource, Model model) throws JastorException {
		return new catalysisImpl(resource, model);
	}
	    
	static catalysisImpl createcatalysis(Resource resource, Model model) throws JastorException {
		catalysisImpl impl = new catalysisImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, catalysis.TYPE)))
			impl._model.add(impl._resource, RDF.type, catalysis.TYPE);
		//impl.addSuperTypes();
	...
	void addHasValueValues() {
		if (!_model.contains(_resource, CONTROL_DASH_TYPEProperty, _model.createTypedLiteral("ACTIVATION^^http://www.w3.org/2001/XMLSchema#string")))
			_model.add(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(_resource, CONTROL_DASH_TYPEProperty, _model.createTypedLiteral("ACTIVATION^^http://www.w3.org/2001/XMLSchema#string")));
	}
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,DIRECTIONProperty,(RDFNode)null);
		while (it.hasNext()) {
			list.add(it.next());
		}
		it = _model.listStatements(_resource,COFACTORProperty,(RDFNode)null);
		while (it.hasNext()) {
			list.add(it.next());
		}
		it = _model.listStatements(_resource,RDF.type, fr.curie.BiNoM.pathways.biopax.catalysis.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	private void initDATA_DASH_SOURCE() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#DATA-SOURCE properties in catalysis model not a Resource", stmt.getObject());
	...
	private void initAVAILABILITY() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#AVAILABILITY properties in catalysis model not a Literal", stmt.getObject());
	...
	private void initCOMMENT() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#COMMENT properties in catalysis model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	public java.lang.String getSHORT_DASH_NAME() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": SHORT_DASH_NAME getProperty() in fr.curie.BiNoM.pathways.biopax.catalysis model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initSYNONYMS() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#SYNONYMS properties in catalysis model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	public java.lang.String getNAME() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": NAME getProperty() in fr.curie.BiNoM.pathways.biopax.catalysis model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
		Object obj = Util.fixLiteral(literal.getValue(),"java.lang.String");
	...
	private void initXREF() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#XREF properties in catalysis model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPARTICIPANTS_asphysicalEntityParticipant() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#PARTICIPANTS properties in catalysis model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	private void initEVIDENCE() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#EVIDENCE properties in catalysis model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initINTERACTION_DASH_TYPE() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#INTERACTION-TYPE properties in catalysis model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public fr.curie.BiNoM.pathways.biopax.physicalEntityParticipant getCONTROLLER() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": CONTROLLER getProperty() in fr.curie.BiNoM.pathways.biopax.catalysis model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	public fr.curie.BiNoM.pathways.biopax.conversion getCONTROLLED_asconversion() throws JastorException {
		if (CONTROLLED_asconversion != null)
			return CONTROLLED_asconversion;
		com.hp.hpl.jena.rdf.model.Statement stmt = _model.getProperty(_resource, CONTROLLEDProperty);
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": CONTROLLED_asconversion getProperty() in fr.curie.BiNoM.pathways.biopax.catalysis model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
		if (!_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.conversion.TYPE))
			return null;
		CONTROLLED_asconversion = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level2_DOT_owlFactory.getconversion(resource,_model);
		return CONTROLLED_asconversion;
	}

	public void setCONTROLLED(fr.curie.BiNoM.pathways.biopax.conversion CONTROLLED) throws JastorException {
		if (_model.contains(_resource,CONTROLLEDProperty)) {
			_model.removeAll(_resource,CONTROLLEDProperty,null);
		}
		this.CONTROLLED_asconversion = CONTROLLED;
		if (CONTROLLED != null) {
			_model.add(_model.createStatement(_resource,CONTROLLEDProperty, CONTROLLED.resource()));
		}			
	}
		
	public fr.curie.BiNoM.pathways.biopax.conversion setCONTROLLED_asconversion() throws JastorException {
		if (_model.contains(_resource,CONTROLLEDProperty)) {
			_model.removeAll(_resource,CONTROLLEDProperty,null);
		}
		fr.curie.BiNoM.pathways.biopax.conversion CONTROLLED = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level2_DOT_owlFactory.createconversion(_model.createResource(),_model);
		this.CONTROLLED_asconversion = CONTROLLED;
		_model.add(_model.createStatement(_resource,CONTROLLEDProperty, CONTROLLED.resource()));
		return CONTROLLED;
	}
	
	public fr.curie.BiNoM.pathways.biopax.conversion setCONTROLLED_asconversion(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		if (_model.contains(_resource,CONTROLLEDProperty)) {
			_model.removeAll(_resource,CONTROLLEDProperty,null);
		}
		fr.curie.BiNoM.pathways.biopax.conversion CONTROLLED = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level2_DOT_owlFactory.getconversion(resource,_model);
		this.CONTROLLED_asconversion = CONTROLLED;
		_model.add(_model.createStatement(_resource,CONTROLLEDProperty, CONTROLLED.resource()));
		return CONTROLLED;
	}
	...
	public fr.curie.BiNoM.pathways.biopax.interaction getCONTROLLED_asinteraction() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": CONTROLLED_asinteraction getProperty() in fr.curie.BiNoM.pathways.biopax.catalysis model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	public fr.curie.BiNoM.pathways.biopax.pathway getCONTROLLED_aspathway() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": CONTROLLED_aspathway getProperty() in fr.curie.BiNoM.pathways.biopax.catalysis model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	public java.lang.String getCONTROL_DASH_TYPE() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": CONTROL_DASH_TYPE getProperty() in fr.curie.BiNoM.pathways.biopax.catalysis model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
		Object obj = Util.fixLiteral(literal.getValue(),"java.lang.String");
	...
	public java.lang.String getDIRECTION() throws JastorException {
		if (DIRECTION != null)
			return DIRECTION;
		com.hp.hpl.jena.rdf.model.Statement stmt = _model.getProperty(_resource, DIRECTIONProperty);
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": DIRECTION getProperty() in fr.curie.BiNoM.pathways.biopax.catalysis model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
		Object obj = Util.fixLiteral(literal.getValue(),"java.lang.String");
		DIRECTION = (java.lang.String)obj;
		return DIRECTION;
	}
	
	public void setDIRECTION(java.lang.String DIRECTION) throws JastorException {
		if (_model.contains(_resource,DIRECTIONProperty)) {
			_model.removeAll(_resource,DIRECTIONProperty,null);
		}
		this.DIRECTION = DIRECTION;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
		if (DIRECTION != null) {
			_model.add(_model.createStatement(_resource,DIRECTIONProperty, _model.createTypedLiteral(DIRECTION)));
		}	
	}


	private void initCOFACTOR() throws JastorException {
		this.COFACTOR = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, COFACTORProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#COFACTOR properties in catalysis model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				fr.curie.BiNoM.pathways.biopax.physicalEntityParticipant COFACTOR = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level2_DOT_owlFactory.getphysicalEntityParticipant(resource,_model);
				this.COFACTOR.add(COFACTOR);
			}
		}
	}

	public java.util.Iterator getCOFACTOR() throws JastorException {
		if (COFACTOR == null)
			initCOFACTOR();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(COFACTOR,_resource,COFACTORProperty,true);
	}

	public void addCOFACTOR(fr.curie.BiNoM.pathways.biopax.physicalEntityParticipant COFACTOR) throws JastorException {
		...
		this.COFACTOR.add(COFACTOR);
		_model.add(_model.createStatement(_resource,COFACTORProperty,COFACTOR.resource()));
	}
	
	public fr.curie.BiNoM.pathways.biopax.physicalEntityParticipant addCOFACTOR() throws JastorException {
		fr.curie.BiNoM.pathways.biopax.physicalEntityParticipant COFACTOR = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level2_DOT_owlFactory.createphysicalEntityParticipant(_model.createResource(),_model);
		if (this.COFACTOR == null)
			initCOFACTOR();
		this.COFACTOR.add(COFACTOR);
		_model.add(_model.createStatement(_resource,COFACTORProperty,COFACTOR.resource()));
	...
	public fr.curie.BiNoM.pathways.biopax.physicalEntityParticipant addCOFACTOR(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		fr.curie.BiNoM.pathways.biopax.physicalEntityParticipant COFACTOR = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level2_DOT_owlFactory.getphysicalEntityParticipant(resource,_model);
		if (this.COFACTOR == null)
			initCOFACTOR();
		if (this.COFACTOR.contains(COFACTOR))
	...
	public void removeCOFACTOR(fr.curie.BiNoM.pathways.biopax.physicalEntityParticipant COFACTOR) throws JastorException {
		if (this.COFACTOR == null)
			initCOFACTOR();
		if (!this.COFACTOR.contains(COFACTOR))
			return;
		if (!_model.contains(_resource, COFACTORProperty, COFACTOR.resource()))
			return;
		this.COFACTOR.remove(COFACTOR);
		_model.removeAll(_resource, COFACTORProperty, COFACTOR.resource());
	}
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof catalysisListener))
			throw new IllegalArgumentException("ThingListener must be instance of catalysisListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((catalysisListener)listener);
		}
	}
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDATA_DASH_SOURCE.iterator();iter.hasNext();){
							catalysisListener listener=(catalysisListener)iter.next();
							listener.DATA_DASH_SOURCEAdded(fr.curie.BiNoM.pathways.biopax.catalysisImpl.this,_DATA_DASH_SOURCE);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(AVAILABILITYProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForAVAILABILITY.iterator();iter.hasNext();){
						catalysisListener listener=(catalysisListener)iter.next();
						listener.AVAILABILITYAdded(fr.curie.BiNoM.pathways.biopax.catalysisImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(COMMENTProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForCOMMENT.iterator();iter.hasNext();){
						catalysisListener listener=(catalysisListener)iter.next();
						listener.COMMENTAdded(fr.curie.BiNoM.pathways.biopax.catalysisImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(SHORT_DASH_NAMEProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						catalysisListener listener=(catalysisListener)iter.next();
						listener.SHORT_DASH_NAMEChanged(fr.curie.BiNoM.pathways.biopax.catalysisImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(SYNONYMSProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForSYNONYMS.iterator();iter.hasNext();){
						catalysisListener listener=(catalysisListener)iter.next();
						listener.SYNONYMSAdded(fr.curie.BiNoM.pathways.biopax.catalysisImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(NAMEProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						catalysisListener listener=(catalysisListener)iter.next();
						listener.NAMEChanged(fr.curie.BiNoM.pathways.biopax.catalysisImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForXREF.iterator();iter.hasNext();){
							catalysisListener listener=(catalysisListener)iter.next();
							listener.XREFAdded(fr.curie.BiNoM.pathways.biopax.catalysisImpl.this,_XREF);
						}
					}
				}
				return;
				...
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.physicalEntityParticipant.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPARTICIPANTS_asphysicalEntityParticipant.iterator();iter.hasNext();){
							catalysisListener listener=(catalysisListener)iter.next();
							listener.PARTICIPANTSAdded(fr.curie.BiNoM.pathways.biopax.catalysisImpl.this,_PARTICIPANTS_asphysicalEntityParticipant);
						}
					}
				}
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.entity.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPARTICIPANTS_asentity.iterator();iter.hasNext();){
							catalysisListener listener=(catalysisListener)iter.next();
							listener.PARTICIPANTSAdded(fr.curie.BiNoM.pathways.biopax.catalysisImpl.this,_PARTICIPANTS_asentity);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForEVIDENCE.iterator();iter.hasNext();){
							catalysisListener listener=(catalysisListener)iter.next();
							listener.EVIDENCEAdded(fr.curie.BiNoM.pathways.biopax.catalysisImpl.this,_EVIDENCE);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForINTERACTION_DASH_TYPE.iterator();iter.hasNext();){
							catalysisListener listener=(catalysisListener)iter.next();
							listener.INTERACTION_DASH_TYPEAdded(fr.curie.BiNoM.pathways.biopax.catalysisImpl.this,_INTERACTION_DASH_TYPE);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(CONTROLLERProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						catalysisListener listener=(catalysisListener)iter.next();
						listener.CONTROLLERChanged(fr.curie.BiNoM.pathways.biopax.catalysisImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(CONTROLLEDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						catalysisListener listener=(catalysisListener)iter.next();
						listener.CONTROLLEDChanged(fr.curie.BiNoM.pathways.biopax.catalysisImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(CONTROL_DASH_TYPEProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						catalysisListener listener=(catalysisListener)iter.next();
						listener.CONTROL_DASH_TYPEChanged(fr.curie.BiNoM.pathways.biopax.catalysisImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(DIRECTIONProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
					return;
				com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
				DIRECTION = (java.lang.String)Util.fixLiteral(literal.getValue(),"java.lang.String");
				if (listeners != null) {
					java.util.ArrayList consumers;
					synchronized (listeners) {
						consumers = (java.util.ArrayList) listeners.clone();
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						catalysisListener listener=(catalysisListener)iter.next();
						listener.DIRECTIONChanged(fr.curie.BiNoM.pathways.biopax.catalysisImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(COFACTORProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
					return;
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					fr.curie.BiNoM.pathways.biopax.physicalEntityParticipant _COFACTOR = null;
					try {
						_COFACTOR = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level2_DOT_owlFactory.getphysicalEntityParticipant(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (COFACTOR == null) {
					...
					if (!COFACTOR.contains(_COFACTOR))
						COFACTOR.add(_COFACTOR);
					if (listeners != null) {
						java.util.ArrayList consumersForCOFACTOR;
						synchronized (listeners) {
							consumersForCOFACTOR = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForCOFACTOR.iterator();iter.hasNext();){
							catalysisListener listener=(catalysisListener)iter.next();
							listener.COFACTORAdded(fr.curie.BiNoM.pathways.biopax.catalysisImpl.this,_COFACTOR);
						}
					}
				}
				return;
...
//				return;
			if (stmt.getPredicate().equals(DATA_DASH_SOURCEProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDATA_DASH_SOURCE.iterator();iter.hasNext();){
							catalysisListener listener=(catalysisListener)iter.next();
							listener.DATA_DASH_SOURCERemoved(fr.curie.BiNoM.pathways.biopax.catalysisImpl.this,_DATA_DASH_SOURCE);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(AVAILABILITYProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						catalysisListener listener=(catalysisListener)iter.next();
						listener.AVAILABILITYRemoved(fr.curie.BiNoM.pathways.biopax.catalysisImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(COMMENTProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						catalysisListener listener=(catalysisListener)iter.next();
						listener.COMMENTRemoved(fr.curie.BiNoM.pathways.biopax.catalysisImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			...
			if (stmt.getPredicate().equals(SYNONYMSProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						catalysisListener listener=(catalysisListener)iter.next();
						listener.SYNONYMSRemoved(fr.curie.BiNoM.pathways.biopax.catalysisImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			...
			if (stmt.getPredicate().equals(XREFProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForXREF.iterator();iter.hasNext();){
							catalysisListener listener=(catalysisListener)iter.next();
							listener.XREFRemoved(fr.curie.BiNoM.pathways.biopax.catalysisImpl.this,_XREF);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(PARTICIPANTSProperty)) {
				...
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.physicalEntityParticipant.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPARTICIPANTS_asphysicalEntityParticipant.iterator();iter.hasNext();){
							catalysisListener listener=(catalysisListener)iter.next();
							listener.PARTICIPANTSRemoved(fr.curie.BiNoM.pathways.biopax.catalysisImpl.this,_PARTICIPANTS_asphysicalEntityParticipant);
						}
					}
				}
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.entity.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPARTICIPANTS_asentity.iterator();iter.hasNext();){
							catalysisListener listener=(catalysisListener)iter.next();
							listener.PARTICIPANTSRemoved(fr.curie.BiNoM.pathways.biopax.catalysisImpl.this,_PARTICIPANTS_asentity);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(EVIDENCEProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForEVIDENCE.iterator();iter.hasNext();){
							catalysisListener listener=(catalysisListener)iter.next();
							listener.EVIDENCERemoved(fr.curie.BiNoM.pathways.biopax.catalysisImpl.this,_EVIDENCE);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(INTERACTION_DASH_TYPEProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForINTERACTION_DASH_TYPE.iterator();iter.hasNext();){
							catalysisListener listener=(catalysisListener)iter.next();
							listener.INTERACTION_DASH_TYPERemoved(fr.curie.BiNoM.pathways.biopax.catalysisImpl.this,_INTERACTION_DASH_TYPE);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(CONTROLLEDProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
					return;
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
					if (CONTROLLED_asconversion != null && CONTROLLED_asconversion.resource().equals(resource))
						CONTROLLED_asconversion = null;				
			...
			if (stmt.getPredicate().equals(DIRECTIONProperty)) {
				...
				//Object obj = literal.getValue();
				Object obj = Util.fixLiteral(literal.getValue(),"java.lang.String");
				if (DIRECTION != null && DIRECTION.equals(obj))
					DIRECTION = null;
				if (listeners != null) {
					java.util.ArrayList consumers;
					synchronized (listeners) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (COFACTOR != null) {
						...
						for (int i=0;i<COFACTOR.size();i++) {
							fr.curie.BiNoM.pathways.biopax.physicalEntityParticipant __item = (fr.curie.BiNoM.pathways.biopax.physicalEntityParticipant) COFACTOR.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_COFACTOR = __item;
								break;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForCOFACTOR.iterator();iter.hasNext();){
							catalysisListener listener=(catalysisListener)iter.next();
							listener.COFACTORRemoved(fr.curie.BiNoM.pathways.biopax.catalysisImpl.this,_COFACTOR);
						}
					}
				}
				return;
