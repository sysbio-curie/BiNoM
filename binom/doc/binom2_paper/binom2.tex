...
is for example based on the expression levels of the genes within the module,
wich can be visualized using a color code. It's then fairly easy to visualize
the difference between a disease and a normal state, or even to try to
discriminate between different disease stages. We have produce such maps for the
