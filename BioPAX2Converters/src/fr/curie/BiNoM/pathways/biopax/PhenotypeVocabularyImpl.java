...
/**
 * Implementation of {@link fr.curie.BiNoM.pathways.biopax.PhenotypeVocabulary}
 ...
 * <br>
 */
public class PhenotypeVocabularyImpl extends com.ibm.adtech.jastor.ThingImpl implements fr.curie.BiNoM.pathways.biopax.PhenotypeVocabulary {
	...
	private static com.hp.hpl.jena.rdf.model.Property patoDataProperty = ResourceFactory.createProperty("http://www.biopax.org/release/biopax-level3.owl#patoData");
	private java.lang.String patoData;

	PhenotypeVocabularyImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static PhenotypeVocabularyImpl getPhenotypeVocabulary(Resource resource, Model model) throws JastorException {
		return new PhenotypeVocabularyImpl(resource, model);
	}
	    
	static PhenotypeVocabularyImpl createPhenotypeVocabulary(Resource resource, Model model) throws JastorException {
		PhenotypeVocabularyImpl impl = new PhenotypeVocabularyImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, PhenotypeVocabulary.TYPE)))
			impl._model.add(impl._resource, RDF.type, PhenotypeVocabulary.TYPE);
		impl.addSuperTypes();
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,patoDataProperty,(RDFNode)null);
		while (it.hasNext()) {
			list.add(it.next());
		}
		it = _model.listStatements(_resource,RDF.type, fr.curie.BiNoM.pathways.biopax.PhenotypeVocabulary.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	private void initComment() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#comment properties in PhenotypeVocabulary model not a Literal", stmt.getObject());
	...
	private void initTerm() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#term properties in PhenotypeVocabulary model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initXref() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#xref properties in PhenotypeVocabulary model not a Resource", stmt.getObject());
	...
	public java.lang.String getPatoData() throws JastorException {
		if (patoData != null)
			return patoData;
		com.hp.hpl.jena.rdf.model.Statement stmt = _model.getProperty(_resource, patoDataProperty);
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": patoData getProperty() in fr.curie.BiNoM.pathways.biopax.PhenotypeVocabulary model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
		Object obj = Util.fixLiteral(literal.getValue(),"java.lang.String");
		patoData = (java.lang.String)obj;
		return patoData;
	}
	
	public void setPatoData(java.lang.String patoData) throws JastorException {
		if (_model.contains(_resource,patoDataProperty)) {
			_model.removeAll(_resource,patoDataProperty,null);
		}
		this.patoData = patoData;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
		if (patoData != null) {
			_model.add(_model.createStatement(_resource,patoDataProperty, _model.createTypedLiteral(patoData)));
		}	
	}
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof PhenotypeVocabularyListener))
			throw new IllegalArgumentException("ThingListener must be instance of PhenotypeVocabularyListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((PhenotypeVocabularyListener)listener);
		}
	}
			...
			if (stmt.getPredicate().equals(commentProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForComment.iterator();iter.hasNext();){
						PhenotypeVocabularyListener listener=(PhenotypeVocabularyListener)iter.next();
						listener.commentAdded(fr.curie.BiNoM.pathways.biopax.PhenotypeVocabularyImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(termProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForTerm.iterator();iter.hasNext();){
						PhenotypeVocabularyListener listener=(PhenotypeVocabularyListener)iter.next();
						listener.termAdded(fr.curie.BiNoM.pathways.biopax.PhenotypeVocabularyImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForXref.iterator();iter.hasNext();){
							PhenotypeVocabularyListener listener=(PhenotypeVocabularyListener)iter.next();
							listener.xrefAdded(fr.curie.BiNoM.pathways.biopax.PhenotypeVocabularyImpl.this,_xref);
						}
					}
				}
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.UnificationXref.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForXref_asUnificationXref.iterator();iter.hasNext();){
							PhenotypeVocabularyListener listener=(PhenotypeVocabularyListener)iter.next();
							listener.xrefAdded(fr.curie.BiNoM.pathways.biopax.PhenotypeVocabularyImpl.this,_xref_asUnificationXref);
						}
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(patoDataProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
					return;
				com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
				patoData = (java.lang.String)Util.fixLiteral(literal.getValue(),"java.lang.String");
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						PhenotypeVocabularyListener listener=(PhenotypeVocabularyListener)iter.next();
						listener.patoDataChanged(fr.curie.BiNoM.pathways.biopax.PhenotypeVocabularyImpl.this);
					}
				}
				return;
			}
...
//				return;
			if (stmt.getPredicate().equals(commentProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						PhenotypeVocabularyListener listener=(PhenotypeVocabularyListener)iter.next();
						listener.commentRemoved(fr.curie.BiNoM.pathways.biopax.PhenotypeVocabularyImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(termProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						PhenotypeVocabularyListener listener=(PhenotypeVocabularyListener)iter.next();
						listener.termRemoved(fr.curie.BiNoM.pathways.biopax.PhenotypeVocabularyImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(xrefProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForXref.iterator();iter.hasNext();){
							PhenotypeVocabularyListener listener=(PhenotypeVocabularyListener)iter.next();
							listener.xrefRemoved(fr.curie.BiNoM.pathways.biopax.PhenotypeVocabularyImpl.this,_xref);
						}
					}
				}
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.UnificationXref.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForXref_asUnificationXref.iterator();iter.hasNext();){
							PhenotypeVocabularyListener listener=(PhenotypeVocabularyListener)iter.next();
							listener.xrefRemoved(fr.curie.BiNoM.pathways.biopax.PhenotypeVocabularyImpl.this,_xref_asUnificationXref);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(patoDataProperty)) {
				...
				//Object obj = literal.getValue();
				Object obj = Util.fixLiteral(literal.getValue(),"java.lang.String");
				if (patoData != null && patoData.equals(obj))
					patoData = null;
				if (listeners != null) {
					java.util.ArrayList consumers;
					synchronized (listeners) {
