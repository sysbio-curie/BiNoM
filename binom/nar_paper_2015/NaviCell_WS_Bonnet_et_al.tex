...
user interfaces (GUI) allowing performing data visualization, on top of
...
values between two or more groups of conditions (e.g. disease vs control as in Figure~2B-D).
...
This can be useful to compare several experimental conditions on the same
map.
...
onto biological networks, when observed at the bird's-eye view level (see example in Figure 2).
...
provided at \href{http://navicell.curie.fr/pages/nav\_web\_service.html}.. In Supplementary
