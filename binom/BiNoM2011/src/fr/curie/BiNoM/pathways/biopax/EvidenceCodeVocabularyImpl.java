...
/**
 * Implementation of {@link fr.curie.BiNoM.pathways.biopax.EvidenceCodeVocabulary}
 ...
 * <br>
 */
public class EvidenceCodeVocabularyImpl extends com.ibm.adtech.jastor.ThingImpl implements fr.curie.BiNoM.pathways.biopax.EvidenceCodeVocabulary {
	...
	EvidenceCodeVocabularyImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static EvidenceCodeVocabularyImpl getEvidenceCodeVocabulary(Resource resource, Model model) throws JastorException {
		return new EvidenceCodeVocabularyImpl(resource, model);
	}
	    
	static EvidenceCodeVocabularyImpl createEvidenceCodeVocabulary(Resource resource, Model model) throws JastorException {
		EvidenceCodeVocabularyImpl impl = new EvidenceCodeVocabularyImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, EvidenceCodeVocabulary.TYPE)))
			impl._model.add(impl._resource, RDF.type, EvidenceCodeVocabulary.TYPE);
		impl.addSuperTypes();
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, fr.curie.BiNoM.pathways.biopax.EvidenceCodeVocabulary.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	private void initComment() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#comment properties in EvidenceCodeVocabulary model not a Literal", stmt.getObject());
	...
	private void initTerm() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#term properties in EvidenceCodeVocabulary model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initXref() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#xref properties in EvidenceCodeVocabulary model not a Resource", stmt.getObject());
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof EvidenceCodeVocabularyListener))
			throw new IllegalArgumentException("ThingListener must be instance of EvidenceCodeVocabularyListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((EvidenceCodeVocabularyListener)listener);
		}
	}
			...
			if (stmt.getPredicate().equals(commentProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForComment.iterator();iter.hasNext();){
						EvidenceCodeVocabularyListener listener=(EvidenceCodeVocabularyListener)iter.next();
						listener.commentAdded(fr.curie.BiNoM.pathways.biopax.EvidenceCodeVocabularyImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(termProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForTerm.iterator();iter.hasNext();){
						EvidenceCodeVocabularyListener listener=(EvidenceCodeVocabularyListener)iter.next();
						listener.termAdded(fr.curie.BiNoM.pathways.biopax.EvidenceCodeVocabularyImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForXref.iterator();iter.hasNext();){
							EvidenceCodeVocabularyListener listener=(EvidenceCodeVocabularyListener)iter.next();
							listener.xrefAdded(fr.curie.BiNoM.pathways.biopax.EvidenceCodeVocabularyImpl.this,_xref);
						}
					}
				}
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.UnificationXref.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForXref_asUnificationXref.iterator();iter.hasNext();){
							EvidenceCodeVocabularyListener listener=(EvidenceCodeVocabularyListener)iter.next();
							listener.xrefAdded(fr.curie.BiNoM.pathways.biopax.EvidenceCodeVocabularyImpl.this,_xref_asUnificationXref);
						}
					}
				}
				return;
...
//				return;
			if (stmt.getPredicate().equals(commentProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						EvidenceCodeVocabularyListener listener=(EvidenceCodeVocabularyListener)iter.next();
						listener.commentRemoved(fr.curie.BiNoM.pathways.biopax.EvidenceCodeVocabularyImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(termProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						EvidenceCodeVocabularyListener listener=(EvidenceCodeVocabularyListener)iter.next();
						listener.termRemoved(fr.curie.BiNoM.pathways.biopax.EvidenceCodeVocabularyImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(xrefProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForXref.iterator();iter.hasNext();){
							EvidenceCodeVocabularyListener listener=(EvidenceCodeVocabularyListener)iter.next();
							listener.xrefRemoved(fr.curie.BiNoM.pathways.biopax.EvidenceCodeVocabularyImpl.this,_xref);
						}
					}
				}
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.UnificationXref.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForXref_asUnificationXref.iterator();iter.hasNext();){
							EvidenceCodeVocabularyListener listener=(EvidenceCodeVocabularyListener)iter.next();
							listener.xrefRemoved(fr.curie.BiNoM.pathways.biopax.EvidenceCodeVocabularyImpl.this,_xref_asUnificationXref);
						}
					}
				}
				return;
