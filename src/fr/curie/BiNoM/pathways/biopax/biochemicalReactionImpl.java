...
public class biochemicalReactionImpl extends com.ibm.adtech.jastor.ThingImpl implements fr.curie.BiNoM.pathways.biopax.biochemicalReaction {
	...
	private void initDATA_DASH_SOURCE() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#DATA-SOURCE properties in biochemicalReaction model not a Resource", stmt.getObject());
	...
	private void initAVAILABILITY() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#AVAILABILITY properties in biochemicalReaction model not a Literal", stmt.getObject());
	...
	private void initCOMMENT() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#COMMENT properties in biochemicalReaction model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	public java.lang.String getSHORT_DASH_NAME() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": SHORT_DASH_NAME getProperty() in fr.curie.BiNoM.pathways.biopax.biochemicalReaction model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initSYNONYMS() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#SYNONYMS properties in biochemicalReaction model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	public java.lang.String getNAME() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": NAME getProperty() in fr.curie.BiNoM.pathways.biopax.biochemicalReaction model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
		Object obj = Util.fixLiteral(literal.getValue(),"java.lang.String");
	...
	private void initXREF() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#XREF properties in biochemicalReaction model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPARTICIPANTS_asphysicalEntityParticipant() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#PARTICIPANTS properties in biochemicalReaction model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	private void initEVIDENCE() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#EVIDENCE properties in biochemicalReaction model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initINTERACTION_DASH_TYPE() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#INTERACTION-TYPE properties in biochemicalReaction model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initLEFT() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#LEFT properties in biochemicalReaction model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initRIGHT() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#RIGHT properties in biochemicalReaction model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initDELTA_DASH_H() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#DELTA-H properties in biochemicalReaction model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initEC_DASH_NUMBER() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#EC-NUMBER properties in biochemicalReaction model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initDELTA_DASH_S() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#DELTA-S properties in biochemicalReaction model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initDELTA_DASH_G() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#DELTA-G properties in biochemicalReaction model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initKEQ() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#KEQ properties in biochemicalReaction model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDATA_DASH_SOURCE.iterator();iter.hasNext();){
							...
							listener.DATA_DASH_SOURCEAdded(fr.curie.BiNoM.pathways.biopax.biochemicalReactionImpl.this,_DATA_DASH_SOURCE);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(SHORT_DASH_NAMEProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						biochemicalReactionListener listener=(biochemicalReactionListener)iter.next();
						listener.SHORT_DASH_NAMEChanged(fr.curie.BiNoM.pathways.biopax.biochemicalReactionImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(SYNONYMSProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForSYNONYMS.iterator();iter.hasNext();){
						biochemicalReactionListener listener=(biochemicalReactionListener)iter.next();
						listener.SYNONYMSAdded(fr.curie.BiNoM.pathways.biopax.biochemicalReactionImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(NAMEProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						biochemicalReactionListener listener=(biochemicalReactionListener)iter.next();
						listener.NAMEChanged(fr.curie.BiNoM.pathways.biopax.biochemicalReactionImpl.this);
					}
				}
				return;
			}
				...
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.physicalEntityParticipant.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPARTICIPANTS_asphysicalEntityParticipant.iterator();iter.hasNext();){
							biochemicalReactionListener listener=(biochemicalReactionListener)iter.next();
							listener.PARTICIPANTSAdded(fr.curie.BiNoM.pathways.biopax.biochemicalReactionImpl.this,_PARTICIPANTS_asphysicalEntityParticipant);
						}
					}
				}
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.entity.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPARTICIPANTS_asentity.iterator();iter.hasNext();){
							biochemicalReactionListener listener=(biochemicalReactionListener)iter.next();
							listener.PARTICIPANTSAdded(fr.curie.BiNoM.pathways.biopax.biochemicalReactionImpl.this,_PARTICIPANTS_asentity);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForINTERACTION_DASH_TYPE.iterator();iter.hasNext();){
							biochemicalReactionListener listener=(biochemicalReactionListener)iter.next();
							listener.INTERACTION_DASH_TYPEAdded(fr.curie.BiNoM.pathways.biopax.biochemicalReactionImpl.this,_INTERACTION_DASH_TYPE);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(DELTA_DASH_HProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDELTA_DASH_H.iterator();iter.hasNext();){
						biochemicalReactionListener listener=(biochemicalReactionListener)iter.next();
						listener.DELTA_DASH_HAdded(fr.curie.BiNoM.pathways.biopax.biochemicalReactionImpl.this,(java.lang.Double)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(EC_DASH_NUMBERProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForEC_DASH_NUMBER.iterator();iter.hasNext();){
						biochemicalReactionListener listener=(biochemicalReactionListener)iter.next();
						listener.EC_DASH_NUMBERAdded(fr.curie.BiNoM.pathways.biopax.biochemicalReactionImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(DELTA_DASH_SProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDELTA_DASH_S.iterator();iter.hasNext();){
						biochemicalReactionListener listener=(biochemicalReactionListener)iter.next();
						listener.DELTA_DASH_SAdded(fr.curie.BiNoM.pathways.biopax.biochemicalReactionImpl.this,(java.lang.Double)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDELTA_DASH_G.iterator();iter.hasNext();){
							biochemicalReactionListener listener=(biochemicalReactionListener)iter.next();
							listener.DELTA_DASH_GAdded(fr.curie.BiNoM.pathways.biopax.biochemicalReactionImpl.this,_DELTA_DASH_G);
						}
					}
				}
				return;
...
//				return;
			if (stmt.getPredicate().equals(DATA_DASH_SOURCEProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDATA_DASH_SOURCE.iterator();iter.hasNext();){
							biochemicalReactionListener listener=(biochemicalReactionListener)iter.next();
							listener.DATA_DASH_SOURCERemoved(fr.curie.BiNoM.pathways.biopax.biochemicalReactionImpl.this,_DATA_DASH_SOURCE);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(SYNONYMSProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						biochemicalReactionListener listener=(biochemicalReactionListener)iter.next();
						listener.SYNONYMSRemoved(fr.curie.BiNoM.pathways.biopax.biochemicalReactionImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			...
			if (stmt.getPredicate().equals(PARTICIPANTSProperty)) {
				...
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.physicalEntityParticipant.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPARTICIPANTS_asphysicalEntityParticipant.iterator();iter.hasNext();){
							biochemicalReactionListener listener=(biochemicalReactionListener)iter.next();
							listener.PARTICIPANTSRemoved(fr.curie.BiNoM.pathways.biopax.biochemicalReactionImpl.this,_PARTICIPANTS_asphysicalEntityParticipant);
						}
					}
				}
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.entity.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPARTICIPANTS_asentity.iterator();iter.hasNext();){
							biochemicalReactionListener listener=(biochemicalReactionListener)iter.next();
							listener.PARTICIPANTSRemoved(fr.curie.BiNoM.pathways.biopax.biochemicalReactionImpl.this,_PARTICIPANTS_asentity);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(INTERACTION_DASH_TYPEProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForINTERACTION_DASH_TYPE.iterator();iter.hasNext();){
							biochemicalReactionListener listener=(biochemicalReactionListener)iter.next();
							listener.INTERACTION_DASH_TYPERemoved(fr.curie.BiNoM.pathways.biopax.biochemicalReactionImpl.this,_INTERACTION_DASH_TYPE);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(DELTA_DASH_HProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						biochemicalReactionListener listener=(biochemicalReactionListener)iter.next();
						listener.DELTA_DASH_HRemoved(fr.curie.BiNoM.pathways.biopax.biochemicalReactionImpl.this,(java.lang.Double)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(EC_DASH_NUMBERProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						biochemicalReactionListener listener=(biochemicalReactionListener)iter.next();
						listener.EC_DASH_NUMBERRemoved(fr.curie.BiNoM.pathways.biopax.biochemicalReactionImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(DELTA_DASH_SProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						biochemicalReactionListener listener=(biochemicalReactionListener)iter.next();
						listener.DELTA_DASH_SRemoved(fr.curie.BiNoM.pathways.biopax.biochemicalReactionImpl.this,(java.lang.Double)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(DELTA_DASH_GProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDELTA_DASH_G.iterator();iter.hasNext();){
							biochemicalReactionListener listener=(biochemicalReactionListener)iter.next();
							listener.DELTA_DASH_GRemoved(fr.curie.BiNoM.pathways.biopax.biochemicalReactionImpl.this,_DELTA_DASH_G);
						}
					}
				}
				return;
