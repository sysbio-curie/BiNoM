...
public class ChangeWeightEdgeTestTask implements Task{
	...
	public void run(){
		...
		for(int i=kappas.size()-1;i>-1;i--){
			a.txt.append(a.wgs.edges.get(foundEdges.get(i)).getIdentifier());a.txt.append("\t");
			a.txt.append(a.weightValue(foundEdges.get(i)));a.txt.append("\t");
			a.txt.append(kappas.get(i));a.txt.append("\r\n");
		}
