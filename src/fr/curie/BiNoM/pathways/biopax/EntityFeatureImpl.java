...
/**
 * Implementation of {@link fr.curie.BiNoM.pathways.biopax.EntityFeature}
 ...
 * <br>
 */
public class EntityFeatureImpl extends com.ibm.adtech.jastor.ThingImpl implements fr.curie.BiNoM.pathways.biopax.EntityFeature {
	...
	static EntityFeatureImpl getEntityFeature(Resource resource, Model model) throws JastorException {
		return new EntityFeatureImpl(resource, model);
	}
	    
	static EntityFeatureImpl createEntityFeature(Resource resource, Model model) throws JastorException {
		EntityFeatureImpl impl = new EntityFeatureImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, EntityFeature.TYPE)))
			impl._model.add(impl._resource, RDF.type, EntityFeature.TYPE);
		impl.addSuperTypes();
	...
	private void initComment() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#comment properties in EntityFeature model not a Literal", stmt.getObject());
	...
	private void initMemberFeature() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#memberFeature properties in EntityFeature model not a Resource", stmt.getObject());
	...
	private void initFeatureLocation() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#featureLocation properties in EntityFeature model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initFeatureLocationType() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#featureLocationType properties in EntityFeature model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initEvidence() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#evidence properties in EntityFeature model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
			...
			if (stmt.getPredicate().equals(commentProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForComment.iterator();iter.hasNext();){
						EntityFeatureListener listener=(EntityFeatureListener)iter.next();
						listener.commentAdded(fr.curie.BiNoM.pathways.biopax.EntityFeatureImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMemberFeature.iterator();iter.hasNext();){
							EntityFeatureListener listener=(EntityFeatureListener)iter.next();
							listener.memberFeatureAdded(fr.curie.BiNoM.pathways.biopax.EntityFeatureImpl.this,_memberFeature);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeatureLocation.iterator();iter.hasNext();){
							EntityFeatureListener listener=(EntityFeatureListener)iter.next();
							listener.featureLocationAdded(fr.curie.BiNoM.pathways.biopax.EntityFeatureImpl.this,_featureLocation);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeatureLocationType.iterator();iter.hasNext();){
							EntityFeatureListener listener=(EntityFeatureListener)iter.next();
							listener.featureLocationTypeAdded(fr.curie.BiNoM.pathways.biopax.EntityFeatureImpl.this,_featureLocationType);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForEvidence.iterator();iter.hasNext();){
							EntityFeatureListener listener=(EntityFeatureListener)iter.next();
							listener.evidenceAdded(fr.curie.BiNoM.pathways.biopax.EntityFeatureImpl.this,_evidence);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(commentProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						EntityFeatureListener listener=(EntityFeatureListener)iter.next();
						listener.commentRemoved(fr.curie.BiNoM.pathways.biopax.EntityFeatureImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(memberFeatureProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMemberFeature.iterator();iter.hasNext();){
							EntityFeatureListener listener=(EntityFeatureListener)iter.next();
							listener.memberFeatureRemoved(fr.curie.BiNoM.pathways.biopax.EntityFeatureImpl.this,_memberFeature);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(featureLocationProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeatureLocation.iterator();iter.hasNext();){
							EntityFeatureListener listener=(EntityFeatureListener)iter.next();
							listener.featureLocationRemoved(fr.curie.BiNoM.pathways.biopax.EntityFeatureImpl.this,_featureLocation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(featureLocationTypeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeatureLocationType.iterator();iter.hasNext();){
							EntityFeatureListener listener=(EntityFeatureListener)iter.next();
							listener.featureLocationTypeRemoved(fr.curie.BiNoM.pathways.biopax.EntityFeatureImpl.this,_featureLocationType);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(evidenceProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForEvidence.iterator();iter.hasNext();){
							EntityFeatureListener listener=(EntityFeatureListener)iter.next();
							listener.evidenceRemoved(fr.curie.BiNoM.pathways.biopax.EntityFeatureImpl.this,_evidence);
						}
					}
				}
				return;
