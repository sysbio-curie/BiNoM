...
/**
 * Implementation of {@link fr.curie.BiNoM.pathways.biopax.CovalentBindingFeature}
 ...
 * <br>
 */
public class CovalentBindingFeatureImpl extends com.ibm.adtech.jastor.ThingImpl implements fr.curie.BiNoM.pathways.biopax.CovalentBindingFeature {
	...
	private static com.hp.hpl.jena.rdf.model.Property intraMolecularProperty = ResourceFactory.createProperty("http://www.biopax.org/release/biopax-level3.owl#intraMolecular");
	private java.lang.Boolean intraMolecular;
	private static com.hp.hpl.jena.rdf.model.Property bindsToProperty = ResourceFactory.createProperty("http://www.biopax.org/release/biopax-level3.owl#bindsTo");
	private fr.curie.BiNoM.pathways.biopax.BindingFeature bindsTo;
	...
	CovalentBindingFeatureImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static CovalentBindingFeatureImpl getCovalentBindingFeature(Resource resource, Model model) throws JastorException {
		return new CovalentBindingFeatureImpl(resource, model);
	}
	    
	static CovalentBindingFeatureImpl createCovalentBindingFeature(Resource resource, Model model) throws JastorException {
		CovalentBindingFeatureImpl impl = new CovalentBindingFeatureImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, CovalentBindingFeature.TYPE)))
			impl._model.add(impl._resource, RDF.type, CovalentBindingFeature.TYPE);
		impl.addSuperTypes();
	...
	void addSuperTypes() {
		...
		if (!_model.contains(_resource, RDF.type, fr.curie.BiNoM.pathways.biopax.BindingFeature.TYPE))
			_model.add(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(_resource, RDF.type, fr.curie.BiNoM.pathways.biopax.BindingFeature.TYPE));     
		if (!_model.contains(_resource, RDF.type, fr.curie.BiNoM.pathways.biopax.ModificationFeature.TYPE))
			_model.add(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(_resource, RDF.type, fr.curie.BiNoM.pathways.biopax.ModificationFeature.TYPE));     
	}
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,intraMolecularProperty,(RDFNode)null);
		while (it.hasNext()) {
			list.add(it.next());
		}
		it = _model.listStatements(_resource,bindsToProperty,(RDFNode)null);
		while (it.hasNext()) {
			list.add(it.next());
		}
		...
		it = _model.listStatements(_resource,RDF.type, fr.curie.BiNoM.pathways.biopax.CovalentBindingFeature.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
		...
		it = _model.listStatements(_resource,RDF.type, fr.curie.BiNoM.pathways.biopax.BindingFeature.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	private void initComment() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#comment properties in CovalentBindingFeature model not a Literal", stmt.getObject());
	...
	private void initMemberFeature() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#memberFeature properties in CovalentBindingFeature model not a Resource", stmt.getObject());
	...
	private void initFeatureLocation() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#featureLocation properties in CovalentBindingFeature model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initFeatureLocationType() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#featureLocationType properties in CovalentBindingFeature model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initEvidence() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#evidence properties in CovalentBindingFeature model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public java.lang.Boolean getIntraMolecular() throws JastorException {
		if (intraMolecular != null)
			return intraMolecular;
		com.hp.hpl.jena.rdf.model.Statement stmt = _model.getProperty(_resource, intraMolecularProperty);
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": intraMolecular getProperty() in fr.curie.BiNoM.pathways.biopax.CovalentBindingFeature model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
		Object obj = Util.fixLiteral(literal.getValue(),"java.lang.Boolean");
		intraMolecular = (java.lang.Boolean)obj;
		return intraMolecular;
	}
	
	public void setIntraMolecular(java.lang.Boolean intraMolecular) throws JastorException {
		if (_model.contains(_resource,intraMolecularProperty)) {
			_model.removeAll(_resource,intraMolecularProperty,null);
		}
		this.intraMolecular = intraMolecular;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
		if (intraMolecular != null) {
			_model.add(_model.createStatement(_resource,intraMolecularProperty, _model.createTypedLiteral(intraMolecular)));
		}	
	}


	public fr.curie.BiNoM.pathways.biopax.BindingFeature getBindsTo() throws JastorException {
		if (bindsTo != null)
			return bindsTo;
		com.hp.hpl.jena.rdf.model.Statement stmt = _model.getProperty(_resource, bindsToProperty);
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": bindsTo getProperty() in fr.curie.BiNoM.pathways.biopax.CovalentBindingFeature model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
		bindsTo = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getBindingFeature(resource,_model);
		return bindsTo;
	}

	public void setBindsTo(fr.curie.BiNoM.pathways.biopax.BindingFeature bindsTo) throws JastorException {
		if (_model.contains(_resource,bindsToProperty)) {
			_model.removeAll(_resource,bindsToProperty,null);
		}
		this.bindsTo = bindsTo;
		if (bindsTo != null) {
			_model.add(_model.createStatement(_resource,bindsToProperty, bindsTo.resource()));
		}			
	}
		
	public fr.curie.BiNoM.pathways.biopax.BindingFeature setBindsTo() throws JastorException {
		if (_model.contains(_resource,bindsToProperty)) {
			_model.removeAll(_resource,bindsToProperty,null);
		}
		fr.curie.BiNoM.pathways.biopax.BindingFeature bindsTo = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.createBindingFeature(_model.createResource(),_model);
		this.bindsTo = bindsTo;
		_model.add(_model.createStatement(_resource,bindsToProperty, bindsTo.resource()));
		return bindsTo;
	}
	
	public fr.curie.BiNoM.pathways.biopax.BindingFeature setBindsTo(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		if (_model.contains(_resource,bindsToProperty)) {
			_model.removeAll(_resource,bindsToProperty,null);
		}
		fr.curie.BiNoM.pathways.biopax.BindingFeature bindsTo = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getBindingFeature(resource,_model);
		this.bindsTo = bindsTo;
		_model.add(_model.createStatement(_resource,bindsToProperty, bindsTo.resource()));
		return bindsTo;
	}
	...
	public fr.curie.BiNoM.pathways.biopax.SequenceModificationVocabulary getModificationType() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": modificationType getProperty() in fr.curie.BiNoM.pathways.biopax.CovalentBindingFeature model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof CovalentBindingFeatureListener))
			throw new IllegalArgumentException("ThingListener must be instance of CovalentBindingFeatureListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((CovalentBindingFeatureListener)listener);
		}
	}
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
			...
			if (stmt.getPredicate().equals(commentProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForComment.iterator();iter.hasNext();){
						CovalentBindingFeatureListener listener=(CovalentBindingFeatureListener)iter.next();
						listener.commentAdded(fr.curie.BiNoM.pathways.biopax.CovalentBindingFeatureImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMemberFeature.iterator();iter.hasNext();){
							CovalentBindingFeatureListener listener=(CovalentBindingFeatureListener)iter.next();
							listener.memberFeatureAdded(fr.curie.BiNoM.pathways.biopax.CovalentBindingFeatureImpl.this,_memberFeature);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeatureLocation.iterator();iter.hasNext();){
							CovalentBindingFeatureListener listener=(CovalentBindingFeatureListener)iter.next();
							listener.featureLocationAdded(fr.curie.BiNoM.pathways.biopax.CovalentBindingFeatureImpl.this,_featureLocation);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeatureLocationType.iterator();iter.hasNext();){
							CovalentBindingFeatureListener listener=(CovalentBindingFeatureListener)iter.next();
							listener.featureLocationTypeAdded(fr.curie.BiNoM.pathways.biopax.CovalentBindingFeatureImpl.this,_featureLocationType);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForEvidence.iterator();iter.hasNext();){
							CovalentBindingFeatureListener listener=(CovalentBindingFeatureListener)iter.next();
							listener.evidenceAdded(fr.curie.BiNoM.pathways.biopax.CovalentBindingFeatureImpl.this,_evidence);
						}
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(intraMolecularProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
					return;
				com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
				intraMolecular = (java.lang.Boolean)Util.fixLiteral(literal.getValue(),"java.lang.Boolean");
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CovalentBindingFeatureListener listener=(CovalentBindingFeatureListener)iter.next();
						listener.intraMolecularChanged(fr.curie.BiNoM.pathways.biopax.CovalentBindingFeatureImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(bindsToProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
					return;
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				bindsTo = null;
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CovalentBindingFeatureListener listener=(CovalentBindingFeatureListener)iter.next();
						listener.bindsToChanged(fr.curie.BiNoM.pathways.biopax.CovalentBindingFeatureImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(modificationTypeProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CovalentBindingFeatureListener listener=(CovalentBindingFeatureListener)iter.next();
						listener.modificationTypeChanged(fr.curie.BiNoM.pathways.biopax.CovalentBindingFeatureImpl.this);
					}
				}
				return;
			}
...
//				return;
			if (stmt.getPredicate().equals(commentProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CovalentBindingFeatureListener listener=(CovalentBindingFeatureListener)iter.next();
						listener.commentRemoved(fr.curie.BiNoM.pathways.biopax.CovalentBindingFeatureImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(memberFeatureProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMemberFeature.iterator();iter.hasNext();){
							CovalentBindingFeatureListener listener=(CovalentBindingFeatureListener)iter.next();
							listener.memberFeatureRemoved(fr.curie.BiNoM.pathways.biopax.CovalentBindingFeatureImpl.this,_memberFeature);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(featureLocationProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeatureLocation.iterator();iter.hasNext();){
							CovalentBindingFeatureListener listener=(CovalentBindingFeatureListener)iter.next();
							listener.featureLocationRemoved(fr.curie.BiNoM.pathways.biopax.CovalentBindingFeatureImpl.this,_featureLocation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(featureLocationTypeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeatureLocationType.iterator();iter.hasNext();){
							CovalentBindingFeatureListener listener=(CovalentBindingFeatureListener)iter.next();
							listener.featureLocationTypeRemoved(fr.curie.BiNoM.pathways.biopax.CovalentBindingFeatureImpl.this,_featureLocationType);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(evidenceProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForEvidence.iterator();iter.hasNext();){
							CovalentBindingFeatureListener listener=(CovalentBindingFeatureListener)iter.next();
							listener.evidenceRemoved(fr.curie.BiNoM.pathways.biopax.CovalentBindingFeatureImpl.this,_evidence);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(intraMolecularProperty)) {
				...
				//Object obj = literal.getValue();
				Object obj = Util.fixLiteral(literal.getValue(),"java.lang.Boolean");
				if (intraMolecular != null && intraMolecular.equals(obj))
					intraMolecular = null;
				if (listeners != null) {
					java.util.ArrayList consumers;
					synchronized (listeners) {
			...
			if (stmt.getPredicate().equals(bindsToProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
					return;
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
					if (bindsTo != null && bindsTo.resource().equals(resource))
						bindsTo = null;				
				if (listeners != null) {
					java.util.ArrayList consumers;
					synchronized (listeners) {
