...
/**
 * Implementation of {@link fr.curie.BiNoM.pathways.biopax.DnaRegionReference}
 * Use the fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory to create instances of this class.
 * <p>(URI: http://www.biopax.org/release/biopax-level3.owl#DnaRegionReference)</p>
 * <br>
 */
public class DnaRegionReferenceImpl extends com.ibm.adtech.jastor.ThingImpl implements fr.curie.BiNoM.pathways.biopax.DnaRegionReference {
	...
	private static com.hp.hpl.jena.rdf.model.Property regionTypeProperty = ResourceFactory.createProperty("http://www.biopax.org/release/biopax-level3.owl#regionType");
	private fr.curie.BiNoM.pathways.biopax.SequenceRegionVocabulary regionType;
	...
	private static com.hp.hpl.jena.rdf.model.Property absoluteRegionProperty = ResourceFactory.createProperty("http://www.biopax.org/release/biopax-level3.owl#absoluteRegion");
	private fr.curie.BiNoM.pathways.biopax.SequenceLocation absoluteRegion;

	DnaRegionReferenceImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static DnaRegionReferenceImpl getDnaRegionReference(Resource resource, Model model) throws JastorException {
		return new DnaRegionReferenceImpl(resource, model);
	}
	    
	static DnaRegionReferenceImpl createDnaRegionReference(Resource resource, Model model) throws JastorException {
		DnaRegionReferenceImpl impl = new DnaRegionReferenceImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, DnaRegionReference.TYPE)))
			impl._model.add(impl._resource, RDF.type, DnaRegionReference.TYPE);
		impl.addSuperTypes();
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,regionTypeProperty,(RDFNode)null);
		while (it.hasNext()) {
			list.add(it.next());
		}
		...
		it = _model.listStatements(_resource,absoluteRegionProperty,(RDFNode)null);
		while (it.hasNext()) {
			list.add(it.next());
		}
		it = _model.listStatements(_resource,RDF.type, fr.curie.BiNoM.pathways.biopax.DnaRegionReference.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	private void initComment() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#comment properties in DnaRegionReference model not a Literal", stmt.getObject());
	...
	private void initMemberEntityReference() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#memberEntityReference properties in DnaRegionReference model not a Resource", stmt.getObject());
	...
	public fr.curie.BiNoM.pathways.biopax.EntityReferenceTypeVocabulary getEntityReferenceType() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": entityReferenceType getProperty() in fr.curie.BiNoM.pathways.biopax.DnaRegionReference model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	private void initEntityFeature() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#entityFeature properties in DnaRegionReference model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initName() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#name properties in DnaRegionReference model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initEvidence() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#evidence properties in DnaRegionReference model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initXref() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#xref properties in DnaRegionReference model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public java.lang.String getSequence() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": sequence getProperty() in fr.curie.BiNoM.pathways.biopax.DnaRegionReference model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initSubRegion_asDnaRegionReference() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#subRegion properties in DnaRegionReference model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	public fr.curie.BiNoM.pathways.biopax.SequenceRegionVocabulary getRegionType() throws JastorException {
		if (regionType != null)
			return regionType;
		com.hp.hpl.jena.rdf.model.Statement stmt = _model.getProperty(_resource, regionTypeProperty);
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": regionType getProperty() in fr.curie.BiNoM.pathways.biopax.DnaRegionReference model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
		regionType = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getSequenceRegionVocabulary(resource,_model);
		return regionType;
	}

	public void setRegionType(fr.curie.BiNoM.pathways.biopax.SequenceRegionVocabulary regionType) throws JastorException {
		if (_model.contains(_resource,regionTypeProperty)) {
			_model.removeAll(_resource,regionTypeProperty,null);
		}
		this.regionType = regionType;
		if (regionType != null) {
			_model.add(_model.createStatement(_resource,regionTypeProperty, regionType.resource()));
		}			
	}
		
	public fr.curie.BiNoM.pathways.biopax.SequenceRegionVocabulary setRegionType() throws JastorException {
		if (_model.contains(_resource,regionTypeProperty)) {
			_model.removeAll(_resource,regionTypeProperty,null);
		}
		fr.curie.BiNoM.pathways.biopax.SequenceRegionVocabulary regionType = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.createSequenceRegionVocabulary(_model.createResource(),_model);
		this.regionType = regionType;
		_model.add(_model.createStatement(_resource,regionTypeProperty, regionType.resource()));
		return regionType;
	}
	
	public fr.curie.BiNoM.pathways.biopax.SequenceRegionVocabulary setRegionType(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		if (_model.contains(_resource,regionTypeProperty)) {
			_model.removeAll(_resource,regionTypeProperty,null);
		}
		fr.curie.BiNoM.pathways.biopax.SequenceRegionVocabulary regionType = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getSequenceRegionVocabulary(resource,_model);
		this.regionType = regionType;
		_model.add(_model.createStatement(_resource,regionTypeProperty, regionType.resource()));
		return regionType;
	}
	...
	public fr.curie.BiNoM.pathways.biopax.BioSource getOrganism() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": organism getProperty() in fr.curie.BiNoM.pathways.biopax.DnaRegionReference model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	public fr.curie.BiNoM.pathways.biopax.SequenceLocation getAbsoluteRegion() throws JastorException {
		if (absoluteRegion != null)
			return absoluteRegion;
		com.hp.hpl.jena.rdf.model.Statement stmt = _model.getProperty(_resource, absoluteRegionProperty);
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": absoluteRegion getProperty() in fr.curie.BiNoM.pathways.biopax.DnaRegionReference model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
		absoluteRegion = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getSequenceLocation(resource,_model);
		return absoluteRegion;
	}

	public void setAbsoluteRegion(fr.curie.BiNoM.pathways.biopax.SequenceLocation absoluteRegion) throws JastorException {
		if (_model.contains(_resource,absoluteRegionProperty)) {
			_model.removeAll(_resource,absoluteRegionProperty,null);
		}
		this.absoluteRegion = absoluteRegion;
		if (absoluteRegion != null) {
			_model.add(_model.createStatement(_resource,absoluteRegionProperty, absoluteRegion.resource()));
		}			
	}
		
	public fr.curie.BiNoM.pathways.biopax.SequenceLocation setAbsoluteRegion() throws JastorException {
		if (_model.contains(_resource,absoluteRegionProperty)) {
			_model.removeAll(_resource,absoluteRegionProperty,null);
		}
		fr.curie.BiNoM.pathways.biopax.SequenceLocation absoluteRegion = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.createSequenceLocation(_model.createResource(),_model);
		this.absoluteRegion = absoluteRegion;
		_model.add(_model.createStatement(_resource,absoluteRegionProperty, absoluteRegion.resource()));
		return absoluteRegion;
	}
	
	public fr.curie.BiNoM.pathways.biopax.SequenceLocation setAbsoluteRegion(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		if (_model.contains(_resource,absoluteRegionProperty)) {
			_model.removeAll(_resource,absoluteRegionProperty,null);
		}
		fr.curie.BiNoM.pathways.biopax.SequenceLocation absoluteRegion = fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory.getSequenceLocation(resource,_model);
		this.absoluteRegion = absoluteRegion;
		_model.add(_model.createStatement(_resource,absoluteRegionProperty, absoluteRegion.resource()));
		return absoluteRegion;
	}
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof DnaRegionReferenceListener))
			throw new IllegalArgumentException("ThingListener must be instance of DnaRegionReferenceListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((DnaRegionReferenceListener)listener);
		}
	}
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
			...
			if (stmt.getPredicate().equals(commentProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForComment.iterator();iter.hasNext();){
						DnaRegionReferenceListener listener=(DnaRegionReferenceListener)iter.next();
						listener.commentAdded(fr.curie.BiNoM.pathways.biopax.DnaRegionReferenceImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMemberEntityReference.iterator();iter.hasNext();){
							DnaRegionReferenceListener listener=(DnaRegionReferenceListener)iter.next();
							listener.memberEntityReferenceAdded(fr.curie.BiNoM.pathways.biopax.DnaRegionReferenceImpl.this,_memberEntityReference);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(entityReferenceTypeProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DnaRegionReferenceListener listener=(DnaRegionReferenceListener)iter.next();
						listener.entityReferenceTypeChanged(fr.curie.BiNoM.pathways.biopax.DnaRegionReferenceImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForEntityFeature.iterator();iter.hasNext();){
							DnaRegionReferenceListener listener=(DnaRegionReferenceListener)iter.next();
							listener.entityFeatureAdded(fr.curie.BiNoM.pathways.biopax.DnaRegionReferenceImpl.this,_entityFeature);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						DnaRegionReferenceListener listener=(DnaRegionReferenceListener)iter.next();
						listener.nameAdded(fr.curie.BiNoM.pathways.biopax.DnaRegionReferenceImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForEvidence.iterator();iter.hasNext();){
							DnaRegionReferenceListener listener=(DnaRegionReferenceListener)iter.next();
							listener.evidenceAdded(fr.curie.BiNoM.pathways.biopax.DnaRegionReferenceImpl.this,_evidence);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForXref.iterator();iter.hasNext();){
							DnaRegionReferenceListener listener=(DnaRegionReferenceListener)iter.next();
							listener.xrefAdded(fr.curie.BiNoM.pathways.biopax.DnaRegionReferenceImpl.this,_xref);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(sequenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DnaRegionReferenceListener listener=(DnaRegionReferenceListener)iter.next();
						listener.sequenceChanged(fr.curie.BiNoM.pathways.biopax.DnaRegionReferenceImpl.this);
					}
				}
				return;
			}
				...
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.DnaRegionReference.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubRegion_asDnaRegionReference.iterator();iter.hasNext();){
							DnaRegionReferenceListener listener=(DnaRegionReferenceListener)iter.next();
							listener.subRegionAdded(fr.curie.BiNoM.pathways.biopax.DnaRegionReferenceImpl.this,_subRegion_asDnaRegionReference);
						}
					}
				}
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.RnaRegionReference.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubRegion_asRnaRegionReference.iterator();iter.hasNext();){
							DnaRegionReferenceListener listener=(DnaRegionReferenceListener)iter.next();
							listener.subRegionAdded(fr.curie.BiNoM.pathways.biopax.DnaRegionReferenceImpl.this,_subRegion_asRnaRegionReference);
						}
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(regionTypeProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
					return;
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				regionType = null;
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DnaRegionReferenceListener listener=(DnaRegionReferenceListener)iter.next();
						listener.regionTypeChanged(fr.curie.BiNoM.pathways.biopax.DnaRegionReferenceImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(organismProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DnaRegionReferenceListener listener=(DnaRegionReferenceListener)iter.next();
						listener.organismChanged(fr.curie.BiNoM.pathways.biopax.DnaRegionReferenceImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(absoluteRegionProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
					return;
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				absoluteRegion = null;
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DnaRegionReferenceListener listener=(DnaRegionReferenceListener)iter.next();
						listener.absoluteRegionChanged(fr.curie.BiNoM.pathways.biopax.DnaRegionReferenceImpl.this);
					}
				}
				return;
			}
...
//				return;
			if (stmt.getPredicate().equals(commentProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DnaRegionReferenceListener listener=(DnaRegionReferenceListener)iter.next();
						listener.commentRemoved(fr.curie.BiNoM.pathways.biopax.DnaRegionReferenceImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(memberEntityReferenceProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMemberEntityReference.iterator();iter.hasNext();){
							DnaRegionReferenceListener listener=(DnaRegionReferenceListener)iter.next();
							listener.memberEntityReferenceRemoved(fr.curie.BiNoM.pathways.biopax.DnaRegionReferenceImpl.this,_memberEntityReference);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(entityFeatureProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForEntityFeature.iterator();iter.hasNext();){
							DnaRegionReferenceListener listener=(DnaRegionReferenceListener)iter.next();
							listener.entityFeatureRemoved(fr.curie.BiNoM.pathways.biopax.DnaRegionReferenceImpl.this,_entityFeature);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DnaRegionReferenceListener listener=(DnaRegionReferenceListener)iter.next();
						listener.nameRemoved(fr.curie.BiNoM.pathways.biopax.DnaRegionReferenceImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(evidenceProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForEvidence.iterator();iter.hasNext();){
							DnaRegionReferenceListener listener=(DnaRegionReferenceListener)iter.next();
							listener.evidenceRemoved(fr.curie.BiNoM.pathways.biopax.DnaRegionReferenceImpl.this,_evidence);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(xrefProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForXref.iterator();iter.hasNext();){
							DnaRegionReferenceListener listener=(DnaRegionReferenceListener)iter.next();
							listener.xrefRemoved(fr.curie.BiNoM.pathways.biopax.DnaRegionReferenceImpl.this,_xref);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(subRegionProperty)) {
				...
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.DnaRegionReference.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubRegion_asDnaRegionReference.iterator();iter.hasNext();){
							DnaRegionReferenceListener listener=(DnaRegionReferenceListener)iter.next();
							listener.subRegionRemoved(fr.curie.BiNoM.pathways.biopax.DnaRegionReferenceImpl.this,_subRegion_asDnaRegionReference);
						}
					}
				}
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.RnaRegionReference.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubRegion_asRnaRegionReference.iterator();iter.hasNext();){
							DnaRegionReferenceListener listener=(DnaRegionReferenceListener)iter.next();
							listener.subRegionRemoved(fr.curie.BiNoM.pathways.biopax.DnaRegionReferenceImpl.this,_subRegion_asRnaRegionReference);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(regionTypeProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
					return;
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
					if (regionType != null && regionType.resource().equals(resource))
						regionType = null;				
				if (listeners != null) {
					java.util.ArrayList consumers;
					synchronized (listeners) {
			...
			if (stmt.getPredicate().equals(absoluteRegionProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
					return;
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
					if (absoluteRegion != null && absoluteRegion.resource().equals(resource))
						absoluteRegion = null;				
				if (listeners != null) {
					java.util.ArrayList consumers;
					synchronized (listeners) {
