...
public class ModularViewTaskFactory implements AbstractModularViewTaskFactory {
    ...
    ModularViewTaskFactory(PluginModel model, CellDesignerPlugin plugin) {
	this.model = model;
	this.plugin = plugin;
    }

    public AbstractTask createTask(int idxAdd, int idxs[], boolean showIntersection, boolean nodeIntersectionView) {

	return new ModularViewTask(model, plugin, idxAdd, idxs, showIntersection, nodeIntersectionView);
    }
}
