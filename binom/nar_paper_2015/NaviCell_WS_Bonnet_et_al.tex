...
\\
Map: simple zooming & $\bullet$ & & & & &
\\
Map: semantic zooming & $\bullet$ & & & & &
\\
Visualization: node coloring & $\bullet$ & & & & &
\\
Visualization: heatmaps & $\bullet$ & & & & &
\\
Visualization: barplots & $\bullet$ & & & & &
\\
Visualization: glyphs & $\bullet$ & & & & &
\\
Visualization: map staining & $\bullet$ & & & & &
\\
Data mapping: gene lists& $\bullet$ & & & & &
\\
Data mapping: expression data& $\bullet$ & & & & &
\\
...
\\
Programmatic access: RESTful web & $\bullet$ & & & & &
\\
