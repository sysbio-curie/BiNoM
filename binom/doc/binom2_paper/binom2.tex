...
\begin{figure}[h]
 \caption{\label{6biopax3_examples}  \textbf{Visualization of the 6 BioPAX examples, provided in BioPAX 3.0 documentation.} 
BioPAX 3.0 documentation available at http://biopax.org contains 6 simple examples of using BioPAX 3.0 to describe
different aspects of functioning of biological networks. Here we show how BiNoM visualizes these examples
in one of the standard representations (Reaction Network, Pathway Structure, Interaction Map). The graphical node and edge semantics 
