...
public class BiNoMPlugin extends CytoscapePlugin {
	...
	plugInMenu.add(binomIOMenu);
	    ...
	    ("Import BioPAX Document from URL...");
        binomIOMenu.add(menuItem);
        ...
        exportBioPAXMenuItem = new JMenuItem("Export current network to BioPAX...");
        ...
        associateBioPAXMenuItem = new JMenuItem("Associate BioPAX Source...");
        binomIOMenu.add(associateBioPAXMenuItem);
        associateBioPAXMenuItem.addActionListener(BioPAXAssociateSource.getInstance());

        saveBioPAXMenuItem = new JMenuItem("Save whole associated BioPAX as...");
	...
	JMenu binomBioPAXUtilsMenu = new JMenu("BiNoM BioPAX Utils");
        plugInMenu.add(binomBioPAXUtilsMenu);

        menuItem = new JMenuItem
	    ("BioPAX Property Editor...");
        ...
        syncBioPAXMenuItem = new JMenuItem("Synchronize networks with BioPAX...");
	...
	JMenu binomBioPAXQueryMenu = new JMenu("BiNoM BioPAX Query ");
