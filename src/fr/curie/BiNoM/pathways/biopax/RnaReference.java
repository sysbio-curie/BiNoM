...
/**
 * Interface for RnaReference ontology class<br>
 * Use the fr.curie.BiNoM.pathways.biopax.biopax_DASH_level3_DOT_owlFactory to create instances of this interface.
 * <p>(URI: http://www.biopax.org/release/biopax-level3.owl#RnaReference)</p>
 * <br>
 * RDF Schema Standard Properties <br>
 * 	comment : Defintion: A RNA  reference is a grouping of several RNA entities that are either encoded by the same gene or replicates of the same genome.  Members can differ in celular location, sequence features and bound partners. Currently conformational states (such as hairpin) are not covered.^^http://www.w3.org/2001/XMLSchema#string <br>
 * <br>
 * <br>
 */
public interface RnaReference extends fr.curie.BiNoM.pathways.biopax.EntityReference, com.ibm.adtech.jastor.Thing {
	
	/**
	 * The rdf:type for this ontology class
     */
	public static final Resource TYPE = ResourceFactory.createResource("http://www.biopax.org/release/biopax-level3.owl#RnaReference");
	 ...
	 * @return		{@link java.util.Iterator} of {@link fr.curie.BiNoM.pathways.biopax.RnaReference}
	 * @see			#memberEntityReferenceProperty
	 */
	public java.util.Iterator getMemberEntityReference_asRnaReference() throws com.ibm.adtech.jastor.JastorException;

	/**
	 * Adds a value for the 'memberEntityReference' property
	 * @param		The {@link fr.curie.BiNoM.pathways.biopax.RnaReference} to add
	 * @see			#memberEntityReferenceProperty
	 */
	public void addMemberEntityReference(fr.curie.BiNoM.pathways.biopax.RnaReference memberEntityReference) throws com.ibm.adtech.jastor.JastorException;
	
	/**
	 * Adds an anonymous value for the 'memberEntityReference' property
	 * @return		The anoymous {@link fr.curie.BiNoM.pathways.biopax.RnaReference} created
	 * @see			#memberEntityReferenceProperty
	 */
	public fr.curie.BiNoM.pathways.biopax.RnaReference addMemberEntityReference_asRnaReference() throws com.ibm.adtech.jastor.JastorException;
	 ...
	 * @see			#memberEntityReferenceProperty
	 */
	public fr.curie.BiNoM.pathways.biopax.RnaReference addMemberEntityReference_asRnaReference(com.hp.hpl.jena.rdf.model.Resource resource) throws com.ibm.adtech.jastor.JastorException;
	
	/**
	 * Removes a value for the 'memberEntityReference' property.  This method should not
	 * be invoked while iterator through values.  In that case, the remove() method of the Iterator
	 * itself should be used.
	 * @param		The {@link fr.curie.BiNoM.pathways.biopax.RnaReference} to remove
	 * @see			#memberEntityReferenceProperty
	 */
	public void removeMemberEntityReference(fr.curie.BiNoM.pathways.biopax.RnaReference memberEntityReference) throws com.ibm.adtech.jastor.JastorException;
