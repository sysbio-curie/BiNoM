...
provides
 functions for the import-export of some standard systems biology
file formats (import from CellDesigner, BioPAX Level 3 and CSML; export to SBML, CellDesigner and BioPAX Level 3), and a set of algorithms to analyze and
reduce the complexity
of biological networks. BiNoM can be used to import and analyze files
...
whole pathway databases (e.g. human Reactome). BiNoM also implements a collection of powerful
...
by a layout specific to the software.  There is obviously
...
morris2011clustermaker, rivera2010nemo}. However, we think that the stength of
...
%source and the target node (see a summary of the input data types for the PIQuant score in table 2).
...
%a relative quantitative difference. 
...
This map contains a lot of valuable information but this one is rather difficult to extract. We present two
...
each protein is involved (decomposition in material components). The 29 networks that are created this way may share a
...
to a given path length, in order to limit the size of the results and computation time.   \par \mbox{}
    \par
    \mbox{
      \begin{tabular}{|c|c|c|}
        %\hline \multicolumn{3}{|c|}{My Table}\\ \hline
        \hline
	\textbf{Algorithms} & \textbf{Directed paths search} &  \textbf{Finite radius} \\ \hline
        Shortest paths (Dijkstra's algorithm) & o & o \\ \hline
        Optimal and suboptimal shortest paths & o & o  \\ \hline
        All non self-intersecting paths & o  & o  \\ \hline
      \end{tabular}
      }

  \subsection*{Table 2 - PIQuant score input data.}
    Input data types description for the calculation of the PIQuant score.   \par \mbox{}
    \par
    \mbox{
      \begin{tabular}{|c|c|}
        \hline
...
ratio or a t-test statistic value.\null}  \\ \hline
  ...
  \subsection*{Table 3 - Detailed import/export BiNoM capabilities for standard systems biology file formats.}
    
   The table is indicating the different standard systems biology file formats and versions that can be imported/exported in BiNoM, as well as what type of conversions are possible.    \par \mbox{}
    \par
    \mbox{
      \begin{tabular}{|l|}
        %\hline \multicolumn{3}{|c|}{My Table}\\ \hline
        \hline
	\textbf{Import from} \\ \hline
        CellDesigner v3.x, 4.1, 4.2 \\ \hline
        BioPAX Level 3  \\ \hline
        SBML Level 2 \\ \hline
        CSML v3.0  \\ \hline\hline
        \textbf{Export (from / to)} \\ \hline
        BioPAX Level 3 / BioPAX Level 3 \\ \hline
        BioPAX Level 3 / SBML Level 2 \\ \hline
        CellDesigner v3.x, 4.1, 4.2 / CellDesigner v4.1 \\ \hline
        CellDesigner v3.x, 4.1, 4.2 / BioPAX Level 3 \\ \hline
        CellDesigner v3.x, 4.1, 4.2 / SBML Level 2 \\ \hline
        CSML v3.0 / SBML Level 2 \\ \hline
      \end{tabular}
      }

  \subsection*{Table 4 - Comparison of BiNoM functionalities with other software tools.}
...
\begin{tabular}{|l|c|c|c|c|c|c|c|c|c|c|c|c|c|}
        ...
        \hline
	\textbf{Function}      & \textbf{BiNoM} & \textbf{CellDesigner} & \textbf{BioPAX2SBML} & \textbf{SyBiL} & \textbf{SBFC} & \textbf{biographer} & \textbf{cySBML} & \textbf{ShortestPath} & \textbf{Glay} & \textbf{MCode} & \textbf{Moduland} & \textbf{clusterMaker} & \textbf{NeMo}\\ \hline
        Standalone application & $\circ$        & $\bullet$ & $\bullet$ & $\bullet$      & $\bullet$     & $\bullet$           & $\circ$       & $\circ$               &  $\circ$      &  $\circ$       &  $\circ$          & $\circ$               &  $\circ$      \\ \hline
        Cytoscape plugin       & $\bullet$      &$\circ$&$\circ$& $\circ$        & $\circ$       & $\circ$             & $\bullet$     & $\bullet$             &  $\bullet$    &  $\bullet$     &  $\bullet$         & $\bullet$            &  $\bullet$      \\ \hline
        BioPAX import          & $\bullet$      & $\bullet$ & $\bullet$ & $\bullet$      & $\bullet$     & $\circ$             & $\circ$       & $\circ$               &  $\circ$      &  $\circ$       &  $\circ$           & $\circ$            &  $\circ$      \\ \hline
        BioPAX visualization   & $\bullet$      & $\bullet$ & $\circ$ & $\bullet$      & $\circ$       & $\circ$             & $\circ$       & $\circ$               &  $\circ$      &  $\circ$       &  $\circ$           & $\circ$            &  $\circ$      \\ \hline
        BioPAX properties editor & $\bullet$   & $\circ$ & $\circ$ & $\circ$      & $\circ$       & $\circ$             & $\circ$       & $\circ$               &  $\circ$      &  $\circ$       &  $\circ$           & $\circ$            &  $\circ$      \\ \hline
        BioPAX queries          & $\bullet$    & $\circ$ & $\circ$& $\circ$      & $\circ$       & $\circ$             & $\circ$       & $\circ$               &  $\circ$      &  $\circ$       &  $\circ$           & $\circ$            &  $\circ$      \\ \hline
        BioPAX export          & $\bullet$      & $\circ$ & $\circ$& $\bullet$      & $\bullet$     & $\circ$             & $\circ$       & $\circ$               &  $\circ$      &  $\circ$       &  $\circ$           & $\circ$            &  $\circ$      \\ \hline
        SBML import            & $\bullet$      & $\bullet$ & $\circ$& $\bullet$      & $\bullet$     & $\bullet$           & $\bullet$     & $\circ$               &  $\circ$      &  $\circ$       &  $\circ$           & $\circ$            &  $\circ$      \\ \hline
        SBML visualization     & $\bullet$      & $\bullet$ & $\circ$& $\bullet$      & $\circ$       & $\bullet$           & $\bullet$     & $\circ$               &  $\circ$      &  $\circ$       &  $\circ$           & $\circ$            &  $\circ$      \\ \hline
        SBML validation        & $\circ$      & $\circ$ & $\circ$& $\circ$      & $\bullet$     & $\circ$           & $\bullet$     & $\circ$               &  $\circ$      &  $\circ$       &  $\circ$           & $\circ$            &  $\circ$      \\ \hline
        SBML layout and & & & & & & & & & & & & &
         \\qualitative support & $\circ$     & $\circ$ & $\bullet$ & $\circ$      & $\circ$       & $\circ$           & $\bullet$     & $\circ$               &  $\circ$      &  $\circ$       &  $\circ$           & $\circ$            &  $\circ$      \\ \hline
        CellDesigner import, & & & & & & & & & & & & &
         \\visualization and export & $\bullet$      &$\bullet$&$\circ$& $\circ$      & $\circ$       & $\circ$     & $\circ$     & $\circ$               &  $\circ$      &  $\circ$       &  $\circ$           & $\circ$            &  $\circ$      \\ \hline
        CSML import            & $\bullet$      &$\circ$&$\circ$& $\circ$      & $\circ$       & $\circ$           & $\circ$     & $\circ$               &  $\circ$      &  $\circ$       &  $\circ$           & $\circ$            &  $\circ$      \\ \hline
        CSML visualization     & $\bullet$      &$\circ$&$\circ$& $\circ$      & $\circ$       & $\circ$           & $\circ$     & $\circ$               &  $\circ$      &  $\circ$       &  $\circ$           & $\circ$            &  $\circ$      \\ \hline
        Cytoscape extra & & & & & & & & & & &
                   \\utilities & $\bullet$      &$\circ$&$\circ$& $\circ$      & $\circ$       & $\circ$           & $\circ$     & $\circ$               &  $\circ$      &  $\circ$       &  $\circ$           & $\circ$            &  $\circ$      \\ \hline
        Get connected  & & & & & & & & & & & & & 
            \\network components & $\bullet$ &$\circ$&$\circ$& $\circ$      & $\circ$       & $\circ$           & $\circ$     & $\circ$               &  $\circ$      &  $\bullet$       &  $\circ$           & $\bullet$            &  $\bullet$      \\ \hline
        Semantic clustering  & $\bullet$      &$\circ$&$\circ$& $\circ$      & $\circ$       & $\circ$           & $\circ$     & $\circ$               &  $\circ$      &  $\circ$       &  $\circ$           & $\circ$            &  $\circ$      \\ \hline
        Community structure  & & & & & & & & & & & & &
                \\clustering  & $\circ$      &$\circ$&$\circ$& $\circ$      & $\circ$       & $\circ$           & $\circ$     & $\circ$               &  $\bullet$      &  $\circ$       &  $\circ$           & $\circ$            &  $\circ$      \\ \hline
        Hierarchical modules  & & & & & & & & & & & & &
                \\clustering  & $\circ$      &$\circ$&$\circ$& $\circ$      & $\circ$       & $\circ$           & $\circ$     & $\circ$               &  $\circ$      &  $\circ$       &  $\bullet$           & $\circ$            &  $\circ$      \\ \hline
        Multiple standard  & & & & & & & & & & & & &
                \\clustering methods & $\circ$      &$\circ$&$\circ$& $\circ$      & $\circ$       & $\circ$           & $\circ$     & $\circ$               &  $\circ$      &  $\circ$       &  $\circ$           & $\bullet$            &  $\circ$      \\ \hline
