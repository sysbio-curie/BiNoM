...
public class xrefImpl extends com.ibm.adtech.jastor.ThingImpl implements fr.curie.BiNoM.pathways.biopax.xref {
	...
	private void initCOMMENT() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level2.owl#COMMENT properties in xref model not a Literal", stmt.getObject());
	...
	public java.lang.String getID_DASH_VERSION() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": ID_DASH_VERSION getProperty() in fr.curie.BiNoM.pathways.biopax.xref model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	public java.lang.String getDB_DASH_VERSION() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": DB_DASH_VERSION getProperty() in fr.curie.BiNoM.pathways.biopax.xref model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
		Object obj = Util.fixLiteral(literal.getValue(),"java.lang.String");
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
			...
			if (stmt.getPredicate().equals(ID_DASH_VERSIONProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						xrefListener listener=(xrefListener)iter.next();
						listener.ID_DASH_VERSIONChanged(fr.curie.BiNoM.pathways.biopax.xrefImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(DB_DASH_VERSIONProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						xrefListener listener=(xrefListener)iter.next();
						listener.DB_DASH_VERSIONChanged(fr.curie.BiNoM.pathways.biopax.xrefImpl.this);
					}
				}
				return;
			}
