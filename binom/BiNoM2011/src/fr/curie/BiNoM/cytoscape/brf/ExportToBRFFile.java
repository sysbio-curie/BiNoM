...
public class ExportToBRFFile implements ActionListener {
	...
	CyNetwork network = Cytoscape.getCurrentNetwork();
        ...
        celldesignerFilter.addExtension("txt");
        celldesignerFilter.setDescription("BiNoM Reaction Format files");

	for (;;) {
	    File file = FileUtil.getFile
		("Save BRF File", FileUtil.SAVE, new CyFileFilter[]{celldesignerFilter});
