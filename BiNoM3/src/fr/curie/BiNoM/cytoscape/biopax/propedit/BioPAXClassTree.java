...
public class BioPAXClassTree extends AbstractCyAction {
	
	public BioPAXClassTree(){
		super("BioPAX 3 Class Tree...",
	...
	if (biopax != null) {
	    BioPAXClassTreeFrame treeFrame = BioPAXClassTreeFrame.getInstance();
	    treeFrame.setBioPAX(biopax, network.getRow(network).get(CyNetwork.NAME, String.class));
