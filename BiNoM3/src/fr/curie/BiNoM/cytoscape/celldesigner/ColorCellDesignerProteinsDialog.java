...
public class ColorCellDesignerProteinsDialog extends JFrame {
    ...
    private ColorCellDesignerProteinsDialog() {
...
//			("Load  File", FileUtil.LOAD, new CyFileFilter[]{indexFilter});
//		    toFront();
	...
	JLabel lab2 = new JLabel("  Feature Table File  ");
	x = 0;
	c = new GridBagConstraints();
	c.ipady = 20;	
	c.gridx = x++;
...
//			("Load Feature Table File", FileUtil.LOAD);
    ...
    public static ColorCellDesignerProteinsDialog instance;

    public static ColorCellDesignerProteinsDialog getInstance() {
	if (instance == null)
	    instance = new ColorCellDesignerProteinsDialog();
	return instance;
    }
