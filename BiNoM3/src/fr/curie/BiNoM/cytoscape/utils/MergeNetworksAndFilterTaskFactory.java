...
public class MergeNetworksAndFilterTaskFactory implements AbstractClusterNetworksTaskFactory {

    public AbstractTask createTask(int idxs[],
				   StructureAnalysisUtils.Option options) {

	return new MergeNetworksAndFilterTask
	    (idxs, options,
