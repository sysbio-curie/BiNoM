...
public class BioPAXIntegerAttrDesc extends BioPAXAttrDesc {
    ...
    public BioPAXIntegerAttrDesc(BioPAXClassDesc clsDesc, String name, Vector<CMethod> getMthV, Vector<CMethod> setMthV) {
	super(clsDesc, name);

	getMth = getOne(getMthV, "BioPAXIntegerAttrDesc", "get");
	setMth = getOne(setMthV, "BioPAXIntegerAttrDesc", "set");
    }

    public Integer getValue(BioPAXObject obj) {
	try {
	    if (getMth == null)
		return null;
	    return (Integer)getMth.invoke(obj.getObject(), getArgs);
	}
	catch(Exception e) {
	    e.printStackTrace();
	    return null;
    ...
    public void setValue(BioPAXObject obj, Integer value) {
	try {
	    if (setMth != null) {
		setArgs[0] = value;
