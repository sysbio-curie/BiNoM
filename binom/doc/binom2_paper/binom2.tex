...
%
% describe how the network is build (LC) biocham conversion, etc.
%
...
PIQuant was applied to this network and its annotation: from each annotated nodes of influence network (red/green nodes of Figure~\ref{InflAnnotNet}), to each cell-cycle phase markers (grey nodes of Figure~\ref{InflAnnotNet}), PIQuant score is computed. These scores are represented in the Figure~\ref{PIQuantHeatMap}.  
