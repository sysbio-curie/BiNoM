...
public class CycleDecompositionTask implements AbstractTask {

    private CellDesignerPlugin plugin;
    private GraphDocument graphDocument;

    public CycleDecompositionTask(CellDesignerPlugin plugin, GraphDocument graphDocument) {
	this.plugin = plugin;
	this.graphDocument = graphDocument;
    }

    public String getTitle() {
	return "BiNoM: Cycle Decomposition";
    }
