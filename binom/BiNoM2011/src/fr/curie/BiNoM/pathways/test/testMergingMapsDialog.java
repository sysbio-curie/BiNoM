...
public class testMergingMapsDialog {
	...
	public static void main(String[] args) {
		...
		//l.add(new File("/bioinfo/users/ebonnet/a1_cyt.xml"));
		//l.add(new File("/bioinfo/users/ebonnet/a2_cyt.xml"));
		
		MergingMapsDialog mp = new MergingMapsDialog(w,"Merge Cell Designer maps",true, l);
		mp.setVisible(true);
		
		/*
		 * first step: let the user define the files he wants to merge.
		 */
