...
/**
 * Implementation of {@link fr.curie.BiNoM.pathways.biopax.Degradation}
 ...
 * <br>
 */
public class DegradationImpl extends com.ibm.adtech.jastor.ThingImpl implements fr.curie.BiNoM.pathways.biopax.Degradation {
	...
	DegradationImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static DegradationImpl getDegradation(Resource resource, Model model) throws JastorException {
		return new DegradationImpl(resource, model);
	}
	    
	static DegradationImpl createDegradation(Resource resource, Model model) throws JastorException {
		DegradationImpl impl = new DegradationImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, Degradation.TYPE)))
			impl._model.add(impl._resource, RDF.type, Degradation.TYPE);
		impl.addSuperTypes();
	...
	void addHasValueValues() {
		if (!_model.contains(_resource, conversionDirectionProperty, _model.createTypedLiteral("LEFT-TO-RIGHT^^http://www.w3.org/2001/XMLSchema#string")))
			_model.add(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(_resource, conversionDirectionProperty, _model.createTypedLiteral("LEFT-TO-RIGHT^^http://www.w3.org/2001/XMLSchema#string")));
	}
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, fr.curie.BiNoM.pathways.biopax.Degradation.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	private void initDataSource() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#dataSource properties in Degradation model not a Resource", stmt.getObject());
	...
	private void initAvailability() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#availability properties in Degradation model not a Literal", stmt.getObject());
	...
	private void initComment() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#comment properties in Degradation model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initName() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#name properties in Degradation model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initEvidence() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#evidence properties in Degradation model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initXref() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#xref properties in Degradation model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public fr.curie.BiNoM.pathways.biopax.InteractionVocabulary getInteractionType() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": interactionType getProperty() in fr.curie.BiNoM.pathways.biopax.Degradation model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	private void initParticipant() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#participant properties in Degradation model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initParticipantStoichiometry() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#participantStoichiometry properties in Degradation model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public java.lang.Boolean getSpontaneous() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": spontaneous getProperty() in fr.curie.BiNoM.pathways.biopax.Degradation model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initLeft() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#left properties in Degradation model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public java.lang.String getConversionDirection() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": conversionDirection getProperty() in fr.curie.BiNoM.pathways.biopax.Degradation model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initRight() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.biopax.org/release/biopax-level3.owl#right properties in Degradation model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof DegradationListener))
			throw new IllegalArgumentException("ThingListener must be instance of DegradationListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((DegradationListener)listener);
		}
	}
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDataSource.iterator();iter.hasNext();){
							DegradationListener listener=(DegradationListener)iter.next();
							listener.dataSourceAdded(fr.curie.BiNoM.pathways.biopax.DegradationImpl.this,_dataSource);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(availabilityProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForAvailability.iterator();iter.hasNext();){
						DegradationListener listener=(DegradationListener)iter.next();
						listener.availabilityAdded(fr.curie.BiNoM.pathways.biopax.DegradationImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(commentProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForComment.iterator();iter.hasNext();){
						DegradationListener listener=(DegradationListener)iter.next();
						listener.commentAdded(fr.curie.BiNoM.pathways.biopax.DegradationImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						DegradationListener listener=(DegradationListener)iter.next();
						listener.nameAdded(fr.curie.BiNoM.pathways.biopax.DegradationImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForEvidence.iterator();iter.hasNext();){
							DegradationListener listener=(DegradationListener)iter.next();
							listener.evidenceAdded(fr.curie.BiNoM.pathways.biopax.DegradationImpl.this,_evidence);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForXref.iterator();iter.hasNext();){
							DegradationListener listener=(DegradationListener)iter.next();
							listener.xrefAdded(fr.curie.BiNoM.pathways.biopax.DegradationImpl.this,_xref);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(interactionTypeProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DegradationListener listener=(DegradationListener)iter.next();
						listener.interactionTypeChanged(fr.curie.BiNoM.pathways.biopax.DegradationImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForParticipant.iterator();iter.hasNext();){
							DegradationListener listener=(DegradationListener)iter.next();
							listener.participantAdded(fr.curie.BiNoM.pathways.biopax.DegradationImpl.this,_participant);
						}
					}
				}
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.PhysicalEntity.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForParticipant_asPhysicalEntity.iterator();iter.hasNext();){
							DegradationListener listener=(DegradationListener)iter.next();
							listener.participantAdded(fr.curie.BiNoM.pathways.biopax.DegradationImpl.this,_participant_asPhysicalEntity);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForParticipantStoichiometry.iterator();iter.hasNext();){
							DegradationListener listener=(DegradationListener)iter.next();
							listener.participantStoichiometryAdded(fr.curie.BiNoM.pathways.biopax.DegradationImpl.this,_participantStoichiometry);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(spontaneousProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DegradationListener listener=(DegradationListener)iter.next();
						listener.spontaneousChanged(fr.curie.BiNoM.pathways.biopax.DegradationImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLeft.iterator();iter.hasNext();){
							DegradationListener listener=(DegradationListener)iter.next();
							listener.leftAdded(fr.curie.BiNoM.pathways.biopax.DegradationImpl.this,_left);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(conversionDirectionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DegradationListener listener=(DegradationListener)iter.next();
						listener.conversionDirectionChanged(fr.curie.BiNoM.pathways.biopax.DegradationImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForRight.iterator();iter.hasNext();){
							DegradationListener listener=(DegradationListener)iter.next();
							listener.rightAdded(fr.curie.BiNoM.pathways.biopax.DegradationImpl.this,_right);
						}
					}
				}
				return;
...
//				return;
			if (stmt.getPredicate().equals(dataSourceProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDataSource.iterator();iter.hasNext();){
							DegradationListener listener=(DegradationListener)iter.next();
							listener.dataSourceRemoved(fr.curie.BiNoM.pathways.biopax.DegradationImpl.this,_dataSource);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(availabilityProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DegradationListener listener=(DegradationListener)iter.next();
						listener.availabilityRemoved(fr.curie.BiNoM.pathways.biopax.DegradationImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(commentProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DegradationListener listener=(DegradationListener)iter.next();
						listener.commentRemoved(fr.curie.BiNoM.pathways.biopax.DegradationImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DegradationListener listener=(DegradationListener)iter.next();
						listener.nameRemoved(fr.curie.BiNoM.pathways.biopax.DegradationImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(evidenceProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForEvidence.iterator();iter.hasNext();){
							DegradationListener listener=(DegradationListener)iter.next();
							listener.evidenceRemoved(fr.curie.BiNoM.pathways.biopax.DegradationImpl.this,_evidence);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(xrefProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForXref.iterator();iter.hasNext();){
							DegradationListener listener=(DegradationListener)iter.next();
							listener.xrefRemoved(fr.curie.BiNoM.pathways.biopax.DegradationImpl.this,_xref);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(participantProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForParticipant.iterator();iter.hasNext();){
							DegradationListener listener=(DegradationListener)iter.next();
							listener.participantRemoved(fr.curie.BiNoM.pathways.biopax.DegradationImpl.this,_participant);
						}
					}
				}
				if (_model.contains(resource,RDF.type,fr.curie.BiNoM.pathways.biopax.PhysicalEntity.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForParticipant_asPhysicalEntity.iterator();iter.hasNext();){
							DegradationListener listener=(DegradationListener)iter.next();
							listener.participantRemoved(fr.curie.BiNoM.pathways.biopax.DegradationImpl.this,_participant_asPhysicalEntity);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(participantStoichiometryProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForParticipantStoichiometry.iterator();iter.hasNext();){
							DegradationListener listener=(DegradationListener)iter.next();
							listener.participantStoichiometryRemoved(fr.curie.BiNoM.pathways.biopax.DegradationImpl.this,_participantStoichiometry);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(leftProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLeft.iterator();iter.hasNext();){
							DegradationListener listener=(DegradationListener)iter.next();
							listener.leftRemoved(fr.curie.BiNoM.pathways.biopax.DegradationImpl.this,_left);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(rightProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForRight.iterator();iter.hasNext();){
							DegradationListener listener=(DegradationListener)iter.next();
							listener.rightRemoved(fr.curie.BiNoM.pathways.biopax.DegradationImpl.this,_right);
						}
					}
				}
				return;
