 ...
 */
public class ClusterByShortPath extends AbstractCyAction{
	
	public ClusterByShortPath(){
	...
	private boolean createNetworksDialog(){
		...
		TextBoxDialog ifCreate=new TextBoxDialog(Launcher.getCySwingAppAdapter().getCySwingApplication().getJFrame(),title,mess,txt);
